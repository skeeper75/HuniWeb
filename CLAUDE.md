...
**변경이력:** 최신: 2026-07-03(3) 적재단계 상품마스터 11시트 전 진단(round-19 readiness) + 돈영향 갭 라이브 COMMIT — ★반전: "새 적재" 전제 8/11 시트 stale(이미 적재됨)·진짜 미적재=상품악세사리(PRICE 0/13)·굿즈파우치(무가격72%·variant 자재오염) 2시트. 3배치 COMMIT+webadmin 실화면 검증: A그룹(캘린더 자재 6행·아크릴146 자재→480,000·151 맥세이프 바인딩→590,000)·B-아크릴부속(마그넷/집게/머리끈 330,000/380,000/300,000)·스티커 반칼 CPQ(059/060/061 완칼→반칼커팅 교정+052동형 CPQ·트리거28/28·코팅+1,000,000). 판수=라이브 fn_calc_pansu 그대로·캘린더=원자합산([[calendar-price-model-atomic-sum-260703]])·전부 undo/백업. 다음=상품악세사리·굿즈파우치 가격적재(최대)·캘린더 장수공식·071트윈링. HANDOFF·`29_readiness/_SUMMARY-5sheets-260703.md`. 직전: 2026-07-03(2) 상품마스터 전 13시트 컬럼 이해 완료(정본 `15_domain-spec/_ALL-SHEETS-column-understanding-260703.md`·가격 두 갈래·별색=공정·비용흡수·사이즈선택 조건부·nonspec 14상품). 직전: 2026-07-03 접지리플렛 완전견적 COMMIT([[leaflet-fold-full-quote-stub-formula-rebind-260703]]) → `_workspace/huni-dbmap/CHANGELOG.md`
...
**변경이력:** 최신: 2026-07-03 문구셋트25(SB-1) 완성 GO(누적 147상품=디지털36+스티커16+실사28+셋트42+문구셋트25[부모9 만년다이어리172~175·먼슬리176·스프링노트177·스프링수첩178·메모패드179·중철노트181+구성원16 293~308])·그래프 노드1202·하드0·멱등·게이트 14시나리오 on-grid 10/10 오차0·sparse 정직·O1~O7 GO. ★문구 교훈: sparse grid=등록 사이즈 적을 뿐·등록은 PRICE≠0/off-grid만 견적0("전 사이즈 견적0" 과대금지)·구성원 slug=자기 prd_cd[HARD](부모 prd_cd 오사용=slug 위반)·177 conflict=candidate+props+gap. 잔여=문구/굿즈 SB-4봉투→SB-2굿즈→SB-3파우치(empty-shell 다수·정직 GAP)·아크릴 별도팩. 직전: 셋트계열42 GO(누적122·member_of 없음·badge=defect 불가·derived_from 부모·Stage A/C 분리) → `_workspace/huni-ontology-kb/_meta/CHANGELOG.md`
