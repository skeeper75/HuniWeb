---
id: product-263-leather-tote-bag
type: product
anchor: t_prd_products/PRD_000263
badge: verified
sources:
  - {source_file: "live-snapshot/latest/t_prd_products.csv", source_locator: "키:PRD_000263 (레더토트백·prd_typ_cd=PRD_TYPE.01·nonspec_yn=N·use_yn=Y·del_yn=N·min1/max10000/incr1·QTY_UNIT.01)", captured_at: "live 20260702_1119", badge: verified, src_id: SR-5-livesnap}
  ...
  - {source_file: "live-snapshot/latest/t_prd_product_prices.csv", source_locator: "키:PRD_000263 unit_price(GP-1 base 단일고정가·260610 verbatim·전사표)", captured_at: "live 20260702_1119", badge: verified, src_id: SR-5-livesnap}
relations:
...
props:
  ...
  fixed_price: "31000원 (t_prd_product_prices unit_price·transcribed-by reprice_goods_260704 @ 07-04 live)"
  가격상태: "고정가룩업·31000원(unit_price·transcribed·07-04 live·reg_dt=2026-06-22)"
standards: {schema_org: "Product", xjdf: "Product(백류·봉제)", config_ont: "component type"}
answers_cq: ["구체 상품 질의(레더토트백 구성·가격)", "백류/에코백 탐색"]
tags: ["#백류", "#봉제상품", "#비종이류판형없음", "#고정가룩업"]
updated: 2026-07-04
---

# 레더토트백 (product-263-leather-tote-bag)

레더토트백(`PRD_000263`)는 **백류·필통(봉제) 완제품 단품**(`prd_typ_cd=PRD_TYPE.01`)이다. 셋트 아님
...
- **정체**: pack §1.3(FRESH) + live-snapshot(`PRD_000263` 실재·use_yn=Y·del_yn=N).
...
<!-- transcribed-by: awk t_prd_products.csv PRD_000263 from live-snapshot/latest (snap_20260702_1119) @ 2026-07-04 -->
...
<!-- transcribed-by: awk t_prd_product_materials.csv + t_mat_materials.csv PRD_000263 from live-snapshot/latest (snap_20260702_1119) @ 2026-07-04 -->
...
<!-- transcribed-by: awk t_prd_product_prices.csv PRD_000263 from live-snapshot/latest (snap_20260702_1119) @ 2026-07-04 -->
| prd_cd | apply_ymd | unit_price | note |
|---|---|---|---|
| PRD_000263 | 2026-06-10 | 31000.00 | GP-1 base 단일고정가 §21 R-GP4-1 (260610 verbatim) |
