...
!(We => {
  var Qe,
    ...
    i = (u => {
      ...
      (((e = t || (t = {}))[(e.None = 0)] = "None"),
        ...
        ((o = u.Severity || (u.Severity = {})).Fatal = "fatal"),
        (o.Error = "error"),
        (o.Warning = "warning"),
        (o.Log = "log"),
        (o.Info = "info"),
        (o.Debug = "debug"),
        (o.Critical = "critical"),
        ((i = u.Severity || (u.Severity = {})).fromString = t => {
          switch (t) {
            case "debug":
              return i.Debug;
            case "info":
        ...
        ((a = u.Status || (u.Status = {})).Unknown = "unknown"),
        (a.Skipped = "skipped"),
        (a.Success = "success"),
        (a.RateLimit = "rate_limit"),
        (a.Invalid = "invalid"),
        (a.Failed = "failed"),
        ((c = u.Status || (u.Status = {})).fromHttpCode = t => {
          return 200 <= t && t < 300
            ? c.Success
            : 429 === t
              ? c.RateLimit
      ...
      function I(t, e) {
        ...
        })(e) ? e.test(t) : "string" == typeof e && t.includes(e));
      }
      function T() {
        return (
          "[object process]" ===
      ...
      function R({message, exception, event_id}) {
        if (message) return message;
        if (exception && exception.values && exception.values[0]) {
          var e = exception.values[0];
          return e.type && e.value
            ? `${e.type}: ${e.value}`
            : e.type || e.value || event_id || "<unknown>";
        }
      ...
      function F({exception}, n) {
        void 0 === n && (n = {});
        try {
          ((exception.values[0].mechanism =
            exception.values[0].mechanism || {}),
            Object.keys(n).forEach(t => {
              exception.values[0].mechanism[t] = n[t];
            }));
        } catch (t) {}
      }
      function L(t) {
        try {
          for (
            var e = t, n = [], r = 0, o = 0, i = " > ".length, a = void 0;
            e &&
            r++ < 5 &&
            !(
              "html" === (a = A(e)) ||
              (1 < r && 80 <= o + n.length * i + a.length)
            );
          )
      ...
      var D = Date.now(),
        ...
        z = (() => {
          ...
          return t && t.now
            ? (void 0 === t.timeOrigin &&
                (t.timeOrigin = (t.timing && t.timing.navigationStart) || D),
              t)
            : B;
        })();
      function H() {
      ...
      var V = O(),
        ...
        K = (() => {
          ...
          (t.prototype.warn = function(...args) {
            for (var t = [], e = 0; e < args.length; e++)
              t[e] = args[e];
            this._enabled &&
              M(() => {
          ...
          (t.prototype.error = function(...args) {
            for (var t = [], e = 0; e < args.length; e++)
              t[e] = args[e];
            this._enabled &&
              M(() => {
      ...
      var Y,
        $,
        X = V.__SENTRY__.logger || (V.__SENTRY__.logger = new K()),
        Z = (() => {
          function t() {
      ...
      function tt(t) {
        ...
        if (b(t)) {
          ...
          try {
            i.currentTarget = x(o.currentTarget)
              ? L(o.currentTarget)
              ...
              : void 0 !== We && t === We
                ...
                : "undefined" != typeof document && t === document
                  ...
                  : (t => {
                      ...
                      })(t) ? "[SyntheticEvent]" : "number" == typeof t && t != t
                      ? "[NaN]"
                      : void 0 === t
                        ? "[undefined]"
                        : "function" == typeof t
      ...
      function rt(t, e, n, r) {
        if (
          (void 0 === n && (n = 1 / 0), void 0 === r && (r = new Z()), 0 === n)
        )
          return (t => {
      ...
      var it = (() => {
        ...
        at = (() => {
          ...
          (t.prototype.add = function (t) {
            var e = this;
            return this.isReady()
              ? (!this._buffer.includes(t) && this._buffer.push(t),
                t
                  .then(() => {
                    return e.remove(t);
                  })
                ...
                t)
              : it.reject(
                  new v("Not adding Promise due to buffer limit reached."),
                );
          }),
        ...
        if (!pt[t])
          switch (((pt[t] = !0), t)) {
                    ...
                    r in lt.console &&
                      Q(lt.console, r, n => {
                        return function(...args) {
                          for (var t = [], e = 0; e < args.length; e++)
                            t[e] = args[e];
                          (vt("console", { args: t, level: r }),
                            n &&
                              Function.prototype.apply.call(n, lt.console, t));
                        };
                      });
                  },
                );
                ...
                (lt.document.addEventListener(
                  ...
                  ["EventTarget", "Node"].forEach(t => {
                    ...
                    e &&
                      ...
                      (Q(e, "addEventListener", r => {
                        return function (t, e, n) {
                          return e && e.handleEvent
                            ? ("click" === t &&
                                Q(e, "handleEvent", e => {
                                  return function (t) {
                                    return (
                                      bt("click", vt.bind(null, "dom"))(t),
                                      e.call(this, t)
                                    );
                                  };
                                }),
                              "keypress" === t &&
                                Q(e, "handleEvent", e => {
                                  return function (t) {
                                    return (
                                      xt(vt.bind(null, "dom"))(t),
                                      e.call(this, t)
                                    );
                                  };
                                }))
                            : ("click" === t &&
                                bt("click", vt.bind(null, "dom"), !0)(this),
                              "keypress" === t &&
                                xt(vt.bind(null, "dom"))(this)),
                          r.call(this, t, e, n);
                        };
                      }),
                      Q(e, "removeEventListener", r => {
                        return function (t, e, n) {
                          try {
              ...
              !(() => {
                ...
                (Q(t, "open", i => {
                  return function(...args) {
                    ...
                    return "onreadystatechange" in r &&
                    "function" == typeof r.onreadystatechange
                      ? Q(r, "onreadystatechange", n => {
                          return function(...args) {
                            for (var t = [], e = 0; e < args.length; e++)
                              t[e] = args[e];
                    ...
                    var n = {
                      ...
                      fetchData: {
                        ...
                        url: (t => {
                          ...
                          if ("Request" in lt && w(t[0], Request))
                            return t[0].url;
                          return String(t[0]);
                        })(t),
                      },
                ...
                function t(i) {
                  return function(...args) {
                    ...
                    if (n) {
                      var r = ut,
                        o = String(n);
                      vt("history", { from: r, to: (ut = o) });
                    }
                    return i.apply(this, t);
                  };
                }
                ((lt.onpopstate = function(...args) {
                  for (var t = [], e = 0; e < args.length; e++)
                    t[e] = args[e];
                  var n = lt.location.href,
                    r = ut;
                  if ((vt("history", { from: r, to: (ut = n) }), o))
                    return o.apply(this, t);
                }),
                  Q(lt.history, "pushState", t),
                  Q(lt.history, "replaceState", t));
              })();
              break;
            case "error":
              ((kt = lt.onerror),
                (lt.onerror = function (t, e, n, r, o) {
                  return (
                    vt("error", {
                      column: r,
                      error: o,
            ...
            case "unhandledrejection":
              ((wt = lt.onunhandledrejection),
                (lt.onunhandledrejection = function (t) {
                  return (
                    vt("unhandledrejection", t),
        ...
        It = (() => {
          ...
          (t.prototype._validate = function () {
            ...
            if (
              ...
              throw new v(`${Et}: Invalid projectId ${this.projectId}`);
            if ("http" !== this.protocol && "https" !== this.protocol)
              throw new v(`${Et}: Invalid protocol ${this.protocol}`);
            if (this.port && isNaN(parseInt(this.port, 10)))
              throw new v(`${Et}: Invalid port ${this.port}`);
          }),
          t;
        })(),
        Tt = (() => {
          ...
          return (n.clone = t => {
            ...
            return (
              t &&
                ((e._breadcrumbs = s(t._breadcrumbs)),
                (e._tags = f({}, t._tags)),
                (e._extra = f({}, t._extra)),
                (e._contexts = f({}, t._contexts)),
                (e._user = t._user),
                (e._level = t._level),
                (e._span = t._span),
                (e._transactionName = t._transactionName),
                (e._fingerprint = t._fingerprint),
                (e._eventProcessors = s(t._eventProcessors))),
              e
            );
          }),
          ...
          (n.prototype.setTag = function (t, e) {
            var n;
            return (
              (this._tags = f(f({}, this._tags), (((n = {})[t] = e), n))),
              this._notifyScopeListeners(),
              this
            );
          }),
          ...
          (n.prototype.setExtra = function (t, e) {
            var n;
            return (
              (this._extra = f(f({}, this._extra), (((n = {})[t] = e), n))),
              this._notifyScopeListeners(),
              this
            );
          }),
          ...
          (n.prototype.update = function (t) {
            ...
            if ("function" != typeof t)
              return (
                t instanceof n
                  ? ((this._tags = f(f({}, this._tags), t._tags)),
                    (this._extra = f(f({}, this._extra), t._extra)),
                    (this._contexts = f(f({}, this._contexts), t._contexts)),
                    t._user && (this._user = t._user),
                    t._level && (this._level = t._level),
                    t._fingerprint && (this._fingerprint = t._fingerprint))
                  : m(t) &&
                    ((t = t),
                    (this._tags = f(f({}, this._tags), t.tags)),
                    (this._extra = f(f({}, this._extra), t.extra)),
                    (this._contexts = f(f({}, this._contexts), t.contexts)),
          ...
          (n.prototype.addBreadcrumb = function (t, e) {
            var n = f({ timestamp: H() }, t);
            return (
              (this._breadcrumbs =
                void 0 !== e && 0 <= e
                  ? s(this._breadcrumbs, [n]).slice(-e)
                  : s(this._breadcrumbs, [n])),
              this._notifyScopeListeners(),
              this
            );
          }),
          ...
          (n.prototype.applyToEvent = function (t, e) {
            return (
              this._extra &&
                ...
                (t.extra = f(f({}, this._extra), t.extra)),
              this._tags &&
                Object.keys(this._tags).length &&
                (t.tags = f(f({}, this._tags), t.tags)),
              this._user &&
                Object.keys(this._user).length &&
                (t.user = f(f({}, this._user), t.user)),
              this._contexts &&
                Object.keys(this._contexts).length &&
                (t.contexts = f(f({}, this._contexts), t.contexts)),
              ...
              (t.breadcrumbs = s(t.breadcrumbs || [], this._breadcrumbs)),
              (t.breadcrumbs =
                0 < t.breadcrumbs.length ? t.breadcrumbs : void 0),
              this._notifyEventProcessors(
                s(Pt(), this._eventProcessors),
                t,
                e,
              )
            );
              ...
              if (null === i || "function" != typeof n) e(i);
                ...
                k(r)
                  ? r
                      .then(t => {
                        return s
                          ._notifyEventProcessors(o, t, a, c + 1)
                          .then(e);
                      })
                      .then(null, t)
                  : s
                      ._notifyEventProcessors(o, r, a, c + 1)
                      .then(e)
                      .then(null, t);
              }
            });
        ...
        Ct = (() => {
          ...
          (t.prototype._invokeClient = function (t) {
            ...
            o &&
              o.client &&
              o.client[t] &&
              (e = o.client)[t].apply(e, s(n, [o.scope]));
          }),
      ...
      function Nt() {
        var t = Rt();
        return (Ft(t) && !Lt(t).isOlderThan(jt)) || At(t, new Ct()),
        T() ? (e => {
              try {
                var t = Rt(),
                  n = t.__SENTRY__;
      ...
      function Wt(t) {
        var e = {};
        return (({defaultIntegrations, integrations}) => {
          var e = (defaultIntegrations && s(defaultIntegrations)) || [],
            n = integrations,
            r = [];
          if (Array.isArray(n)) {
            var o = n.map(({name}) => {
            ...
            (e.forEach(t => {
              ...
              n.forEach(t => {
                !i.includes(t.name) && (r.push(t), i.push(t.name));
              }));
          } else
            r =
              "function" == typeof n
                ? ((r = n(e)), Array.isArray(r) ? r : [r])
                : s(e);
          var a = r.map(({name}) => {
            return name;
          });
          return a.includes("Debug") &&
            r.push(...s(r.splice(a.indexOf("Debug"), 1))),
          r;
        })(t).forEach(t => {
          !(t => {
            !Ht.includes(t.name) &&
      ...
      var Gt,
        qt = (() => {
          function t(t, e) {
            ((this._integrations = {}),
              ...
              (this._options = e).dsn && (this._dsn = new It(e.dsn)));
          }
          ...
          (t.prototype.flush = function (t) {
            var n = this;
            return this._isClientProcessing(t).then(({interval, ready}) => {
          ...
          (t.prototype.getIntegration = function({id}) {
            try {
              return this._integrations[id] || null;
            } catch (t) {
              return X.warn(
                `Cannot retrieve integration ${id} from the current Client`,
              ),
              null;
            }
          }),
          (t.prototype._isClientProcessing = function (r) {
            ...
            return new it(t => {
              ...
              (clearInterval(n),
                (n = setInterval(() => {
                  o._processing
                    ? ((e += 1), r && r <= e && t({ interval: n, ready: !1 }))
                    : t({ interval: n, ready: !0 });
                }, 1)));
            });
          }),
          ...
          (t.prototype._prepareEvent = function (t, e, n) {
            ...
            n &&
              n.captureContext &&
              (c = Tt.clone(c).update(n.captureContext));
            var s = it.resolve(a);
            return c && (s = c.applyToEvent(a, n)),
            s.then(t => {
                  ...
                  f(
                    ...
                    t.breadcrumbs && {
                      breadcrumbs: t.breadcrumbs.map(t => {
                        return f(f({}, t), t.data && { data: ot(t.data, e) });
                      }),
                    },
                  ),
                  t.user && { user: ot(t.user, e) },
                ),
                t.contexts && { contexts: ot(t.contexts, e) },
              ),
              t.extra && { extra: ot(t.extra, e) },
            );
            return (
              t.contexts &&
                t.contexts.trace &&
          ...
          (t.prototype._applyClientOptions = function (t) {
            ...
            (void 0 === t.environment && void 0 !== n && (t.environment = n),
              ...
              t.message && (t.message = S(t.message, a)));
            var c =
          ...
          (t.prototype._applyIntegrationsMetadata = function({sdk}) {
            var e = sdk,
          ...
          (t.prototype._processEvent = function (t, i, e) {
            ...
            return !s && "number" == typeof r && Math.random() > r
              ? it.reject("This event has been sampled, will not send event.")
              : new it((r, o) => {
                  a._prepareEvent(t, e, i)
                    .then(t => {
                      if (null !== t) {
                        var e = t;
                        if (
                          (i && i.data && !0 === i.data.__sentry__) ||
                          !c ||
                          s
                        )
                          return (a._sendEvent(e), void r(e));
                        var n = c(t, i);
                        if (void 0 === n)
                          X.error(
        ...
        Jt = (() => {
          function t(t) {
            ((this._options = t),
              this._options.dsn ||
                X.warn("No DSN provided, backend will not do anything."),
              (this._transport = this._setupTransport()));
          }
          return (t.prototype.eventFromException = (t, e) => {
            throw new v(
  ...
  sent_at: new Date(1e3 * H()).toISOString(),
      ...
      var Yt = (() => {
        ...
        Xt = (() => {
          ...
          (a.prototype._isSentryError = (t, {ignoreInternal}) => {
            if (!ignoreInternal) return !1;
            try {
              return (
                (t &&
                  t.exception &&
          ...
          (a.prototype._isIgnoredError = function(t, {ignoreErrors}) {
            return !(!ignoreErrors || !ignoreErrors.length) &&
            this._getPossibleEventMessages(t).some(e => {
              return ignoreErrors.some(t => {
                return I(e, t);
              });
            });
          }),
          (a.prototype._isDeniedUrl = function(t, {denyUrls}) {
          ...
          (a.prototype._isAllowedUrl = function(t, {allowUrls}) {
          ...
          (a.prototype._getPossibleEventMessages = e => {
          ...
          (a.prototype._getEventFilterUrl = e => {
            try {
              if (e.stacktrace) {
        ...
        try {
          if (
            (e = (t => {
              ...
              return a.length
                ? { message: se(t), name: t.name, stack: a }
                : null;
            })(t))
          )
            return ce(e, n);
            ...
            (e = (t => {
              ...
              for (
                ...
                if ((n = te.exec(i[a]))) {
                  ...
                  (n[3] && n[3].includes(" > eval") && (e = re.exec(n[3]))
                    ? ((n[1] = n[1] || "eval"),
                      (n[3] = e[1]),
                      (n[4] = e[2]),
                      (n[5] = ""))
              ...
              return o.length
                ? { message: se(t), name: t.name, stack: o }
                : null;
            })(t))
          )
            return ce(e, n);
        } catch (t) {}
        return { message: se(t), name: t && t.name, stack: [], failed: !0 };
      }
      function ce(e, t) {
        try {
          return f(f({}, e), { stack: e.stack.slice(t) });
        } catch (t) {
          return e;
        }
      }
      ...
      var ue = 50;
      function le({stack, name, message}) {
        var e = de(stack),
          n = { type: name, value: message };
        return (
            ...
            values: [
              {
                type: b(t)
                  ...
                  : n
                    ...
                    : "Error",
                value:
                  `Non-Error ${n ? "promise rejection" : "exception"} captured with keys: ${((t, e) => {
  void 0 === e && (e = 40);
  ...
  return "";
      ...
      function de(t) {
        ...
        var e = t,
          n = e[0].func || "",
          r = e[e.length - 1].func || "";
        return (!n.includes("captureMessage") &&
          !n.includes("captureException")) ||
          (e = e.slice(1)),
        r.includes("sentryWrapped") && (e = e.slice(0, -1)),
        e
          .slice(0, ue)
          .map(({column, url, func, line}) => {
            return {
              colno: null === column ? void 0 : column,
              filename: url || e[0].url,
              function: func || "?",
              in_app: !0,
              lineno: null === line ? void 0 : line,
            };
          })
          .reverse();
      }
      function he({attachStacktrace}, e, n) {
        var r = ge(e, (n && n.syntheticException) || void 0, {
          attachStacktrace: attachStacktrace,
        });
        return (
          F(r, { handled: !0, type: "generic" }),
          (r.level = u.Severity.Error),
          n && n.event_id && (r.event_id = n.event_id),
          it.resolve(r)
        );
      }
      function ve({attachStacktrace}, e, n, r) {
      ...
      function ge(t, e, n) {
        var r;
        if ((void 0 === n && (n = {}), d(t) && t.error))
          return (r = pe(ae((t = t.error))));
        if (
          g(t) || (t => {
            return (
              "[object DOMException]" === Object.prototype.toString.call(t)
            );
          })(t)
        ) {
          var o = t,
        ...
        return p(t)
          ? (r = pe(ae(t)))
          : (m(t) || b(t)
              ? F((r = fe(t, e, n.rejection)), { synthetic: !0 })
              : (N((r = _e(t, e, n)), `${t}`, void 0), F(r, { synthetic: !0 })),
            r);
      }
      function _e(t, e, n) {
        void 0 === n && (n = {});
      ...
      var ye = (() => {
          function t(t) {
            ((this.options = t),
              (this._buffer = new at(30)),
              (this._api = new zt(this.options.dsn)),
        ...
        be = (e => {
          function t(...args) {
            var t = (null !== e && e.apply(this, args)) || this;
          ...
          (t.prototype.sendEvent = function (t) {
            ...
            if (new Date(Date.now()) < this._disabledUntil)
              return Promise.reject({
                event: t,
                reason:
                  `Transport locked till ${this._disabledUntil} due to too many requests.`,
                status: 429,
              });
            ...
            return void 0 !== this.options.fetchParameters &&
                  ...
                  .then(t => {
                    ...
                    if (e !== u.Status.Success) {
                      if (e === u.Status.RateLimit) {
                        ...
                        ((a._disabledUntil = new Date(n + W(n, r))),
                          X.warn(
                            `Too many requests, backing off till: ${a._disabledUntil}`,
                          ));
                      }
                      i(t);
                    } else o({ status: e });
          ...
          (t.prototype.sendEvent = function (t) {
            ...
            return this._buffer.add(
              new it((r, o) => {
                  ...
                  if (4 === i.readyState) {
                    ...
                    if (t !== u.Status.Success) {
                      if (t === u.Status.RateLimit) {
                        ...
                        ((a._disabledUntil = new Date(e + W(e, n))),
                          X.warn(
                            `Too many requests, backing off till: ${a._disabledUntil}`,
                          ));
                      }
                ...
                i.open("POST", e.url),
                a.options.headers))
                  a.options.headers.hasOwnProperty(t) &&
                    i.setRequestHeader(t, a.options.headers[t]);
                i.send(e.body);
              }),
            );
          }),
        ...
        we = (e => {
          ...
          return (
            ...
            (t.prototype.eventFromMessage = function (t, e, n) {
              return (
                void 0 === e && (e = u.Severity.Info),
                ve(this._options, t, e, n)
              );
            }),
      ...
      function Ie(e, r, o) {
        ...
        var t = function(...args) {
          ...
          try {
            o && "function" == typeof o && o.apply(this, args);
            var t = n.map(t => {
              return Ie(t, r);
            });
            return e.handleEvent
              ? e.handleEvent.apply(this, t)
              : e.apply(this, t);
          } catch (e) {
            throw (
              (Se += 1),
              ...
              Bt(t => {
                (t.addEventProcessor(function (t) {
                  var e = f({}, t);
                  return (
                    r.mechanism && (N(e, void 0, void 0), F(e, r.mechanism)),
                    (e.extra = f(f({}, e.extra), { arguments: n })),
                    e
                  );
                }),
                  Ut(e));
        ...
        try {
          Object.getOwnPropertyDescriptor(t, "name").configurable &&
      ...
      function Te(t) {
        if ((void 0 === t && (t = {}), t.eventId))
          if (t.dsn) {
            ...
            ((e.async = !0),
              (e.src = new zt(t.dsn).getReportDialogEndpoint(t)),
      ...
      var Pe = (() => {
          ...
          return (s.prototype.setupOnce = function () {
            ((Error.stackTraceLimit = 50),
              this._options.onerror &&
                (X.log("Global Handler attached: onerror"),
                this._installGlobalOnErrorHandler()),
              this._options.onunhandledrejection &&
                (X.log("Global Handler attached: onunhandledrejection"),
              ...
              (ht({
                callback(t) {
                  ...
                  if (r && !Ee() && !o) {
                    var i = n.getClient(),
                      a = y(e)
                        ? c._eventFromIncompleteOnError(
                            t.msg,
                            t.url,
                            t.line,
                            t.column,
                          )
                        : c._enhanceEventWithInitialFrame(
                            ge(e, void 0, {
                              attachStacktrace:
                    ...
                    (F(a, { handled: !1, type: "onerror" }),
                      n.captureEvent(a, { originalException: e }));
                  }
                },
                type: "error",
              }),
          ...
          (s.prototype._installGlobalOnUnhandledRejectionHandler =
            function () {
              var c = this;
              this._onUnhandledRejectionHandlerInstalled ||
                (ht({
                  callback(t) {
                    ...
                    var i = n.getClient(),
                      a = y(e)
                        ? c._eventFromIncompleteRejection(e)
                        : ge(e, void 0, {
                            attachStacktrace:
                              i && i.getOptions().attachStacktrace,
                            rejection: !0,
                          });
                    ((a.level = u.Severity.Error),
          ...
          (s.prototype._eventFromIncompleteRejection = t => {
            return {
              exception: {
                values: [
                  {
          ...
          (s.prototype._enhanceEventWithInitialFrame = (t, e, n, r) => {
            ((t.exception = t.exception || {}),
              (t.exception.values = t.exception.values || []),
              (t.exception.values[0] = t.exception.values[0] || {}),
        ...
        je = (() => {
          ...
          return (e.prototype.setupOnce = function () {
            ...
            (this._options.setTimeout &&
              Q(t, "setTimeout", this._wrapTimeFunction.bind(this)),
            this._options.setInterval &&
              Q(t, "setInterval", this._wrapTimeFunction.bind(this)),
            this._options.requestAnimationFrame &&
              Q(t, "requestAnimationFrame", this._wrapRAF.bind(this)),
            this._options.XMLHttpRequest &&
              "XMLHttpRequest" in t &&
              Q(XMLHttpRequest.prototype, "send", this._wrapXHR.bind(this)),
          ...
          (e.prototype._wrapTimeFunction = r => {
            return function(...args) {
              for (var t = [], e = 0; e < args.length; e++)
                t[e] = args[e];
              var n = t[0];
          ...
          (e.prototype._wrapEventTarget = o => {
            var t = O(),
              e = t[o] && t[o].prototype;
            e &&
              e.hasOwnProperty &&
                ...
                return function (t, e, n) {
                  try {
                    "function" == typeof e.handleEvent &&
                      (e.handleEvent = Ie(e.handleEvent.bind(e), {
                        mechanism: {
                          data: {
        ...
        Ce = (() => {
              ...
              this._options.history &&
                ht({
                  callback(...args) {
                    for (var t = [], e = 0; e < args.length; e++)
                      t[e] = args[e];
                    n._historyBreadcrumb(...s(t));
                  },
                  type: "history",
                }));
          }),
          (e.prototype._consoleBreadcrumb = function({args, level}) {
            var e = {
              category: "console",
              data: { arguments: args, logger: "console" },
              level: u.Severity.fromString(level),
              message: E(args, " "),
            };
            if ("assert" === level) {
              if (!1 !== args[0]) return;
              ((e.message =
                `Assertion failed: ${E(args.slice(1), " ") || "console.assert"}`),
                (e.data.arguments = args.slice(1)));
            }
            Nt().addBreadcrumb(e, { input: args, level: level });
          }),
          (e.prototype._domBreadcrumb = ({event, name}) => {
            var e;
            try {
              e = event.target ? L(event.target) : L(event);
            } catch (t) {
              e = "<unknown>";
            }
            0 !== e.length &&
              Nt().addBreadcrumb(
                { category: `ui.${name}`, message: e },
                { event: event, name: name },
              );
          }),
          (e.prototype._xhrBreadcrumb = ({endTimestamp, xhr}) => {
            if (endTimestamp) {
              if (xhr.__sentry_own_request__) return;
              Nt().addBreadcrumb(
                { category: "xhr", data: xhr.__sentry_xhr__, type: "http" },
                { xhr: xhr },
              );
            } else;
          }),
          (e.prototype._fetchBreadcrumb = t => {
            t.endTimestamp &&
          ...
          (e.prototype._historyBreadcrumb = ({from, to}) => {
            var e = O(),
              n = from,
              r = to,
              o = C(e.location.href),
        ...
        Re = (() => {
          ...
          (r.prototype._walkErrorTree = function (t, e, n) {
            if (
              (void 0 === n && (n = []),
              !w(t[e], Error) || n.length + 1 >= this._limit)
            )
              return n;
            var r = le(ae(t[e]));
        ...
        Ne = (() => {
          ...
          return (n.prototype.setupOnce = () => {
            Ot(t => {
              if (Nt().getIntegration(n)) {
                if (!Me.navigator || !Me.location) return t;
                var e = t.request || {};
                return (
                  (e.url = e.url || Me.location.href),
                  (e.headers = e.headers || {}),
                  (e.headers["User-Agent"] = Me.navigator.userAgent),
                  f(f({}, t), { request: e })
                );
              }
              return t;
        ...
        De = (r => {
          ...
          return (
            n(t, r),
            (t.prototype.showReportDialog = function (t) {
              (void 0 === t && (t = {}),
                O().document &&
                  (this._isEnabled()
                    ? Te(f(f({}, t), { dsn: t.dsn || this.getDsn() }))
                    : X.error(
              ...
              return (
                ...
                (t.sdk = f(f({}, t.sdk), {
                  ...
                  packages: s((t.sdk && t.sdk.packages) || [], [
                    { name: "npm:@sentry/browser", version: Ae },
                  ]),
                  version: Ae,
                })),
            ...
            (t.prototype._sendEvent = function (t) {
              ...
              (e && e.addSentryBreadcrumb(t),
                r.prototype._sendEvent.call(this, t));
            }),
            t
          );
        })(qt),
      ...
      (u.addGlobalEventProcessor = Ot),
      (u.captureEvent = t => {
        return Dt("captureEvent", t);
      }),
      (u.captureException = Ut),
      (u.captureMessage = (t, e) => {
        var n;
        try {
          throw new Error(t);
        } catch (t) {
      ...
      (u.defaultIntegrations = Ue),
      (u.eventFromException = he),
      (u.eventFromMessage = ve),
      (u.flush = t => {
        var e = Nt().getClient();
      ...
      (u.forceLoad = () => {}),
      (u.getCurrentHub = Nt),
      (u.getHubFromCarrier = Lt),
      (u.init = t => {
        if (
          (void 0 === t && (t = {}),
          void 0 === t.defaultIntegrations && (t.defaultIntegrations = Ue),
          void 0 === t.release)
        ) {
          var e = O();
          e.SENTRY_RELEASE &&
      ...
      (u.showReportDialog = t => {
        (void 0 === t && (t = {}),
          t.eventId || (t.eventId = Nt().lastEventId()));
        var e = Nt().getClient();
        e && e.showReportDialog(t);
      }),
      (u.startTransaction = t => {
  ...
  /**
   * ============================================================================
   * EDICUS SDK / IFRAME PORTAL INTEGRATION
   * ============================================================================
   * The Qe object handles iframe mounting, postMessage communication, and
   * parameter bridging for the Edicus Cloud Editor.
   */
  ...
  (((Qe = {
    ...
    (Qe.dev_base_url = "https://edicus-stage.firebaseapp.com"),
    (Qe._lastUpdatedAt = "20210609"),
    /**
     * Initializes the Edicus SDK.
     * Sets up a cross-origin window.postMessage listener to route events
     * ("from-edicus", "from-edicus-root") to the target_callback.
     * Also intercepts "from-edicus-private" events to supply large requested blobs (ddp_block, options).
     * @param {boolean} t - isDev flag
     * @param {string} e - Base URL override
     */
     ...
     * @param {string} e - Base URL override
     */
    (Qe.init = function (t, e) {
      var i = this;
      ((Qe._isDev = t),
        (Qe.base_url = t ? Qe.dev_base_url : Qe.base_url),
        e && (Qe.base_url = e),
        We.__KOI_EVENT_LISNTER_INITIALIZE ||
          ((i.messageListener = ({data}) => {
            if (
              data &&
              "string" == typeof data &&
              data.match(/^{.*}$/g)
                  ...
                  if ("waiting-for-extra-param" == e.action) {
                    for (var n = [], r = 0; r < e.info.param_names.length; r++)
                      "ddp_block" == e.info.param_names[r]
                        ? n.push({ name: "ddp_block", ddp_block: i.ddp_block })
                        : "private_css" == e.info.param_names[r]
                          ...
                          : "prod_info" == e.info.param_names[r]
                            ...
                            : "options" == e.info.param_names[r]
                              ? n.push({ name: "options", options: i.options })
                    ...
                    i.iframe_el.contentWindow.postMessage(
                      JSON.stringify(o),
                      "*",
                    );
          ...
          We.addEventListener("message", i.messageListener, !1),
          (We.__KOI_EVENT_LISNTER_INITIALIZE = !0)));
    }),
    (Qe.destroy = function (t, e) {
      (e &&
        this.messageListener &&
        (We.removeEventListener("message", this.messageListener, !1),
        (this.messageListener = null),
        (We.__KOI_EVENT_LISNTER_INITIALIZE = !1)),
        this.iframe_el &&
          t &&
          t.firstElementChild &&
          (t.removeChild(this.iframe_el), (this.iframe_el = null)));
    }),
    (Qe.open_portal = function({token, parent_element}, e) {
      var n =
        `${this.base_url}/ed#/editor_portal?cmd=open_portal&token=${token}`;
      (this._build_iframe(n, parent_element), (this.target_callback = e));
    }),
    /**
     * Internal URL Builder.
     * Appends standard contextual parameters (lang, ui_style, plugins, etc.)
     * to the Edicus iframe src URL before mounting.
     */
    ...
    (Qe._add_common_url_param = function (t, e) {
      return t +=
        (e.partner ? `&partner=${e.partner}` : "") +
        (e.mobile ? `&mobile=${e.mobile}` : "") +
        (e.div ? `&div=${e.div}` : "") +
        (e.lang ? `&lang=${e.lang}` : "") +
        (e.ui_locale ? `&ui_locale=${e.ui_locale}` : "") +
        (e.editor_type ? `&editor_type=${e.editor_type}` : "") +
        (e.parent_type ? `&parent_type=${e.parent_type}` : "") +
        (this._isDev ? "&env_mode=dev" : "") +
        (e.run_mode ? `&run_mode=${e.run_mode}` : "") +
        (e.master_mode ? `&master_mode=${e.master_mode}` : "") +
        (e.edit_mode ? `&edit_mode=${e.edit_mode}` : "") +
        (e.ui_style ? `&ui_style=${e.ui_style}` : "") +
        (e.num_page ? `&num_page=${e.num_page}` : "") +
        (e.max_page ? `&max_page=${e.max_page}` : "") +
        (e.min_page ? `&min_page=${e.min_page}` : "") +
        (e.unit_page ? `&unit_page=${e.unit_page}` : "") +
        (e.max_order ? `&max_order=${e.max_order}` : "") +
        (e.min_order ? `&min_order=${e.min_order}` : "") +
        (e.force_plugin ? `&force_plugin=${e.force_plugin}` : "") +
        (e.plugin_param ? `&plugin_param=${e.plugin_param}` : "") +
        (e.resapi_param ? `&resapi_param=${e.resapi_param}` : "") +
        (e.unlayers ? `&unlayers=${e.unlayers}` : "") +
        (e.edit_lock ? `&edit_lock=${e.edit_lock}` : "") +
        (e.no_update ? `&no_update=${e.no_update}` : "") +
        (e.clear_src ? `&clear_src=${e.clear_src}` : "") +
        (e.cal_date ? `&cal_date=${e.cal_date}` : "") +
        (e.video_frames ? `&video_frames=${e.video_frames}` : "") +
        (e.ddp_block ? "&wait_ddp=true" : "") +
        (e.private_css ? "&wait_private_css=true" : "") +
        (e.prod_info ? "&wait_prod_info=true" : "") +
        (e.options ? "&wait_options=true" : "") +
        (e.option_string ? "&wait_option_string=true" : "") +
        (e.dev_apiHost ? `&dev_apiHost=${e.dev_apiHost}` : "") +
        (e.dev_assetHost ? `&dev_assetHost=${e.dev_assetHost}` : "") +
        (e.dev_uploadHost ? `&dev_uploadHost=${e.dev_uploadHost}` : "") +
        (e.dev_resHost ? `&dev_resHost=${e.dev_resHost}` : "");
    }),
    /**
     * Mounts the Edicus Editor to create a brand new design project.
     * Targets the /editor_landing route.
     */
    ...
    (Qe.create_project = function (t, e) {
      var n =
        `${this.base_url +
this.landing_path}?cmd=create&token=${t.token}&ps_code=${t.ps_code}&title=${encodeURIComponent(t.title)}${t.template_uri ? `&template_uri=${t.template_uri}` : ""}${t.content_uri ? `&content_uri=${t.content_uri}` : ""}`;
    ...
    (Qe.open_project = function (t, e) {
      var n =
        `${this.base_url +
this.landing_path}?cmd=open&token=${t.token}&prjid=${t.prjid}`;
      ((this.target_callback = e),
        (n = this._add_common_url_param(n, t)),
        this._set_deferred_params(t),
        this._build_iframe(n, t.parent_element));
    ...
    (Qe.edit_template = function (t, e) {
      var n =
        `${this.base_url +
this.landing_path}?cmd=edit-template&token=${t.token}&ps_code=${t.ps_code}${t.prjid ? `&prjid=${t.prjid}` : ""}${t.template_uri ? `&template_uri=${t.template_uri}` : ""}`;
      ((this.target_callback = e),
        (n = this._add_common_url_param(n, t)),
        this._set_deferred_params(t),
        this._build_iframe(n, t.parent_element));
    ...
    (Qe.create_design_project = function (t, e) {
      var n =
        `${this.base_url +
this.landing_path}?cmd=create-design-project&token=${t.token}&ps_code=${t.ps_code}&title=${encodeURIComponent(t.title)}${t.template_uri ? `&template_uri=${t.template_uri}` : ""}`;
      ((this.target_callback = e),
        (n = this._add_common_url_param(n, t)),
        this._set_deferred_params(t),
        this._build_iframe(n, t.parent_element));
    ...
    (Qe.open_design_project = function (t, e) {
      var n =
        `${this.base_url +
this.landing_path}?cmd=open-design-project&token=${t.token}&prjid=${t.prjid}`;
      ((this.target_callback = e),
        (n = this._add_common_url_param(n, t)),
        this._set_deferred_params(t),
        this._build_iframe(n, t.parent_element));
    ...
    (Qe.recycle_project = function (t, e) {
      var n =
        `${this.base_url +
this.landing_path}?cmd=recycle&token=${t.token}&prjid=${t.prjid}&title=${encodeURIComponent(t.title)}`;
      ((this.target_callback = e),
        (n = this._add_common_url_param(n, t)),
        this._set_deferred_params(t),
        this._build_iframe(n, t.parent_element));
    ...
    (Qe.reform_project = function (t, e) {
      var n =
        `${this.base_url +
this.landing_path}?cmd=reform&token=${t.token}&prjid=${t.prjid}&ps_code=${t.ps_code}`;
      ((this.target_callback = e),
        (n = this._add_common_url_param(n, t)),
        this._set_deferred_params(t),
        this._build_iframe(n, t.parent_element));
    ...
    /**
     * Sends a postMessage command to an ALREADY OPEN Edicus iframe
     * instructing it to change the active project dynamically.
     */
    ...
    (Qe.execute_ddp_block = (t, e) => {
      var n = { ddp_block: t, history_label: e };
      We.edicusSDK.post_to_editor("execute-ddp-block", n);
    }),
    (Qe.open_preview = function (t, e) {
      var n =
        `${this.base_url +
this.preview_path}?cmd=open&token=${t.token}&partner=${t.partner}&uid=${t.uid}&prjid=${t.prjid}&div=${t.div || "host"}&lang=${t.lang || "ko"}&npage=${t.npage || 1}&flow=${t.flow || "horizontal"}${t.options ? "&wait_options=true" : ""}${t.data_row ? "&wait_data_row=true" : ""}${t.zoom ? "&wait_zoom=true" : ""}`;
      (this._set_deferred_params(t),
        this._build_iframe(n, t.parent_element),
        (this.target_callback = e));
    }),
    (Qe.show_tnview = function (t, e) {
      var n =
        `${this.base_url +
this.tnview_path}?cmd=show&token=${t.token}&ps_code=${t.ps_code}&template_uri=${t.template_uri}&div=${t.div || "host"}&lang=${t.lang || "ko"}&npage=${t.npage || 1}&flow=${t.flow || "horizontal"}${t.options ? "&wait_options=true" : ""}${t.data_row ? "&wait_data_row=true" : ""}${t.zoom ? "&wait_zoom=true" : ""}`;
      (this._set_deferred_params(t),
        this._build_iframe(n, t.parent_element),
        (this.target_callback = e));
    }),
    (Qe.create_tnview = function (t, e) {
      var n =
        `${this.base_url +
this.tnview_path}?cmd=create&token=${t.token}&ps_code=${t.ps_code}&template_uri=${t.template_uri}&div=${t.div || "host"}&lang=${t.lang || "ko"}&npage=${t.npage || 1}&flow=${t.flow || "horizontal"}${t.options ? "&wait_options=true" : ""}${t.data_row ? "&wait_data_row=true" : ""}${t.zoom ? "&wait_zoom=true" : ""}`;
      (this._set_deferred_params(t),
        this._build_iframe(n, t.parent_element),
        (this.target_callback = e));
    }),
    (Qe.open_tnview = function (t, e) {
      var n =
        `${this.base_url +
this.tnview_path}?cmd=open&token=${t.token}&prjid=${t.prjid}&div=${t.div || "host"}&lang=${t.lang || "ko"}&npage=${t.npage || 1}&flow=${t.flow || "horizontal"}${t.options ? "&wait_options=true" : ""}${t.data_row ? "&wait_data_row=true" : ""}${t.zoom ? "&wait_zoom=true" : ""}`;
      (this._set_deferred_params(t),
        this._build_iframe(n, t.parent_element),
        (this.target_callback = e));
    }),
    (Qe.show_gallery = function (t, e) {
      var n =
        `${this.base_url +
this.tnview_path}?cmd=gallery&token=${t.token}&div=${t.div || "host"}&lang=${t.lang || "ko"}${t.options ? "&wait_options=true" : ""}${t.data_feed ? "&wait_data_feed=true" : ""}${t.data_row ? "&wait_data_row=true" : ""}`;
      (this._set_deferred_params(t),
        this._build_iframe(n, t.parent_element),
        (this.target_callback = e));
    }),
    (Qe.create_lite_project = function (t, e) {
      var n =
        `${this.base_url +
this.lite_path}?cmd=create&token=${t.token}&ps_code=${t.ps_code}&template_uri=${t.template_uri}&div=${t.div || "host"}&lang=${t.lang || "ko"}&uilocale=${t.uilocale || "ko"}${t.private_css ? "&wait_private_css=true" : ""}${t.prod_info ? "&wait_prod_info=true" : ""}${t.size_option ? "&wait_size_option=true" : ""}${t.rsc_option ? "&wait_rsc_option=true" : ""}`;
      (this._set_deferred_params(t),
        this._build_iframe(n, t.parent_element),
        (this.target_callback = e));
    }),
    (Qe.open_lite_project = function (t, e) {
      var n =
        `${this.base_url +
this.lite_path}?cmd=open&token=${t.token}&prjid=${t.prjid}&div=${t.div || "host"}&lang=${t.lang || "ko"}&uilocale=${t.uilocale || "ko"}${t.private_css ? "&wait_private_css=true" : ""}${t.prod_info ? "&wait_prod_info=true" : ""}${t.size_option ? "&wait_size_option=true" : ""}${t.rsc_option ? "&wait_rsc_option=true" : ""}`;
      (this._set_deferred_params(t),
        this._build_iframe(n, t.parent_element),
        (this.target_callback = e));
    }),
    (Qe.show_lite_editor = function (t, e) {
      var n =
        `${this.base_url +
this.lite_path}?cmd=show&token=${t.token}&ps_code=${t.ps_code}&template_uri=${t.template_uri}&div=${t.div || "host"}&lang=${t.lang || "ko"}&uilocale=${t.uilocale || "ko"}${t.private_css ? "&wait_private_css=true" : ""}${t.prod_info ? "&wait_prod_info=true" : ""}${t.size_option ? "&wait_size_option=true" : ""}${t.rsc_option ? "&wait_rsc_option=true" : ""}`;
      (this._set_deferred_params(t),
        this._build_iframe(n, t.parent_element),
        (this.target_callback = e));
    }),
    (Qe.post_to_editor = function (t, e) {
      var n = { type: "to-edicus", action: t, info: e };
      this.iframe_el.contentWindow.postMessage(JSON.stringify(n), "*");
    }),
    (Qe.post_to_tnview = function (t, e) {
      var n = { type: "to-edicus-tnview", action: t, info: e };
      this.iframe_el.contentWindow.postMessage(JSON.stringify(n), "*");
    }),
    (Qe.post_to_preview = function (t, e) {
      var n = { type: "to-edicus-preview", action: t, info: e };
      this.iframe_el.contentWindow.postMessage(JSON.stringify(n), "*");
    }),
    (Qe._build_iframe = function (t, e) {
      ((this.iframe_el = document.createElement("iframe")),
        this.iframe_el.setAttribute("src", t),
        this.iframe_el.setAttribute("frameborder", 0),
        (this.iframe_el.style.width = "100%"),
        (this.iframe_el.style.height = "100%"),
        e.appendChild(this.iframe_el));
    }),
    (Qe._set_deferred_params = function (t) {
      (t.ddp_block
        ? (console.log("detect_ddp", t.ddp_block),
          (this.ddp_block = t.ddp_block))
        : (this.ddp_block = null),
        t.private_css
          ? (this.private_css = t.private_css)
          : (this.private_css = null),
        t.prod_info
          ? (console.log("detect_prod_info", t.prod_info),
            (this.prod_info = t.prod_info))
          : (this.prod_info = null),
        t.options
          ? (console.log("detect_options", t.options),
            (this.options = t.options))
          : (this.options = null),
        t.data_feed
          ? (console.log("detect_date_feed", t.data_feed),
            (this.data_feed = t.data_feed))
          : (this.data_feed = null),
        t.data_row
          ? (console.log("detect_initial_data_row", t.data_row),
            (this.data_row = t.data_row))
          : (this.data_row = null),
        t.zoom
          ? (console.log("detect_zoom", t.zoom), (this.zoom = t.zoom))
          : (this.zoom = null),
        t.show3d
          ? (console.log("detect_show3d", t.show3d), (this.show3d = t.show3d))
          : (this.show3d = null),
        t.size_option
          ? (console.log("detect_size_option", t.size_option),
            (this.size_option = t.size_option))
        ...
        t.template_list
          ? (console.log("detect_template_list", t.template_list),
            (this.template_list = t.template_list))
          : (this.template_list = null),
        t.option_string
          ? (this.option_string = t.option_string)
          : (this.option_string = null));
    }));

  /**
   * ============================================================================
   * REDPRINTING API CLIENT (Class a)
   * ============================================================================
   * Manages HTTP communication with makers.redprinting.net.
   * Automatically handles the `red-editor-token`, user session metadata, and endpoints.
   */
  ...
  var a = (() => {
      ...
      (_classCallCheck(this, n),
        (this.baseUrl =
          "product" === e
            ...
            : "dev" === e
              ? "https://dev.makers.redprinting.net/"
              : "http://172.17.6.47:6500/"),
        (this.token = t));
    }
    return _createClass(n, [
      ...
      /**
       * Core API Router Method.
       * Sends a multipart/form-data POST request to the /editor API endpoint.
       * Automatically binds active user context (uid, email, staffCode).
       * @param {string} t - Target operation (e.g., 'tentativeOrder', 'cloneProject', 'getProductInfo')
       * @param {string} e - Collection ID or override ID
       * @param {Object} n - Additional query payload
       */
       ...
       */
      {
        ...
        value(t, e, n) {
          var r = this,
            o = new FormData();
          (o.append("target", t),
            o.append("uid", D("userId")),
            o.append("email", D("email")),
            o.append("staffCode", D("staffCode")),
            [
              "projectThumbnail",
              "deleteProject",
              "tentativeOrder",
              ...
              ? (e
                  ? o.append("collectionId", e)
                  : o.append("collectionId", D("projectId")),
                "cloneProject" === t &&
                  (n.projectOwnerId &&
                    o.append("projectOwnerId", n.projectOwnerId),
                  (n = null)))
              : "cancelOrder" === t && o.append("collectionId", D("orderId")),
            n && o.append("qry", JSON.stringify(n)));
          ...
          return new Promise((t, e) => {
            ...
            ((n.onreadystatechange = () => {
              4 == n.readyState && 200 == n.status
                ...
                : 4 == n.readyState &&
                  200 != n.status &&
                  e({ code: n.status, message: JSON.parse(n.responseText) });
            }),
              n.open("POST", i),
              n.setRequestHeader("red-editor-token", r.token),
              n.send(o));
          });
        },
      },
        ...
        value() {
          ...
          return new Promise((t, e) => {
            ...
            ((n.onreadystatechange = () => {
              ...
              n.open("GET", r),
              n.setRequestHeader("red-editor-token", o.token),
              n.send());
          });
        },
      },
      {
        ...
        value(o, i) {
          ...
          return new Promise((t, e) => {
            var n = new XMLHttpRequest(),
              r =
                `${a.baseUrl}v1/templates/${o}${"function" == typeof i || 0 === Object.keys(i).length
  ? ""
  : c(i)}`;
            ((n.onreadystatechange = () => {
              4 == n.readyState && 200 == n.status
              ...
              n.open("GET", r),
              n.setRequestHeader("red-editor-token", a.token),
              n.send());
          });
        },
      },
      {
        ...
        value(t, e, o) {
          ...
          new Promise((t, e) => {
            var n = new XMLHttpRequest(),
              r =
                `${i.baseUrl}v1/resources/resource/query${"function" == typeof o || 0 === Object.keys(o).length
  ? ""
  : c(o)}`;
            ((n.onreadystatechange = () => {
              4 == n.readyState && 200 == n.status
              ...
              n.open("GET", r),
              n.setRequestHeader("red-editor-token", i.token),
              n.send());
          });
        },
      },
        ...
        value(o, i) {
          ...
          return new Promise((t, e) => {
            ...
            ((n.onreadystatechange = () => {
              4 == n.readyState && 200 == n.status
                ? t(n.responseText)
                : 4 == n.readyState && 200 != n.status && e(n.statusText);
            }),
              n.open("PUT", r),
              n.setRequestHeader("red-editor-token", a.token),
              n.send());
      ...
      /**
       * Verifies the active JWT token with the backend.
       * If verified, updates the local refresh token state.
       */
       ...
       */
      {
        ...
        value() {
          ...
          ((n.onreadystatechange = () => {
            ...
            n.setRequestHeader("red-editor-token", this.token));
          n.send(JSON.stringify({ type: "verify" }));
        },
      },

      /**
       * Exchanges the current refreshToken for a new short-lived access token.
       */
        ...
        value(r) {
          ...
          ((i.onreadystatechange = () => {
            if (4 == i.readyState && 200 == i.status) {
              ...
              ((o.token = e),
                (o.refreshToken = n),
                r && r(null, { token: e, refreshToken: n }));
            }
          }),
            i.open("POST", t),
            i.setRequestHeader("content-type", "application/json"),
            i.setRequestHeader("red-editor-token", this.token));
          var e = { type: "refresh", refreshToken: this.refreshToken };
        ...
        value(o) {
          ...
          return new Promise((e, n) => {
            ...
            ((r.onreadystatechange = () => {
              ...
              r.open("GET", t),
              r.setRequestHeader("red-editor-token", i.token),
              r.send());
          });
        },
      },
        ...
        1: [
          function (n, t, e) {
            ((t => {
              ...
              if ((n(327), n(328), n(2), t._babelPolyfill))
                throw new Error(
              ...
              function (n) {
                var r = i(this),
                  ...
                  t = function t() {
                    ...
                    return this instanceof t ? ((t, e, n) => {
                          if (!(e in u)) {
                            for (var r = [], o = 0; o < e; o++)
                              r[o] = `a[${o}]`;
                            u[e] = Function(
            ...
            var a = t(72).f,
              ...
              g = ({_i, _f}, e) => {
                var n,
                  r = d(e);
                if ("F" !== r) return _i[r];
                for (n = _f; n; n = n.n) if (n.k == e) return n;
              };
            e.exports = {
              getConstructor(t, i, n, r) {
                var o = t((t, e) => {
                  (l(t, o, i, "_i"),
                    (t._t = i),
                    (t._i = c(null)),
                ...
                return s(o.prototype, {
                  clear() {
                    for (var t = h(this, i), e = t._i, n = t._f; n; n = n.n)
                      ((n.r = !0),
            ...
            e.exports = (r, t, e, n, o, i) => {
              ...
              if (
                ...
                (v ||
                  ...
                  (h || g) && (f("delete"), f("has"), o && f("get")),
                  (g || d) && f(s),
                  i && u.clear && delete u.clear);
              } else
                ((c = n.getConstructor(t, r, o, s)),
                  b(c.prototype, e),
                  (x.NEED = !0));
              return (
                T(c, r),
              ...
              !r(() => {
                ...
                ? function () {
                    ...
                    var t = this,
                      ...
                      r = e < 0 ? "-" : 9999 < e ? "+" : "";
                    return `${r +
(`00000${Math.abs(e)}`).slice(r ? -6 : -4)}-${a(t.getUTCMonth() + 1)}-${a(t.getUTCDate())}T${a(t.getUTCHours())}:${a(t.getUTCMinutes())}:${a(t.getUTCSeconds())}.${99 < n ? n : `0${a(n)}`}Z`;
                  }
                : i;
          },
          { 35: 35 },
              ...
              for (var u, l, f = i, p = 0, d = !!c && _(c, s, 3); p < o; ) {
                if (p in r) {
                  if (
                    ((u = d ? d(r[p], p, n) : r[p]),
                    (l = !1),
                    v(u) && (l = void 0 !== (l = u[y]) ? !!l : h(u)),
                    l && 0 < a)
                  )
                    f = t(e, n, u, g(u.length), f, a - 1) - 1;
                  else {
        ...
        55: [
          (t, e, n) => {
            ...
            e.exports = (t, e, n, r, o, i, a) => {
              ...
              if (
                (y &&
                  (u = T(y.call(new t()))) !== Object.prototype &&
                  u.next &&
                  (I(u, f, !0), m || w(u, P) || k(u, P, j)),
                p &&
                  v &&
                  "values" !== v.name &&
                  ((d = !0),
          ...
          (t, e, n) => {
            ...
            e.exports = () => {
              ...
              if (p)
                ...
                (new u(t).observe(i, { characterData: !0 }),
                  (o = () => {
                    i.data = e = !e;
                  }));
              } else if (f && f.resolve) {
        ...
        76: [
          (t, {exports}, n) => {
            var r = t(117),
              ...
              i = {}.toString,
              a =
                "object" == (void 0 === We ? "undefined" : _typeof(We)) &&
                We &&
        ...
        84: [
          (t, e, n) => {
            ...
            e.exports = c => {
              return t => {
                for (
                  var e, n = u(t), r = s(n), o = r.length, i = 0, a = [];
                  i < o;
                )
                  l.call(n, (e = r[i++])) && a.push(c ? [e, n[e]] : n[e]);
                return a;
              };
            };
          },
          ...
          (t, e, n) => {
            ...
            e.exports = function(...args) {
              ...
              return function(...args) {
                ...
                if (((t = a.slice()), s))
                  for (; n < i; n++) t[n] === c && (t[n] = args[r++]);
                for (; r < e; ) t.push(args[r++]);
                return u(o, t, this);
              };
            };
          },
        ...
        94: [
          (t, e, n) => {
            var i = t(40),
              ...
              r = Function.toString,
              u = (`${r}`).split("toString");
            ((t(23).inspectSource = t => {
              return r.call(t);
            }),
              (e.exports = (t, e, n, r) => {
                var o = "function" == typeof n;
                (o && (c(n, "name") || a(n, "name", e)),
                  t[e] !== n &&
                    (o &&
                      (c(n, s) ||
                        a(n, s, t[e] ? `${t[e]}` : u.join(String(e)))),
                    t === i
                      ? (t[e] = n)
                      : r
                        ? t[e]
        ...
        98: [
          (t, e, n) => {
            ...
            e.exports = t => {
              r(r.S, t, {
                of(...args) {
                  for (var t = args.length, e = Array(t); t--; )
                    e[t] = args[t];
                  return new this(e);
                },
              });
          ...
          (t, e, n) => {
            if (t(29)) {
              var _ = t(60),
                ...
                Pt = (t, e) => {
                  for (var n = 0, r = e.length, o = It(t, r); n < r; )
                    o[n] = e[n++];
                  return o;
                },
                Ot = (t, e, n) => {
                ...
                Ct = function(...args) {
                  for (
                    var t = 0, e = args.length, n = It(this, e);
                    t < e;
                  )
                    n[t] = args[t++];
                  return n;
                ...
                Mt = function(...args) {
                  return dt.apply(Rt ? ft.call(Et(this)) : Et(this), args);
                },
                Nt = {
                  copyWithin(t, e) {
                    return D.call(
                ...
                Bt = (t, e, n) => {
                  return !(Dt(t, (e = s(e, !0))) && T(n) && u(n, "value")) ||
                    u(n, "get") ||
                    u(n, "set") ||
                    n.configurable ||
                ...
                (e.exports = (t, f, e, o) => {
                  ...
                  c
                    ? ((d = e((t, e, n, r) => {
                        ...
                        if (T(e)) {
                          if (
                            ...
                            return mt in e ? Pt(d, e) : jt.call(d, e);
                          ((o = e), (u = St(n, f)));
                          var l = e.byteLength;
                          if (void 0 === r) {
                        ...
                        for (
                          w(t, "_d", { b: o, o: u, l: i, e: a, v: new K(o) });
                          s < a;
                        )
                          h(t, s++);
                      })),
                    ...
                    : (m(() => {
                      ...
                      Y(
                        n !== Function.prototype ? j(a).concat(j(n)) : j(a),
                        t => {
                          t in d || w(d, t, a[t]);
                        },
                      ),
                  ...
                  (w(d, gt, !0),
                    ...
                    "BYTES_PER_ELEMENT" in u || w(u, "BYTES_PER_ELEMENT", f),
                    b(b.P, p, Nt),
                    L(p),
                    b(b.P + b.F * wt, p, { set: Lt }),
                    b(b.P + b.F * !v, p, At),
                    _ || u.toString == pt || (u.toString = pt),
                    b(
                      b.P +
                        b.F *
                          m(() => {
        ...
        122: [
          (t, e, n) => {
            function r(t, e, n) {
              ...
              for (
                (t = A(t)) != t || t === F
                  ...
                  : ((r = U(B(t) / z)),
                    t * (i = D(2, -r)) < 1 && (r--, (i *= 2)),
                    2 <= (t += 1 <= r + u ? l / i : l * D(2, 1 - u)) * i &&
                      (r++, (i /= 2)),
                    s <= r + u
                      ? ((o = 0), (r = s))
                      : 1 <= r + u
                        ? ((o = (t * i - 1) * D(2, e)), (r += u))
                        : ((o = t * D(2, u - 1) * D(2, e)), (r = 0)));
                8 <= e;
                a[f++] = 255 & o, o /= 256, e -= 8
              );
              for (
            ...
            function d(t, e, n, r, o, i) {
              ...
              for (var c = t[H]._b, s = a + t[G], u = r(+o), l = 0; l < e; l++)
                c[s + l] = u[i ? l : e - l - 1];
            }
            var h = t(40),
              v = t(29),
        ...
        129: [
          (t, e, n) => {
            var r = t(17),
              o = t(128)("iterator"),
              i = t(58);
            e.exports = t(23).getIteratorMethod = t => {
              ...
              "Array",
              {
                from(t) {
                  var e,
                    ...
                    f = y(i);
                  if (
                    (u && (s = p(s, 2 < c ? arguments[2] : void 0, 2)),
                    null == f || (a == Array && v(f)))
                  )
                    for (n = new a((e = g(i.length))); l < e; l++)
                      _(n, l, u ? s(i[l], l) : i[l]);
                  else
                    for (o = f.call(i), n = new a(); !(r = o.next()).done; l++)
                      _(n, l, u ? h(o, s, [r.value, l], !0) : r.value);
                  return ((n.length = l), n);
                },
              },
            );
            ...
            r(r.P + r.F * (s || !t(105)(c)), "Array", {
              lastIndexOf(t) {
                ...
                var e = o(this),
                  ...
                  r = n - 1;
                for (
                  1 < arguments.length && (r = Math.min(r, i(arguments[1]))),
                    r < 0 && (r = n + r);
                  0 <= r;
                  r--
                )
        ...
        160: [
          (t, e, n) => {
            ...
            e.exports = t(22)(
              ...
              t => {
                return function(...args) {
                  return t(this, 0 < args.length ? args[0] : void 0);
                };
              },
              {
                get(t) {
        ...
        169: [
          (t, e, n) => {
            ...
            r(r.S, "Math", {
              hypot(t, e) {
                for (
                  var n, r, o = 0, i = 0, a = arguments.length, c = 0;
                  i < a;
                )
                  c < (n = s(arguments[i++]))
                    ? ((o = o * (r = c / n) * r + 1), (c = n))
        ...
        188: [
          (t, e, n) => {
            var r = t(33),
              ...
              d = (t, e) => {
                for (var n = -1, r = e; ++n < 6; )
                  ((r += t * a[n]), (a[n] = r % 1e7), (r = i(r / 1e7)));
              },
              h = t => {
                for (var e = 6, n = 0; 0 <= --e; )
                  ((n += a[e]), (a[e] = i(n / t)), (n = (n % t) * 1e7));
              },
              v = () => {
                for (var t = 6, e = ""; 0 <= --t; )
                  if ("" !== e || 0 === t || 0 !== a[t]) {
          ...
          (n, t, e) => {
            var r,
              ...
              P = !!(() => {
                try {
                  var t = S.resolve(1),
                    e = ((t.constructor = {})[n(128)("species")] = t => {
                      t(I, I);
                    });
                  return (
              ...
              C = (u, e) => {
                if (!u._n) {
                  ...
                  var n = u._c;
                  y(() => {
                    for (var c = u._v, s = 1 == u._s, t = 0; n.length > t; )
                      !(t => {
                        var e,
                          n,
                          r = s ? t.ok : t.fail,
                        ...
                        try {
                          r
                            ? (s || (2 == u._h && N(u), (u._h = 1)),
                              !0 === r
                                ? (e = c)
                                : (a && a.enter(), (e = r(c)), a && a.exit()),
                              e === t.promise
                                ? i(k("Promise-chain cycle"))
                                : (n = j(e))
                                  ? n.call(e, o, i)
                                  : o(e))
                            : i(c);
            ...
            (P ||
              ...
              f(f.S + f.F * (c || !P), "Promise", {
                resolve(t) {
                  return t instanceof S && O(t.constructor, this)
                    ? t
                    : x(this, t);
                },
              }),
            ...
            r(r.S + r.F * (d || h), "Reflect", {
              construct(t, e) {
                ...
                if (t == n) {
                  ...
                  var r = [null];
                  return r.push(...e), new (f.apply(t, r))();
                }
                var o = n.prototype,
              ...
              set: function t(e, n, r) {
                ...
                return f(c, "value")
                  ? !(
                      !1 === c.writable ||
                      !h(a) ||
                      (((o = u.f(a, n) || p(0)).value = r), s.f(a, n, o), 0)
                    )
                  : void 0 !== c.set && (c.set.call(a, r), !0);
              },
            });
          },
                ...
                a = function (t, e) {
                  ...
                  for (
                    ...
                    !(
                      ...
                      !_ &&
                        1 < o[g] &&
                        o[0].replace(r, function(...args) {
                          for (c = 1; c < args[g] - 2; c++)
                            void 0 === args[c] && (o[c] = void 0);
                        }),
                      1 < o[g] && o.index < n[g] && v.apply(s, o.slice(1)),
                      (a = o[0][g]),
                      (l = i),
                      s[g] >= f)
                    );
        ...
        254: [
          (t, e, n) => {
            var r = t(40),
              ...
              K = (t, e) => {
                m(t);
                for (var n, r = _((e = b(e))), o = 0, i = r.length; o < i; )
                  J(t, (n = r[o++]), e[n]);
                return t;
              },
              Y = function (t) {
              ...
              X = t => {
                for (var e, n = j(b(t)), r = [], o = 0; n.length > o; )
                  a(D, (e = n[o++])) || e == N || e == s || r.push(e);
                return r;
              },
              Z = t => {
                for (
                  var e, n = t === B, r = j(n ? U : b(t)), o = [], i = 0;
                  r.length > i;
                )
                  !a(D, (e = r[i++])) || (n && !a(B, e)) || o.push(D[e]);
                return o;
              };
            (z ||
              (c(
                (C = function(...args) {
                  ...
                  var n = p(0 < args.length ? args[0] : void 0);
                  return (
                    o &&
                      W &&
                      G(B, n, {
                        ...
                        set: function t(e) {
                          (this === B && t.call(U, e),
                            a(this, N) && a(this[N], n) && (this[N][n] = !1),
                            G(this, n, k(1, e)));
                        },
                      }),
                    q(n)
              ...
              (t(82).f = Y),
              (t(78).f = Z),
              o && !t(60) && c(B, "propertyIsEnumerable", Y, !0),
              (h.f = t => {
                return q(d(t));
              })),
              i(i.G + i.W + i.F * !z, { Symbol: C }));
            for (
              var Q =
            ...
            (i(i.S + i.F * !z, "Symbol", {
              ...
              C.prototype[F] || t(42)(C.prototype, F, C.prototype.valueOf),
              f(C, "Symbol"),
              f(Math, "Math", !0),
              f(r.JSON, "JSON", !0));
          },
        ...
        266: [
          (t, e, n) => {
            ...
            l(() => {
              ...
              (c((i = s.getConstructor(g, "WeakMap")).prototype, _),
              (o.NEED = !0),
              r(["delete", "has", "get", "set"], r => {
                var t = y.prototype,
                  o = t[r];
                a(t, r, function (t, e) {
        ...
        296: [
          (t, e, n) => {
            ...
            (f(x.prototype, {
              ...
              forEach(r) {
                var o = this;
                return new (a.Promise || i.Promise)((t, e) => {
                  s(r);
                  var n = o.subscribe({
                    next(t) {
                      try {
              ...
              f(x, {
                ...
                of(...args) {
                  for (var t = 0, e = args.length, r = Array(e); t < e; )
                    r[t] = args[t++];
                  return new ("function" == typeof this ? this : x)(e => {
                    var n = !1;
                    return o(() => {
                      if (!n) {
            ...
            (function (t) {
              !(t => {
                  ...
                  return (i._invoke = ((i, a, c) => {
                    ...
                    return (t, e) => {
                      ...
                      for (c.method = t, c.arg = e; ; ) {
                        ...
                        "throw" === o.type &&
                          ((s = I), (c.method = "throw"), (c.arg = o.arg));
                      }
                    };
                  })(t, n, a)),
                  i;
                ...
                if (k) x && (R.exports = k);
                  ...
                  ((n.prototype = C.constructor = e),
                    (e.constructor = n),
                    (e[b] = n.displayName = "GeneratorFunction"),
                    ...
                    (k.async = (t, e, n, r) => {
                      ...
                      return k.isGeneratorFunction(e)
                        ? o
                        : o.next().then(({done, value}) => {
                            return done ? value : o.next();
                          });
                    }),
                    r(C),
                    (C[b] = "Generator"),
                    ...
                    (f.prototype = {
                      ...
                      dispatchException(n) {
                        function t(t, e) {
                          return (
                            ...
                            (i.arg = n),
                            (r.next = t),
                            e && ((r.method = "next"), (r.arg = h)),
                            !!e
                          );
                        }
                        if (this.done) throw n;
                        for (
                          var r = this, e = this.tryEntries.length - 1;
                          0 <= e;
                          --e
                        ) {
                      ...
                      complete({type, arg}, e) {
                        ...
                        return "break" === type || "continue" === type
                          ? (this.next = arg)
                          : "return" === type
  ...
  var D = (t, e) => {
      if (void 0 !== e) {
        ...
        return (
          "userId" === t && 64 < n.length && (n = n.slice(0, 64)),
  ...
  "object" === _typeof(n[e]) ? JSON.stringify(n[e]) : n[e],
)}`,
    ),
    t;
  }, [])
  .join("&")}`;
    ...
    H = t => {
      return (
        J({ message: t, projectId: null, data: null, level: "error" }),
        null
      );
    },
    x = t => {
    ...
    s = ({data}) => {
      if (data && "string" == typeof data && data.match(/^{.*}$/g)) {
        var e = JSON.parse(data);
        "KOI-SDK" == e.target &&
          "refreshToken" == e.action &&
          en.setToken(e.info.token);
      }
    },
    M = null,
    W = null,
  ...
  return `${t}${e}=${n[e]}&`;
    ...
    G = (t, e) => {
      ...
      {
        commands: t.reduce((t, e) => {
          if (
            e.hiddenItems &&
            e.hiddenItems.constructor === new Array().constructor
          ) {
            var n = !0,
              r = !1,
              o = void 0;
            try {
              for (
                var i, a = e.hiddenItems[Symbol.iterator]();
                !(n = (i = a.next()).done);
                n = !0
              ) {
                var c = i.value,
                ...
                ("name" === c.type
                  ? (s.target.name = c.target)
                  : "item" === c.type
                    ? (s.target.var_id = c.target)
                    : "layer" === c.type && (s.target.postlayer = c.target),
                  c.pageIndex && (s.target.page_index = c.pageIndex),
                  c.itemId && (s.target.item_id = c.itemId),
                  "document" === c.scope && (s.target.object = "all-items"),
                  (s.data = { hidden: void 0 === c.value || c.value }),
                  t.push(s));
              }
            } catch (t) {
              ((r = !0), (o = t));
          ...
          if (
            e.deletePages &&
            e.deletePages.constructor === new Array().constructor
          ) {
            var u = !0,
              l = !1,
              f = void 0;
            try {
              for (
                var p, d = e.deletePages[Symbol.iterator]();
                !(u = (p = d.next()).done);
                u = !0
              ) {
                var h = p.value,
                  v = { action: "delete-page", target: { object: "page" } };
                ("index" === h.target
                  ? (v.target.index = h.value)
                  : "cover" === h.target
                    ? (v.target.type = h.target)
                    : "subType" === h.target && (v.target.subType = h.value),
                  (v.data = { store_to_pool: !0 }),
                  t.push(v));
              }
            } catch (t) {
              ((l = !0), (f = t));
          ...
          if (
            e.setItems &&
            e.setItems.constructor === new Array().constructor
          ) {
            var g = !0,
              _ = !1,
              y = void 0;
            try {
              for (
                var m, b = e.setItems[Symbol.iterator]();
                !(g = (m = b.next()).done);
                g = !0
              ) {
                var x = m.value,
                  k = {};
                ((k.action =
                  "cell" === x.type ? "set-cell-src" : "set-item-src"),
                  (k.target = { object: "item" }),
                  x && x.target && "background" === x.target.type
                    ? ((k.target.type = x.target.type),
                      (k.data = { src: x.data.src }))
                    : (x.tid
                        ? (k.target.item_id = x.tid)
                        : (x.id && (k.target.var_id = x.id),
                          x.name && (k.target.name = x.name)),
                      (k.data = { src: x.src }),
                      x.srcSize && (k.data.srcSize = x.srcSize),
                      x.scaleType && (k.data.scaleType = x.scaleType),
                      "center" === x.scaleType &&
                        x.srcSize &&
                        (k.data.size_mm = x.srcSize),
                      x.nocache && (k.data.nocache = x.nocache)),
                  t.push(k));
              }
            } catch (t) {
              ((_ = !0), (y = t));
          ...
          if (
            e.setAttributes &&
            e.setAttributes.constructor === new Array().constructor
          ) {
            var w = !0,
              S = !1,
              E = void 0;
            try {
              for (
                var I, T = e.setAttributes[Symbol.iterator]();
                !(w = (I = T.next()).done);
                w = !0
              ) {
                var P = I.value;
                if ("page" === P.type) {
                  var O = { action: "set-page-attribute" };
                  ((O.target = { object: "page", index: P.target }),
                    (O.data = P.data),
                    t.push(O));
                }
                if ("layer" === P.type) {
                  ...
                  ((j.target = {
                    ...
                    (j.data = {}),
                    "color" === P.data.attribute &&
                      ("textbox" === P.target
                        ? ((j.action = "set-text-style"),
                          (j.data.fontColor = P.data.value))
                        : "svgart" === P.target
                          ? ((j.action = "set-item-overlay-src"),
                            (j.data.overlaySrc =
                              `value://color/${P.data.value}`))
                          : ((j.action = "set-item-src"),
                            (j.data.src =
                              `value://color/${P.data.value}${tn(P.data.cmyk)}`))),
                    "textbox" === P.target &&
                      "font" === P.data.attribute &&
                      P.data.font &&
                      (j.data.font = P.data.font),
                    t.push(j));
                }
                if ("item" === P.type) {
                  var C = {};
                  ((C.target = { object: "item", var_id: P.data.id }),
                    P.data.pageIndex &&
                      (C.target.page_index = P.data.pageIndex),
                    P.data.itemId && (C.target.item_id = P.data.itemId),
                    (C.data = {}),
                    "color" === P.data.attribute &&
                      ("textbox" === P.target
                        ? ((C.action = "set-text-style"),
                          (C.data.fontColor = P.data.value))
                        : "svgart" === P.target
                          ? ((C.action = "set-item-overlay-src"),
                            (C.data.overlaySrc =
                              `value://color/${P.data.value}`))
                          : ((C.action = "set-item-src"),
                            (C.data.src = `value://color/${P.data.value}`))),
                    "textbox" === P.target &&
                      "font" === P.data.attribute &&
                      P.data.font &&
                      (C.data.font = P.data.font),
                    t.push(C));
                }
              }
            } catch (t) {
          ...
          if (
            e.clonePages &&
            e.clonePages.constructor === new Array().constructor
          ) {
            var R = !0,
              M = !1,
              N = void 0;
            try {
              for (
                var F, L = e.clonePages[Symbol.iterator]();
                !(R = (F = L.next()).done);
                R = !0
              ) {
                var A = F.value,
                  D = { action: "clone-page" };
                ((D.target = { object: "page", index: A.target }),
                  (D.data = { position: A.value }),
                  t.push(D));
              }
            } catch (t) {
              ((M = !0), (N = t));
          ...
          if (
            e.flipStickers &&
            e.flipStickers.constructor === new Array().constructor
          ) {
            var U = !0,
              B = !1,
              z = void 0;
            try {
              for (
                var H, W = e.flipStickers[Symbol.iterator]();
                !(U = (H = W.next()).done);
                U = !0
              ) {
                var G = H.value,
                  q = { action: "flip-sticker" };
                ((q.target = { object: "item", var_id: G.target }),
                  G.pageIndex && (q.target.page_index = G.pageIndex),
                  G.itemId && (q.target.item_id = G.itemId),
                  (q.data = { direction: G.value }),
                  t.push(q));
              }
            } catch (t) {
              ((B = !0), (z = t));
          ...
          if (
            e.changeLayout &&
            e.changeLayout.constructor === new Array().constructor
          ) {
            var V = !0,
              J = !1,
              K = void 0;
            try {
              for (
                var Y, $ = e.changeLayout[Symbol.iterator]();
                !(V = (Y = $.next()).done);
                V = !0
              ) {
                var X = Y.value,
                  Z = {
                    action: "change-layout",
                    target: { object: "page", position: "active-page" },
                  };
                ((Z.data = {
                  ...
                  en.updateTemplateCount(X.resourceUri || "null", "hit"),
                  t.push(Z));
              }
            } catch (t) {
              ((J = !0), (K = t));
          ...
          if (
            e.copyPageContent &&
            e.copyPageContent.constructor === new Array().constructor
          ) {
            var Q = !0,
              tt = !1,
              et = void 0;
            try {
              for (
                var nt, rt = e.copyPageContent[Symbol.iterator]();
                !(Q = (nt = rt.next()).done);
                Q = !0
              ) {
                var ot = nt.value,
                  it = { action: "copy-page-content" };
                ((it.target = { object: "page", index: ot.copyIndex }),
                  (it.data = { position: ot.pasteIndex }),
                  t.push(it));
              }
            } catch (t) {
              ((tt = !0), (et = t));
          ...
          if (
            (e.newDocument &&
              (t = []).push({ action: "new-document", target: "project" }),
            ...
            try {
              for (
                var ut, lt = e.addPages[Symbol.iterator]();
                !(at = (ut = lt.next()).done);
                at = !0
              ) {
                var ft = ut.value,
                  pt = { action: "add-page", target: "document", data: {} };
                if (
                  (ft.width &&
                    ft.height &&
                    (pt.data.size_mm = {
                  ...
                  ft.count && (pt.data.count = ft.count),
                  ft.template &&
                    ((pt.data.templateUri = ft.template.resourceUri),
                    (pt.data.indexInTemplate = ft.template.targetIndex)),
                  ft.setBackground)
                ) {
                  var dt = ft.bgColor || "#ffffff";
                  ((pt.data.backgroundSrc = `value://color/${dt}`),
                    "transparent" === ft.bgColor &&
                      (pt.data.backgroundSrc = "value://color/transparent"));
                }
                if (ft.cutMargin) {
                  ...
                  try {
                    for (
                      var _t,
                        yt = Object.entries(ft.cutMargin)[Symbol.iterator]();
                      !(ht = (_t = yt.next()).done);
                      ht = !0
                    ) {
          ...
          if (
            e.addItems &&
            e.addItems.constructor === new Array().constructor
          ) {
            var kt = !0,
              wt = !1,
              St = void 0;
            try {
              for (
                var Et, It = e.addItems[Symbol.iterator]();
                !(kt = (Et = It.next()).done);
                kt = !0
              ) {
                var Tt = Et.value,
                ...
                switch (Tt.type) {
                  case "picFrame":
                    ((Pt.action = "add-cell"),
                      (Pt.target = { object: "page", index: Tt.pageIndex }),
                      (Pt.data = {}),
                      Tt.position && Tt.position.constructor === Object
                        ? (Pt.data.rect_mm = {
                            x: Tt.position.x,
                            y: Tt.position.y,
                        ...
                        : (Pt.data.rect_mm = "page-full"),
                      Tt.variable && (Pt.data.variable = Tt.variable),
                      Tt.insertIndex &&
                        (Pt.data.insertIndex = Tt.insertIndex));
                    break;
                  case "sticker":
                    ((Pt.action = "add-sticker"),
                      (Pt.target = { object: "page", index: Tt.pageIndex }),
                      (Pt.data = {}),
                      Tt.src &&
                        (Pt.data.src =
                          `value://svg/base64,${Tt.src.split("base64,")[1]}`),
                      Tt.externalSrc && (Pt.data.src = Tt.externalSrc),
                      Tt.layer && (Pt.data.postLayer = Tt.layer),
                      Tt.position && Tt.position.constructor === Object
                        ? (Pt.data.rect_mm = {
                            x: Tt.position.x,
                            y: Tt.position.y,
          ...
          if (
            e.addExternalImages &&
            e.addExternalImages.constructor === new Array().constructor
          ) {
            var Ot = !0,
              jt = !1,
              Ct = void 0;
            try {
              for (
                var Rt, Mt = e.addExternalImages[Symbol.iterator]();
                !(Ot = (Rt = Mt.next()).done);
                Ot = !0
              ) {
                var Nt = Rt.value,
          ...
          if (
            e.addInternalImages &&
            e.addInternalImages.constructor === new Array().constructor
          ) {
            var Lt = !0,
              At = !1,
              Dt = void 0;
            try {
              for (
                var Ut, Bt = e.addInternalImages[Symbol.iterator]();
                !(Lt = (Ut = Bt.next()).done);
                Lt = !0
              ) {
                var zt = Ut.value;
                if (zt.multi) {
                  var Ht = {
                    ...
                    repeat: zt.repeat,
                    sort_type: "default",
                    srcs: zt.images.map(({key, info}) => {
                      return { src_key: key, src_info: info };
                    }),
                  };
                  ...
                  (zt.tid && (Wt.item_id = zt.tid),
                    zt.rectInfo && (Wt.item_mm = zt.rectInfo),
                    Qe.post_to_editor("add-image", Wt));
                }
              }
            } catch (t) {
              ((At = !0), (Dt = t));
          ...
          if (
            e.setTexts &&
            e.setTexts.constructor === new Array().constructor
          ) {
            var Gt = !0,
              qt = !1,
              Vt = void 0;
            try {
              for (
                var Jt, Kt = e.setTexts[Symbol.iterator]();
                !(Gt = (Jt = Kt.next()).done);
                Gt = !0
              ) {
                var Yt = Jt.value,
                  $t = {
                    ...
                    target: { object: "item", var_id: Yt.variableId },
                    data: {},
                  };
                ((Yt.pageIndex || 0 === Yt.pageIndex) &&
                  ($t.target.page_index = Yt.pageIndex),
                  1 == Yt.shrink && ($t.data.shrink = Yt.shrink),
                  Yt.font &&
                    (Yt.font.family &&
                      Yt.font.style &&
                      ($t.data.font = {
                    ...
                    Yt.font.size && ($t.data.fontSize = Yt.font.size),
                    Yt.font.align && ($t.data.align = Yt.font.align),
                    Yt.font.color &&
                      (($t.data.fontColor = Yt.font.color),
                      Yt.font.cmyk &&
                        ($t.data.fontColorCMYK = tn(Yt.font.cmyk, !0)))),
                  (Yt.value || "" === Yt.value) && ($t.data.text = Yt.value),
                  t.push($t));
              }
            } catch (t) {
              ((qt = !0), (Vt = t));
          ...
          if (
            e.setItemAttributes &&
            e.setItemAttributes.constructor === new Array().constructor
          ) {
            var Xt = !0,
              Zt = !1,
              Qt = void 0;
            try {
              for (
                var te, ee = e.setItemAttributes[Symbol.iterator]();
                !(Xt = (te = ee.next()).done);
                Xt = !0
              ) {
                var ne = te.value,
                ...
                (ne.variableId && (re.target.var_id = ne.variableId),
                  ne.itemId && (re.target.item_id = ne.itemId),
                  (re.data[ne.type] = ne.value),
                  ne.scope && (re.target.scope = ne.scope),
                  ne.target && (re.target.type = ne.target),
                  ne.data && (re.data = ne.data),
                  ne.allItem && (re.target.object = "all-items"),
                  t.push(re));
              }
            } catch (t) {
              ((Zt = !0), (Qt = t));
          ...
          if (
            e.setLayerFeatures &&
            e.setLayerFeatures.constructor === new Array().constructor
          ) {
            var oe = !0,
              ie = !1,
              ae = void 0;
            try {
              for (
                var ce, se = e.setLayerFeatures[Symbol.iterator]();
                !(oe = (ce = se.next()).done);
                oe = !0
              ) {
                var ue = ce.value,
                  le = {
                    ...
                    target: { object: "item", postlayer: ue.target },
                ...
                ("document" === ue.scope &&
                  "object" == _typeof(le.target) &&
                  (le.target.object = "all-items"),
                  t.push(le));
              }
            } catch (t) {
              ((ie = !0), (ae = t));
          ...
          if (
            e.resizePages &&
            e.resizePages.constructor === new Array().constructor
          ) {
            var fe = !0,
              pe = !1,
              de = void 0;
            try {
              for (
                var he, ve = e.resizePages[Symbol.iterator]();
                !(fe = (he = ve.next()).done);
                fe = !0
              ) {
                var ge = he.value,
                  _e = {
                    action: "resize-page",
                    target: { object: "page", index: ge.pageIndex },
                    data: {
                      size_mm: { width: ge.width, height: ge.height },
          ...
          if (
            e.imposePages &&
            e.imposePages.constructor === new Array().constructor
          ) {
            var ye = !0,
              me = !1,
              be = void 0;
            try {
              for (
                var xe, ke = e.imposePages[Symbol.iterator]();
                !(ye = (xe = ke.next()).done);
                ye = !0
              ) {
                var we = xe.value,
          ...
          if (
            e.addPageGroup &&
            e.addPageGroup.constructor === new Array().constructor
          ) {
            var Ee = !0,
              Ie = !1,
              Te = void 0;
            try {
              for (
                var Pe, Oe = e.addPageGroup[Symbol.iterator]();
                !(Ee = (Pe = Oe.next()).done);
                Ee = !0
              ) {
                var je = Pe.value,
                  Ce = {
                    ...
                    target: "document",
                    data: { pages: je.pages, printCount: je.printCount },
                  };
                t.push(Ce);
              }
            } catch (t) {
          ...
          if (
            e.clonePageGroup &&
            e.clonePageGroup.constructor === new Array().constructor
          ) {
            var Re = !0,
              Me = !1,
              Ne = void 0;
            try {
              for (
                var Fe, Le = e.clonePageGroup[Symbol.iterator]();
                !(Re = (Fe = Le.next()).done);
                Re = !0
              ) {
                var Ae = {
                  action: "clone-page-group",
                  target: { object: "group", position: "active-group" },
                  data: {
          ...
          if (
            e.changeGroupInfo &&
            e.changeGroupInfo.constructor === new Array().constructor
          ) {
            var De = !0,
              Ue = !1,
              Be = void 0;
            try {
              for (
                var ze, He = e.changeGroupInfo[Symbol.iterator]();
                !(De = (ze = He.next()).done);
                De = !0
              ) {
                var We = ze.value,
                  Ge = {
                    ...
                    target: { object: "group", index: We.index },
                    data: We.data,
                  };
                t.push(Ge);
              }
          ...
          if (e.setPageAttribute) {
            ...
            try {
              for (
                var Ke, Ye = e.setPageAttribute[Symbol.iterator]();
                !(qe = (Ke = Ye.next()).done);
                qe = !0
              ) {
                var $e = Ke.value,
                  Xe = {
                    ...
                    target: { object: "page", index: $e.index },
                    data: { selectedKey: $e.selectKey },
                  };
                t.push(Xe);
              }
            } catch (t) {
          ...
          if (e.setPostLayer) {
            var Ze = {
              action: "set-item-attribute",
              target: { object: "item", name: "postlayer" },
              data: { postLayer: e.setPostLayer },
            };
            t.push(Ze);
          }
          return t;
    ...
    q = ({data}) => {
      if (data && "string" == typeof data && data.match(/^{.*}$/g)) {
        var e = JSON.parse(data);
        if (e && "From-KOI-Passive" === e.target)
          switch (e.type) {
            case "load":
    ...
    V = null,
    J = ({message, projectId, data, level}) => {
      var e = message,
        n = projectId,
        r = data,
        o = level,
      ...
      try {
        V.withScope(t => {
          (t.setUser({ id: D("userId"), username: D("userId") }),
            t.setTag("projectId", n),
            t.setTag("editorBaseURL", Qe.base_url),
            K.clone &&
              (t.setTag("originProjectId", K.originProjectId),
              (r.clone = !0),
              (r.originProjectId = K.originProjectId)),
            t.setExtras(r),
    ...
    t = (() => {
      function o(t) {
        ...
        ((n.version = "6.6.48"),
          (n.isDev = !1),
          (K.fromKOIPassive = t.fromKOIPassive),
          (K.mode = "standard"),
          (K.deviceTarget = "pc"));
        try {
          U(["accessToken"], t);
        } catch (t) {
          (H && H.constructor === Function && ((t.code = "002"), H(t)),
            console.error(t));
        } finally {
          var e =
            "local" === t.sandboxMode
              ...
              : t.sandboxMode
                ...
                : "product";
          if (
            ((en = new a(t.accessToken, e)),
            t.inheritToken ||
              (en.verifyToken(),
              en.autoRefreshToken((t, {token}) => {
                if (L) {
                  var n = {
                    target: "KOI-SDK",
                    action: "refreshToken",
            ...
            (n.isDev = t.sandboxMode),
            Qe.init(n.isDev, t.initialStageUrl),
            We.addEventListener("message", s, !1),
            t.userId)
          )
            (D("userId", t.userId),
              en
                .call("issueUserToken")
                .then(({division, lang, companyCode, token}) => {
                  (division && D("division", division),
                    lang && D("lang", lang),
                    companyCode && D("companyCode", companyCode));
                  var e = { token: token, expiredAt: new Date().getTime() };
                  (D("editorToken", e), (n.isReady = !0));
                })
                .catch(t => {
                  (H && H.constructor === Function && ((t.code = "003"), H(t)),
                    console.error(t));
                }));
          else
            try {
          ...
          (t.email && D("email", t.email), t.staffCode && D("staffCode", t.staffCode), (() => {
            var t = new i.BrowserClient({
              ...
              integrations: [].concat(
                _toConsumableArray(i.defaultIntegrations),
              ),
              normalizeDepth: 8,
              release: "v6.6.48",
            });
      ...
      return _createClass(o, [
                  ...
                  switch ((t.prev = t.next)) {
                    ...
                    case 2:
                      if (
                        ...
                        (K.openType = "CREATE"),
                        (K.clone = !1),
                        (K.originProjectId = null),
                        (K.params = JSON.parse(
                          JSON.stringify({ editorConfig: e, options: n }),
                        )),
                        We.__KOI_EVENT_LISNTER_INITIALIZE || Qe.init(r.isDev),
                        this.isReady)
                      ) {
                        t.next = 16;
                        break;
                    ...
                    case 23:
                      if (
                        ...
                        e.psCode &&
                          ...
                          ((n = n || {}).deletePages = [{ target: "cover" }]),
                        e.locale && ((n = n || {}).locale = e.locale),
                        !n)
                      ) {
                        t.next = 102;
                        break;
                      ...
                      if (
                        (n.initPageCount &&
                          (e.initPageCount = n.initPageCount),
                        n.maxPage && (e.maxPage = n.maxPage),
                        n.minPage && (e.minPage = n.minPage),
                        n.maxOrder && (e.maxOrder = n.maxOrder),
                        n.testPlugin && (e.testPlugin = !0),
                        n.bundlePageUnit &&
                          (e.bundlePageUnit = n.bundlePageUnit),
                        n.calendarConfig &&
                          "object" === _typeof(n.calendarConfig) &&
                          ((o = new Date()),
                          (i = n.calendarConfig),
                          (a = i.initialYear),
                          (c = i.initialMonth),
                        ...
                        n.addPages &&
                          (e.ddpBlock
                            ...
                            : (e.ddpBlock = G([{ addPages: n.addPages }]))),
                        n.customDocument &&
                          (n.executeList
                            ? (n.executeList = [
                                { newDocument: !0 },
                                {
                                  addPages: n.customDocument.pages.map(
                                    t => {
                                      return ((t.setBackground = !0), t);
                                    },
                                  ),
                                },
                              ].concat(_toConsumableArray(n.executeList)))
                            : ((f = [
                                { newDocument: !0 },
                                {
                                  addPages: n.customDocument.pages.map(
                              ...
                              (e.ddpBlock = G(f))),
                          (e.templateUrl = null)),
                        n.executeList && (e.ddpBlock = G(n.executeList)),
                        n.deletePages &&
                          (e.ddpBlock
                            ? (e.ddpBlock = G(
                        ...
                        n.autoSave &&
                          "number" == typeof n.autoSave &&
                          (W = n.autoSave),
                        n.extra && (e.extra = n.extra),
                        n.locale && (e.locale = n.locale),
                        n.isMobile &&
                          ((e.isMobile = n.isMobile),
                          (K.deviceTarget = "mobile")),
                        n.hideToolbar &&
                          ((e.hideToolbar = n.hideToolbar),
                          (K.mode = "passive")),
                        n.showSetting && (e.showSetting = n.showSetting),
                        n.useVideoFrame &&
                          (e.useVideoFrame = n.useVideoFrame),
                        !n.limitColor && !n.paletteCode)
                      ) {
                        t.next = 71;
                        break;
                      }
                    ...
                    case 54:
                      return (
                        (e.extra.palette = { palCode: n.paletteCode }),
                        t.abrupt("break", 58)
                      );
                    case 56:
                      return (
                    ...
                    case 60:
                      if (
                        ...
                        (e.extra.palette = {}),
                        n.limitColor &&
                          (e.extra.palette.max_color = parseInt(
                            n.limitColor,
                          )),
                        !n.paletteCode)
                      ) {
                    ...
                    case 71:
                      if (
                        ((!0 !== n.setTransparentBackground &&
                          !1 !== n.setTransparentBackground) ||
                          (e.extra || (e.extra = {}),
                          e.extra.background || (e.extra.background = {}),
                          (e.extra.background.set_transparent =
                            n.setTransparentBackground)),
                        (!0 !== n.activeTransparentBackground &&
                          !1 !== n.activeTransparentBackground) ||
                          (e.extra || (e.extra = {}),
                          e.extra.background || (e.extra.background = {}),
                          (e.extra.background.can_transparent =
                            n.activeTransparentBackground)),
                        n.customTabInfo)
                      )
                        return (
                          e.extra || (e.extra = {}),
                          ...
                          (g = p.options),
                          (t.next = 78),
                          regeneratorRuntime.awrap(this.getProductInfo(d))
                        );
                      t.next = 94;
                      break;
                    case 78:
                      return (
                        (_ = t.sent),
                        (t.next = 81),
                        regeneratorRuntime.awrap(this.getTemplateList(d))
                      );
                    case 81:
                      return (
                        (y = t.sent.list),
                    ...
                    case 87:
                      ((x = t.sent),
                        ...
                        x.varMap &&
                          (!e.templateUrl &&
                            x.varMap.$TMPL &&
                            (e.templateUrl = x.varMap.$TMPL),
                          !e.psCode &&
                            x.varMap.$PSCD &&
                            (e.psCode = x.varMap.$PSCD)),
                        (e.extra.custom_tab = x),
                        (k = b.whetherUsePalette(v)) &&
                          (e.extra.palette = _.paletteInfo),
                        console.log(
                          ">>>>>>>>>>>>>",
                          { usePalette: k },
                          { editorConfig: e },
                    ...
                    case 94:
                      (n.useTabless && (e.uiStyle = "tab-less,header-less"),
                        n.hideCustomTab &&
                          (e.uiStyle = "tab-less,hide-custom"),
                        n.setSpine &&
                          (e.extra || (e.extra = {}),
                          e.extra.override || (e.extra.override = {}),
                          (e.extra.override.spine_mm = n.setSpine)),
                        n.documentSizeInfo &&
                          (e.extra || (e.extra = {}),
                          (w = n.documentSizeInfo),
                          (S = w.width),
                          (E = w.height),
                          (I = w.round),
                          (e.extra.sizing = { width_mm: S, height_mm: E }),
                          I && (e.extra.sizing.round_mm = I)),
                        n.setDefaultSelectKey &&
                          (e.ddpBlock
                            ? (e.ddpBlock = G(
                        ...
                        n.minItemSize &&
                          (e.extra || (e.extra = {}),
                          e.extra.override || (e.extra.override = {}),
                          (e.extra.override.min_item_mm = n.minItemSize)),
                        n.tabControl &&
                          (e.extra || (e.extra = {}),
                          e.extra.override || (e.extra.override = {}),
                          (T = Object.keys(n.tabControl).map(t => {
                            return { type: t, value: n.tabControl[t] };
                          })),
                          (e.extra.override.sizeOption = { tabControls: T })),
                        n.changeLayer &&
                          (e.ddpBlock
                            ? (e.ddpBlock = G(
                    ...
                    case 102:
                      if (
                        ...
                        n &&
                          n.unableLayers &&
                          (n.unableLayers.constructor === String().constructor
                            ? (P.unlayers = n.unableLayers)
                            : n.unableLayers.constructor ===
                                Array().constructor &&
                              0 < n.unableLayers.length &&
                              (P.unlayers = n.unableLayers.join(","))),
                        n &&
                          n.resourceParams &&
                          (P.resapi_param = n.resourceParams),
                        n &&
                          n.lockGroupPageCount &&
                          ((P.no_edit_group = n.lockGroupPageCount),
                          (P.edit_lock = "edit-group")),
                        n &&
                          n.disableMasterColorPicker &&
                          ((P.no_edit_group = n.lockGroupPageCount),
                          (P.edit_lock = P.edit_lock
                            ? `${P.edit_lock},set-strict-color`
                            : "set-strict-color")),
                        n &&
                          n.disableFontPreview &&
                          (P.edit_lock = P.edit_lock
                            ? `${P.edit_lock},no-font-preview`
                            : "no-font-preview"),
                        n &&
                          n.disableSelection &&
                          (P.edit_lock = P.edit_lock
                            ? `${P.edit_lock},no-selection`
                            : "no-selection"),
                        n &&
                          n.disableTapeOptions &&
                          (P.edit_lock = P.edit_lock
                            ? `${P.edit_lock},tape-option`
                            : "tape-option"),
                        n &&
                          n.disableAllOption &&
                          (P.edit_lock = "lock-all, edit-custom-tab"),
                        n && n.clearSource && (P.clear_src = n.clearSource),
                        n && n.privateCSS)
                      )
                        return (
                          (t.next = 115),
                          regeneratorRuntime.awrap(
                            this.getCustomCss(n.privateCSS),
                          )
                        );
                      t.next = 116;
                      break;
                    ...
                    case 116:
                      if (
                        (n &&
                          n.preview &&
                          (P.option_string = `file_3d=${n.preview}`),
                        n &&
                          n.pantone &&
                          ((O = n.pantone),
                          (j = O.name),
                          ...
                          (M = O.rgb),
                          (P.option_string =
                            `single_strict_palette=name:${j};dpName:${C};hex:${R};rgb:${M};`)),
                        (N = B()).user)
                      ) {
                        t.next = 121;
                        break;
                    ...
                    case 121:
                      return D("edicusConfig", e),
                      D("targetElement", e.selector),
                      (F = r.editorEventHandler),
                      e.promotionInfo &&
                        (P.options || (P.options = {}),
                        e.promotionInfo.useExternal
                          ? (P.options.promo = { type: "external" })
                          : (P.options.promo = {
                      ...
                      N.token
                        ? ((P.token = N.token),
                          (P.div = D("division")),
                          (P.lang = D("lang")),
                          (P.plugin_param = JSON.stringify(
                            z(D("companyCode"), n && n.pluginCustomData),
                          )),
                          n && n.locale && (P.lang = n.locale),
                          Qe.create_project(P, F),
                          en.updateTemplateCount(
                            P.template_uri || "null",
                            "hit",
                          ))
                        : en
                            .call("issueUserToken")
                            .then(({token, division, lang, companyCode}) => {
                              ((P.token = token),
                                division &&
                                  (D("division", division),
                                  (P.div = division)),
                  ...
                  switch ((t.prev = t.next)) {
                    ...
                    case 2:
                      if (
                        ...
                        (K.openType = "OPEN"),
                        (K.params = JSON.parse(
                          JSON.stringify({ editorConfig: o, options: i }),
                        )),
                        We.__KOI_EVENT_LISNTER_INITIALIZE || Qe.init(a.isDev),
                        this.isReady)
                      ) {
                        t.next = 14;
                        break;
                    ...
                    case 21:
                      ...
                      if (
                        (i.initPageCount &&
                          (o.initPageCount = i.initPageCount),
                        i.maxPage && (o.maxPage = i.maxPage),
                        i.minPage && (o.minPage = i.minPage),
                        i.maxOrder && (o.maxOrder = i.maxOrder),
                        i.testPlugin && (o.force_plugin = !0),
                        i.executeList && (o.ddpBlock = G(i.executeList)),
                        i.autoSave &&
                          "number" == typeof i.autoSave &&
                          (W = i.autoSave),
                        i.extra && (o.extra = i.extra),
                        i.locale && (o.locale = i.locale),
                        i.isMobile &&
                          ((o.isMobile = i.isMobile),
                          (K.deviceTarget = "mobile")),
                        i.hideToolbar &&
                          ((o.hideToolbar = i.hideToolbar),
                          (K.mode = "passive")),
                        i.showSetting && (o.showSetting = i.showSetting),
                        i.clone && (o.clone = i.clone),
                        i.useVideoFrame &&
                          (o.useVideoFrame = i.useVideoFrame),
                    ...
                    case 45:
                      return (
                        (o.extra.palette = { palCode: i.paletteCode }),
                        t.abrupt("break", 49)
                      );
                    case 47:
                      return (
                    ...
                    case 51:
                      if (
                        ...
                        (o.extra.palette = {}),
                        i.limitColor &&
                          (o.extra.palette.max_color = parseInt(
                            i.limitColor,
                          )),
                        !i.paletteCode)
                      ) {
                    ...
                    case 62:
                      if (
                        (!1 === i.setTransparentBackground &&
                          (o.extra || (o.extra = {}),
                          o.extra.background || (o.extra.background = {}),
                          (o.extra.background.set_transparent =
                            i.setTransparentBackground)),
                        (!0 !== i.activeTransparentBackground &&
                          !1 !== i.activeTransparentBackground) ||
                          (o.extra || (o.extra = {}),
                          o.extra.background || (o.extra.background = {}),
                          (o.extra.background.can_transparent =
                        ...
                        return (
                          (t.next = 67),
                          regeneratorRuntime.awrap(
                            this.getCustomCss(i.privateCSS),
                          )
                        );
                      t.next = 68;
                      break;
                    ...
                    case 68:
                      if (i.customTabInfo)
                        return (
                          ...
                          (u = void 0 === s ? {} : s),
                          (t.next = 73),
                          regeneratorRuntime.awrap(this.getProductInfo(n))
                        );
                      t.next = 87;
                      break;
                    case 73:
                      return (
                        (l = t.sent),
                        (t.next = 76),
                        regeneratorRuntime.awrap(this.getTemplateList(n))
                      );
                    case 76:
                      return (
                        (f = t.sent.list),
                        ...
                        (t.next = 83),
                        regeneratorRuntime.awrap(
                          d.getCustomTabFormat(r, c, u),
                        )
                      );
                    case 83:
                      ((h = t.sent),
                        (o.extra.custom_tab = h),
                        d.whetherUsePalette(c) &&
                          (o.extra.palette = l.paletteInfo));
                    case 87:
                      (i.useTabless && (o.uiStyle = "tab-less,header-less"),
                        i.hideCustomTab &&
                          (o.uiStyle = "tab-less,hide-custom"),
                        i.setSpine &&
                          (o.extra || (o.extra = {}),
                          o.extra.override || (o.extra.override = {}),
                          (o.extra.override.spine_mm = i.setSpine)),
                        i.documentSizeInfo &&
                          (o.extra || (o.extra = {}),
                          (v = i.documentSizeInfo),
                          (g = v.width),
                          (_ = v.height),
                          (y = v.round),
                          (o.extra.sizing = { width_mm: g, height_mm: _ }),
                          y && (o.extra.sizing.round_mm = y)),
                        ...
                        i.minItemSize &&
                          (o.extra || (o.extra = {}),
                          o.extra.override || (o.extra.override = {}),
                          (o.extra.override.min_item_mm = i.minItemSize)),
                        i.tabControl &&
                          (o.extra || (o.extra = {}),
                          o.extra.override || (o.extra.override = {}),
                          (m = Object.keys(i.tabControl).map(t => {
                            return { type: t, value: i.tabControl[t] };
                          })),
                          (o.extra.override.sizeOption = { tabControls: m })),
                        i.changeLayer &&
                          (o.ddpBlock
                            ? (o.ddpBlock = G(
                    ...
                    case 95:
                      return (b = t => {
                        var n = {
                          parent_element: document.querySelector(
                            o.selector,
                          ),
                          prjid: t || o.projectId,
                        ...
                        (i &&
                          ...
                          i &&
                            i.resourceParams &&
                            (n.resapi_param = o.resourceParams),
                          i &&
                          ...
                          i &&
                            i.clearSource &&
                            (n.clear_src = i.clearSource),
                          i && i.viewerMode && (n.no_update = i.viewerMode),
                          D("projectId", o.projectId),
                          D("edicusConfig", o),
                          D("targetElement", o.selector));
                        var e = B();
                        if (!e.user) return !1;
                        var r = a.editorEventHandler;
                        (o.promotionInfo &&
                          (n.options || (n.options = {}),
                          o.promotionInfo.useExternal
                            ? (n.options.promo = { type: "external" })
                            : (n.options.promo = {
                      ...
                      !0 === o.clone
                        ? ((x = {}),
                          i &&
                            ...
                            (K.projectOwnerId = i.projectOwnerId)),
                          this.cloneProject(o.projectId, x)
                            .then(t => {
                              ((K.clone = !0),
                                (K.originProjectId = o.projectId),
                                (o.projectId = t),
                                b(t));
                            })
                            .catch(t => {
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ...
                        e &&
                          e.unableLayers &&
                          (e.unableLayers.constructor === String().constructor
                            ? (r.unlayers = e.unableLayers)
                            : e.unableLayers.constructor ===
                                Array().constructor &&
                              0 < e.unableLayers.length &&
                              (r.unlayers = e.unableLayers.join(","))),
                        e &&
                          e.lockGroupPageCount &&
                          ((r.no_edit_group = e.lockGroupPageCount),
                          (r.edit_lock = "edit-group")),
                        e &&
                          e.disableMasterColorPicker &&
                          ((r.no_edit_group = e.lockGroupPageCount),
                          (r.edit_lock = r.edit_lock
                            ? `${r.edit_lock},set-strict-color`
                            : "set-strict-color")),
                        e &&
                          e.disableFontPreview &&
                          (r.edit_lock = r.edit_lock
                            ? `${r.edit_lock},no-font-preview`
                            : "no-font-preview"),
                        e &&
                          e.disableSelection &&
                          (r.edit_lock = r.edit_lock
                            ? `${r.edit_lock},no-selection`
                            : "no-selection"),
                        e.resourceParams &&
                          (r.resapi_param = e.resourceParams),
                        e.clearSource && (r.clear_src = e.clearSource),
                        e.privateCSS)
                      )
                        return (
                          (t.next = 13),
                          regeneratorRuntime.awrap(
                            this.getCustomCss(e.privateCSS),
                          )
                        );
                      t.next = 14;
                      break;
                    ...
                    case 17:
                      ((o = n.editorEventHandler),
                        ...
                        (i = D("staffEditorToken")),
                        (i = JSON.parse(i || "{}")),
                        3e6,
                        (a = {}),
                        new Date().getTime() - i.expiredAt < 3e6
                          ? (a.token = i.token)
                          : (a.token = !1),
                        a.token
                          ? ((r.token = a.token), Qe.edit_template(r, o))
                          : en
                              .call("issueStaffToken")
                              .then(({token}) => {
                                r.token = token;
                                var e = {
                                  token: token,
                                ...
                                (D("staffEditorToken", e),
                                  Qe.edit_template(r, o));
                              })
                              .catch(t => {
                                (H &&
                                  H.constructor === Function &&
        ...
        },
        {
          ...
          value(t) {
            ...
            try {
              ...
              e.token
                ? ((r.token = e.token),
                  Qe.open_tnview(r, this.editorEventHandler))
                : en
                    .call("issueUserToken")
                    .then(({token}) => {
                      r.token = token;
                      ...
                      (D("editorToken", e),
                        Qe.open_tnview(r, n.editorEventHandler));
                    })
                    .catch(t => {
                      (H &&
                        H.constructor === Function &&
        ...
        },
        {
          ...
          value(t, e) {
            ...
            return (
              r && r.constructor === Function && (k = r),
              Qe.post_to_editor("execute-ddp-block", o),
              this
            );
          },
        },
              ...
              commands: [
                {
                  ...
                  target: { object: "page", index: t },
                  data: { position: e },
                },
              ],
            };
            return (
              Qe.post_to_editor("execute-ddp-block", { ddp_block: n }),
              this
            );
          },
        },
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    ...
                    case 5:
                      if (
                        ("project-id-created" === n.action &&
                          (D("projectId", n.info.project_id), l(n)),
                        ("load-project-report" !== n.action &&
                          "edit-template-report" !== n.action) ||
                          "end" !== n.info.status ||
                          ((A = !1),
                          f(n),
                          W &&
                          ...
                          J({
                            message:
                              `[${K.openType}]Editor Loaded${K.fromKOIPassive ? "(KOI-Passive)" : ""}`,
                      ...
                      if (n.info && n.info.template_uri)
                        return (
                          (r = n.info.template_uri.split("/")),
                          (o = r.length),
                          (i = r[o - 1].split(".")[0]),
                          (t.next = 17),
                          regeneratorRuntime.awrap(en.getResourceWithId(i))
                        );
                      t.next = 19;
                      break;
                    case 17:
                      (a = t.sent) && a.template_uri
                        ? en.updateTemplateCount(a.template_uri, "hit")
                        : console.warn("Fail Resource Info LookUp");
                    case 19:
                      F =
                        void 0 !== n.info.vdp_catalog &&
                        null !== n.info.vdp_catalog &&
                        0 < Object.keys(n.info.vdp_catalog).length
                          ? {
                    ...
                    case 20:
                      if (
                        ("page-changed" === n.action && P(n),
                        "promo-external-report" === n.action && y(n),
                        "command-completed" === n.action &&
                          (b.resolve(n),
                          (b.resolve = () => {
                            return null;
                          })),
                        "command-rejected" === n.action &&
                          (b.reject(n),
                          (b.reject = () => {
                            return null;
                          })),
                        "save-doc-report" === n.action &&
                          "end" === n.info.status &&
                          ((c = {
                            message:
                              `[${K.openType}]Editor Saved${K.fromKOIPassive ? "(KOI-Passive)" : ""}`,
                            projectId: D("projectId"),
                            data: _extends({}, n.info, {
                              mode: K.mode,
                              deviceTarget: K.deviceTarget,
                          ...
                          J(c),
                          h(n)),
                        "close" !== n.action && "goto-cart" !== n.action)
                      ) {
                        t.next = 45;
                        break;
                      }
                    ...
                    case 31:
                      (s = t.sent).can_order
                        ? (n.isCanOrder = !0)
                        : ((n.error = s), (n.isCanOrder = !1));
                    case 33:
                      (J({
                        message:
                          `[${K.openType}]Editor Close${K.fromKOIPassive ? "(KOI-Passive)" : ""}`,
                        projectId: D("projectId"),
                        data: _extends({}, n.info, {
                          mode: K.mode,
                          deviceTarget: K.deviceTarget,
                    ...
                    case 45:
                      ("selection-changed" === n.action && v(n),
                        "state-history" === n.action && g(n),
                        "label-history" === n.action && _(n.info),
                        "dpp-execute-report" === n.action &&
                          "end" === n.info.status &&
                          (k && k.constructor === Function && k(),
                          (k = null)),
                        "scene-info-report" === n.action &&
                          N &&
                          N.constructor === Function &&
                          (n.info.activePage &&
                            (n.info.sceneInfo.activePage = n.info.activePage),
                          N(n.info.sceneInfo),
                          (N = null)),
                        "imgpool-notify" === n.action && w(n.info),
                        "preview-closed" === n.action && S(),
                        "font-list" === n.action && E(n.info),
                        ("enter-overlay-mode" !== n.action &&
                          "exit-overlay-mode" !== n.action) ||
                          I(n),
                        "page-count-changed" === n.action && T(n),
                        "request-page-size-change" === n.action && m(n),
                        "request-user-token" === n.action &&
                          en
                            .call("issueUserToken")
                            .then(({division, lang, companyCode, token}) => {
                              (division && D("division", division),
                        ...
                        "impose-opened" === n.action && O(n),
                        "page-group-print-count-changed" === n.action && j(n),
                        "prod-var-changed" == n.action && C(n),
                        "doc-report" == n.action &&
                          ((u = {
                            message:
                              `[${K.openType}]Editor Doc Report ${K.fromKOIPassive ? "(KOI-Passive)" : ""}`,
                            projectId: D("projectId"),
                            data: _extends({}, n.info, {
                              mode: K.mode,
                              deviceTarget: K.deviceTarget,
        ...
        },
        {
          ...
          value(t, e) {
            if ("changeLayout" !== t)
              return Qe.post_to_editor(t, e),
              ["command"].includes(t) && ["close-preview"].includes(e.type)
                ? new Promise((t, e) => {
            ...
            (console.warn(
              "[Deprecated] This Action Will be Deprecated ! Check change API Document, should be use changeLayout method!",
            ),
              Qe.change_layout(e.uri, e.pageIndex, e.isChangeableBackground));
          },
        },
        {
          ...
          value(t, e, n, r) {
            ...
            (void 0 !== e && e.constructor === Function && void 0 === r
              ? (r = e)
              : e && e.constructor === Object && (o.history_label = e),
              void 0 !== n && n.constructor === Function && void 0 === r
                ? (r = n)
                : n && n.constructor === Boolean && (o.reset_history = n),
              r && r.constructor === Function && (k = r),
              o.ddp_block.commands.some(({action, data}) => {
                return "set-text-style" === action
                  ? data.text || "" === data.text
                  : "set-item-src" === action &&
                      data.src &&
                      data.src.includes("color");
              }) && (o.show_progress = !1),
              0 < o.ddp_block.commands.length &&
                Qe.post_to_editor("execute-ddp-block", o));
          },
        },
        {
        ...
        },
        {
          ...
          value(r) {
            ...
            var t = D("userId");
            return new Promise((e, n) => {
              en.call("projectList", t)
                .then(t => {
                  r && "function" == typeof r ? r(null, t) : e(t);
                })
                .catch(t => {
                  (H && H.constructor === Function && H(t),
              ...
              D("division")
                ? en
                    ...
                    .then(({product}) => {
                      ...
                      ((e.userData = JSON.parse(e.userData || "{}")),
                        e.userData &&
                        e.userData.productCustomData &&
                        e.userData.productCustomData[D("division")]
                          ? e.userData.productCustomData[D("division")][
                              e.defaultLanguage
                            ]
                            ? (e.userData =
                ...
                : en
                    ...
                    .then(({division, lang, token}) => {
                      ...
                      (D("editorToken", e),
                        en.call("getProductInfo", r).then(({product}) => {
                          var e = product;
                          ((e.userData = JSON.parse(e.userData || "{}")),
                            e.userData &&
                            e.userData.productCustomData &&
        ...
        },
        {
          ...
          value(t, r, o) {
            ...
            return new Promise((e, n) => {
              en.call("tentativeOrder", t, r)
                .then(t => {
                  (o && "function" == typeof o ? o(null, t) : e(t),
                    en.updateTemplateCount(i.template_uri, "order"));
                })
                .catch(t => {
                  (H && H.constructor === Function && H(t),
                    o && "function" == typeof o ? o(t) : n(t));
                });
            });
          },
        },
                ...
                for (;;)
                  switch ((t.prev = t.next)) {
                    ...
                    case 9:
                      ...
                      if (
                        ((i = JSON.parse(JSON.stringify(e))).size &&
                        ...
                        return (
                          ...
                          (t.prev = 14),
                          (t.next = 17),
                          regeneratorRuntime.awrap(this.getProductInfo(r))
                        );
                      t.next = 27;
                      break;
                    case 17:
                    ...
                    case 27:
                      i.sort &&
                        ...
                        (i.sort = {}),
                        Object.keys(s).map(t => {
                          ["hit", "ordered", "priority"].includes(t)
                            ? (i.sort[`sortReference.${t}`] = s[t])
                            : (i.sort[t] = s[t]);
                        }));
                    case 28:
                      return t.abrupt(
                ...
                for (;;)
                  switch ((t.prev = t.next)) {
                    ...
                    case 10:
                      ...
                      if (
                        ((a = JSON.parse(JSON.stringify(e))).size &&
                    ...
                    case 28:
                      a.sort &&
                        ...
                        (a.sort = {}),
                        Object.keys(u).map(t => {
                          ["hit", "ordered"].includes(t)
                            ? (a.sort[`sortReference.${t}`] = u[t])
                            : (a.sort[t] = u[t]);
                        }));
                    case 29:
                      return t.abrupt(
                    ...
                    case 32:
                      console.warn(
                        "resourceType does not exist. Please enter the type again",
                      );
                    case 33:
                    case "end":
                      return t.stop();
        ...
        },
        {
          key: "getSceneInfo",
          value(t) {
            (Qe.post_to_editor("get-scene-info", { include_text_info: !0 }),
              (N = t));
          },
        },
        {
        ...
        },
        {
          ...
          value(...args) {
            var t = { type: "save" };
            ((0 < args.length && void 0 !== args[0]
              ? args[0]
              : {}
            ).removeOutterItems && (t.remove_outter_item = !0),
              Qe.post_to_editor("command", t));
          },
        },
        {
          key: "saveThenClose",
          value(...args) {
            var t = { type: "save-then-close" };
            ((0 < args.length && void 0 !== args[0]
              ? args[0]
              : {}
            ).removeOutterItems && (t.remove_outter_item = !0),
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        (r = null),
                        (t.prev = 1),
                        U(["projectId"], { projectId: e }),
                        (t.next = 5),
                        regeneratorRuntime.awrap(en.call("isReadyToOrder", e))
                      );
                    case 5:
                      if (
                        (null === (r = t.sent).doc_rev && (r.can_order = !1),
                    ...
                    case 14:
                      return (
                        (t.prev = 14),
                        (t.t0 = t.catch(1)),
                        H && H.constructor === Function && H(t.t0),
                        (r = { can_order: !1, message: t.t0.message }),
                        n && n.constructor === Function && n(t.t0, r),
                        console.log(t.t0),
                        t.abrupt("return", r)
                      );
                    case 21:
        ...
        },
        {
          ...
          value(r) {
            return new Promise((e, t) => {
              var n = new XMLHttpRequest();
              (n.open("GET", r, !0),
                n.setRequestHeader("Cache-Control", "max-age=0"),
                (n.responseType = "blob"),
                (n.onload = () => {
                  var t = new FileReader();
                  (t.readAsText(n.response),
                    (t.onload = ({target}) => {
                      e(target.result);
                    }));
                }),
        ...
        },
        {
          ...
          value(t) {
            ...
            (t &&
              ...
              Qe.destroy(e ? document.querySelector(e.selector) : null, t),
              u &&
                (We.removeEventListener("message", q, !1), u.removeChild(L)));
          },
        },
        {
          key: "openFullyFunctionalUI",
          value({selector, productCode}, e) {
            var n = selector,
              r = productCode;
            return !A &&
            ((A = !0),
            ...
            (L = ((t, e, n) => {
              ...
              ((o += `config=${encodeURIComponent(JSON.stringify(i))}`),
                e &&
                  "object" === (void 0 === e ? "undefined" : _typeof(e)) &&
                  (o +=
                    `&options=${encodeURIComponent(JSON.stringify(e))}`));
            ...
            We.addEventListener("message", q, !1),
            u.appendChild(L),
            t => {
        ...
        },
        {
          ...
          value(g) {
            ...
            if (0 < Object.keys(_).length) {
              ...
              try {
                for (
                  var o, i = Object.entries(_)[Symbol.iterator]();
                  !(t = (o = i.next()).done);
                  t = !0
                ) {
                  var a = _slicedToArray(o.value, 2),
                    ...
                    s = a[1],
                    u = s.baseData,
                    l = s.findField.split("&").reduce((t, e) => {
                      return t = t.filter(t => {
                        return t[e] === n[e];
                      });
                    }, Y[u]);
    ...
    X = (() => {
      function e(t) {
        (_classCallCheck(this, e),
          (this.productCode = t.productCode),
          (this.locale = t.locale),
          (this.product = t.product),
          (this.customTabInfo = this.getCustomTabInfo()),
          (this.templateList = t.templateList),
          (this.isDev = t.isDev));
      }
      return _createClass(e, [
        {
          ...
          value() {
            return this.product.multilingualCustomData.product[this.locale]
              .customTabInfo;
          },
        },
        {
          ...
          value(r) {
            return Object.entries({ printType: ["PTP_SLK"] }).some(
              t => {
        ...
        },
        {
          ...
          value(t, r) {
            var e = !1;
            return t &&
              (e = t.reduce((t, {values, field}) => {
                var n = values.includes(r[field]);
                return t || n;
              }, !1)),
            e;
          },
        },
        {
          ...
          value(o) {
            var t = this.customTabInfo,
              ...
              n = t.groupingInfo;
            return e
              ? n.list.map(({sliceField, targetField, range}) => {
                  var e = sliceField,
                    n = targetField,
                    r = range;
        ...
        },
        {
          ...
          value({material, mappingData}, g) {
            var _ = material,
              y = mappingData;
            return this.templateList.find(({features}) => {
              var o = {},
                t = !0,
                e = !1,
                n = void 0;
              ...
              return Object.keys(o).reduce((t, e) => {
                var n = features.customInfo[e] === o[e];
                return t && n;
              }, !0);
            });
          },
        ...
        },
        {
          ...
          value(t) {
            var f = this,
              ...
              d = e.mappingData,
              n = e.dynamicItems,
              h = n.list.reduce((t, {targetItem}) => {
                return (t[`${targetItem}Tree`] = {}), t;
              }, {});
            return t.reduce((r, u) => {
              var t = n.exceptions,
                e = n.list;
              ...
              return e.forEach(a => {
                ...
                l.reduce((o, i, t, e) => {
                  ...
                  return o[i][c].sort(({code, sortNumber}, {code, sortNumber}) => {
                    return d[c][code].sortNumber
                      ? d[c][code].sortNumber - d[c][code].sortNumber
        ...
        },
        {
          key: "getInitVariable",
          value(r, o) {
            var t = Object.keys(r).reduce((t, e) => {
                if (o[e]) {
                  var n = o[e];
                  t[e] = r[e].find(({code}) => {
                    return code === n;
            ...
            try {
              for (
                var c,
                  s = this.customTabInfo.initVariables[Symbol.iterator]();
                !(n = (c = s.next()).done);
                n = !0
              ) {
                var u = c.value;
                if ("text" === u.type) e[u.variable] = u.value;
                  ...
                  void 0 === t[u.targetItem]
                    ? (e[u.variable] = r[u.targetItem][0][u.itemField])
                    : (e[u.variable] = t[u.targetItem][u.itemField]);
                }
              }
            } catch (t) {
              ((i = !0), (a = t));
        ...
        },
        {
          ...
          value({materialType}) {
            ...
            switch (t.selectionInfo.compareKey) {
              case "materialType":
                r = this.templateList.find(({features}) => {
                  return features.customInfo.materialType === materialType;
                });
                break;
              case "productCode":
        ...
        },
        {
          ...
          value(n, r) {
            var o = this,
              ...
              i = [],
              _ = this.customTabInfo.dynamicItems.list.find(({includeTemplateInfo}) => {
                return includeTemplateInfo;
              }),
              e = !0,
              a = !1,
              c = void 0;
                ...
                var s,
                  u = () => {
                    ...
                    if ("uniform-select" === g.type) {
                      var t = n[g.items.target].reduce((t, e) => {
                        var n = {},
                          r = !1,
                          o = !0,
                          i = !1,
                        ...
                        try {
                          for (
                            var c,
                              s = Object.keys(g.items)[Symbol.iterator]();
                            !(o = (c = s.next()).done);
                            o = !0
                          ) {
                            var u = c.value;
            ...
            return regeneratorRuntime.async(
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (n = this.customTabInfo.noStocks),
                      (y = n.exceptions),
                      (m = n.tagItems),
                      (r = e.reduce((t, r) => {
                        var e = !1;
                        ...
                        if ("Y" === r.HIDE_YN) {
                          ...
                          try {
                            for (
                              ...
                              n +=
                                `${f}:${g
  ? b.customTabInfo.mappingData[p][_][v]
  : _}/`;
                            }
                          } catch (t) {
                            ((i = !0), (a = t));
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ...
                        (u = n.settings),
                        (l = void 0 === u ? {} : u),
                        (f = this.getItemList(e[o])),
                        (p = L.skipInitVarMap),
                        (d = L.generateCutLayer),
                        (h = l.forceMaterialCode),
                        (v = this.product.controlPsCode),
                        (g = {}),
                        (_ = f),
                        (y = {}),
                        (m = Object.keys(r)),
                        a
                          ? (_ = c.list.reduce((t, {key, initVariable}) => {
                              var n = "";
                              return m.includes(key) &&
                                ((n = r[key]),
                                m.splice(m.indexOf(key), 1)),
                              initVariable &&
                                (y[initVariable] = r[key]),
                              n ? t[n] : t;
                            }, f))
                          : (y.$MTRL = r.material),
                        (b = m.reduce((t, e) => {
                      ...
                      if (
                        ((x = this.getInitVariable(_, b)),
                        (k = _extends({ $CDBG: this.isDev }, y, x)),
                        h &&
                          ((w = h.condition),
                          (S = w.key),
                          (E = w.value),
                          r[S] === E && (k.$FCMC = h.value)),
                        d && (k.$PGLR = "Cut"),
                        !v || !v.length)
                      ) {
                        t.next = 46;
                    ...
                    case 46:
                      g.varMap = k;
                    case 47:
                      return (F = { entities: this.getEntities(_, r) }),
                      (t.t1 = _extends),
                      (t.t2 = {}),
                      (t.t3 = g),
                      (t.t4 = { $PRCE: `${s}` }),
                      (t.next = 54),
                      regeneratorRuntime.awrap(
                        this.getNoStocksInfo(e[i.baseData]),
                      );
                    case 54:
                      return (
                        (t.t5 = t.sent),
