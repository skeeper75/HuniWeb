...
- **지비츠(156) Path 1 보류** — 권위 재확인(사장님 지적): 규격5+비규격 사이즈·가공 투명200/스핀600·구간할인0~50%. 사이즈 무관·가공이 가격축. 에이전트 flat200은 미완→§18 재설계(`jibbitz-authority-correction-260701.md`). 미판매(use_yn=N) 신규라 비급.
