#!/usr/bin/env bash
# =====================================================================
# undo.sh — 면적매트릭스 마이그레이션 역실행기
#   등록한 211 좌표 siz + 추가한 면적 component_prices(신규 siz_cd 좌표분)를 제거한다.
