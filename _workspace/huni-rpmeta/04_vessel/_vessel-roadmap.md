...
- **"신규 그릇 불요" 재분류: 8** — V-2·#4·V-5·V-6·V-7 + **V-9(prd_typ_cd+semi_role_cd PASS)** + MAT_TYPE(신규 0·use_yn만) + **TP facet(VDP본문보류·페이지/형태/특수인쇄 기존 흡수)** + **ST facet 5항(재단입자 PASS·점착→V-3·인쇄방식→V-2·disable→V-4·칼선→V-12/V-1 게이팅)**. + essential(V-4 내부 PASS). **+ PR/CL/AC/PD facet 전건 흡수(신규 0)** — PR 6항·CL 5항·AC 6항·**PD 5항(봉제→V-8·직물물성/밑창 sub_mtr→V-3·단수/형상=#13 PASS·★PD-4 내재BOM=data-gap)** 전부 기존 V-항목/판정에 귀속·새 V-번호 0.
