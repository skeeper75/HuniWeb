---
id: product-254-leather-volume-mini-pouch
type: product
anchor: t_prd_products/PRD_000254
badge: candidate
sources:
  - {source_file: "live-snapshot/latest/t_prd_products.csv", source_locator: "키:PRD_000254 (prd_typ=PRD_TYPE.01·use_yn=Y·del_yn=N·nonspec_yn=N)", captured_at: "live 20260702_1119", badge: verified, src_id: SR-5-livesnap}
...
# 레더 볼륨 미니파우치 (product-254-leather-volume-mini-pouch)
...
- **자재 오염 잔존**: 활성 자재 중 shape-변형 2행(MAT_000330(정사각)·MAT_000329(직사각))이 `MAT_TYPE.09`로 등록 = 치수/형상을 자재로 오모델(substrate 아님) → [[gap-goods-material-contamination]]. substrate 자재는 레더뿐.
...
<!-- transcribed-by: _meta/scripts/gen_leather_pouch_nodes.py from live-snapshot/latest (snap_20260702_1119) t_prd_products PRD_000254 @ 2026-07-03 -->
...
<!-- transcribed-by: _meta/scripts/gen_leather_pouch_nodes.py from live-snapshot/latest (snap_20260702_1119) t_prd_product_prices+t_prd_product_price_formulas PRD_000254 @ 2026-07-03 -->
| 원천 테이블 | 행 | 값 |
|---|---|---|
...
<!-- transcribed-by: _meta/scripts/gen_leather_pouch_nodes.py from live-snapshot/latest (snap_20260702_1119) t_prd_product_materials+t_mat_materials PRD_000254 @ 2026-07-03 -->
| mat_cd | 자재명 | mat_typ | usage_cd | 역할 |
|---|---|---|---|---|
| MAT_000330 | 정사각 | MAT_TYPE.09 | USAGE.07 | shape-변형(오염·substrate 아님) |
| MAT_000329 | 직사각 | MAT_TYPE.09 | USAGE.07 | shape-변형(오염·substrate 아님) |
...
<!-- transcribed-by: _meta/scripts/gen_leather_pouch_nodes.py from live-snapshot/latest (snap_20260702_1119) t_prd_product_sizes+t_siz_sizes PRD_000254 @ 2026-07-03 -->
| siz_cd | 라벨 |
|---|---|
...
<!-- transcribed-by: _meta/scripts/gen_leather_pouch_nodes.py from live-snapshot/latest (snap_20260702_1119) t_prd_product_categories+t_cat_categories PRD_000254 @ 2026-07-03 -->
