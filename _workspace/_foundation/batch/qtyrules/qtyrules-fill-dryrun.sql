...
-- ============================================================
-- 롤백 전용 DRY-RUN: 적용→검증→ROLLBACK (실 반영 없음)
BEGIN;

-- [1] 사이즈 빈곳 채움 (FILL 49건)
...
-- [검증] 방금 채운 행 확인
SELECT prd_cd, siz_cd, min_qty, max_qty, qty_incr FROM t_prd_product_sizes
  WHERE prd_cd IN ('PRD_000016','PRD_000017','PRD_000018','PRD_000019','PRD_000020','PRD_000021','PRD_000022','PRD_000026','PRD_000041','PRD_000042','PRD_000052','PRD_000053','PRD_000054','PRD_000058','PRD_000059','PRD_000060','PRD_000061','PRD_000062','PRD_000063','PRD_000064') AND del_yn='N' ORDER BY prd_cd, disp_seq;
