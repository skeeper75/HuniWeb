...
**변경이력:** 최신: 2026-07-01(3세션) **엽서북30p·지비츠156 라이브 COMMIT(실화면 확인)+미러3T LEGIT_UNUSED·결함 17→13** — ① ★엽서북30p PRD_000094 COMMIT: 30P 고아2 배선+페이지 opt_cd(OPT_000082·20P/30P)·백엔드3계층 검증(evaluate_set_price L920 set_selections 통과→_row_matches opt_cd 매칭·sim_meta opt_grp 스코프)·골든6/6·**price_simulate_set 실화면 실호출 30P부수2=23,000·부수4=39,600·20P=22,000(회귀0)** 17→15. ② 미러아크릴3T=순수고아(소비상품0)→LEGIT_UNUSED 재분류(강제배선시 오적재·거울류186/187은 별개 굿즈 고정가 READY·COMMIT 보류) 15→14. ③ ★지비츠156=신규출시(단종 아님) §18 재설계 COMMIT: 가공=opt_cd 옵션 모델(공정코드 아님·동형선례 BADGE/KEYRING)+DSC_ACR_QTY 재사용(권위 B04 일치)·규격5/비규격 사이즈 가격무관·골든8/8·**실화면 투명100=16,000·스핀100=48,000**·use_yn=N 유지(런칭시 §7 활성화)·고아 placeholder ZIBITZ_TBD 정리 14→13. ④ ★[HARD 신규 directive·별도 §26 세션] 라이브 COMMIT 전 webadmin 실화면 확인 필수(SOT=`_foundation/HARNESS-DOMAIN-RULES-260701.md` 12규칙). 커밋 d7f5356·ce77dc3·f153497·299b82e·bb2d875. 남은 13=고아6(폼보드·접지·캘린더·포토카드 CONFIRM)+dead6(신상아크릴 무권위 실무진단가)+deleted1(082 §23)=전부 사장님/타트랙 의존. 직전: 스캐너 정밀화+엽서북 단품정합 확정(23→17). → `_workspace/_foundation/batch/wiring/HANDOFF.md`·[[formula-components-wiring-subtrack-260701]]
