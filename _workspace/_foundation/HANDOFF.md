...
## 다음 시작점 (한 줄)
**아크릴 addon 템플릿 교정 전파** — 검증된 레시피(`remediation/FINDING-addon-optcd-model-broken.md` "교정 패턴")로 146 키링·148 뱃지·149 집게·150 스마트톡·152 명찰·154 머리끈을 147 동형 전파(★각 건 라이브 시뮬레이터 실증 필수). 그 다음 다음 상품군 착수.
