...
!(function (We) {
      ...
      function Wt(t) {
        ...
        return (
          (function (t) {
            ...
            return (
              -1 !== a.indexOf("Debug") &&
                r.push.apply(r, s(r.splice(a.indexOf("Debug"), 1))),
              r
            );
          })(t).forEach(function (t) {
            !(function (t) {
            ...
            (a.prototype._getPossibleEventMessages = function (e) {
              ...
              if (e.exception)
                try {
                  ...
                  return (
                    X.error("Cannot extract message for event " + R(e)),
                    []
                  );
                }
              return [];
          ...
          return (
            ...
            (e.prototype._consoleBreadcrumb = function (t) {
              ...
              if ("assert" === t.level) {
                ...
                ((e.message =
                  "Assertion failed: " +
                  (E(t.args.slice(1), " ") || "console.assert")),
                  (e.data.arguments = t.args.slice(1)));
              }
              Nt().addBreadcrumb(e, { input: t.args, level: t.level });
            }),
  ...
  (((Qe = {
    ...
    (Qe.open_portal = function (t, e) {
      var n =
        this.base_url + "/ed#/editor_portal?cmd=open_portal&token=" + t.token;
          ...
          function (t, e, n) {
            if (t(29)) {
              var _ = t(60),
                ...
                Ct = function () {
                  for (
                    var t = 0, e = arguments.length, n = It(this, e);
                    t < e;
                  )
                    n[t] = arguments[t++];
                  return n;
          ...
          function (n, t, e) {
            var r,
              ...
              P = !!(function () {
                try {
                  var t = S.resolve(1),
                    e = ((t.constructor = {})[n(128)("species")] = function (
                      t,
                    ) {
                      t(I, I);
                    });
              ...
              f(x, {
                ...
                of: function () {
                  for (var t = 0, e = arguments.length, r = Array(e); t < e; )
                    r[t] = arguments[t++];
                  return new ("function" == typeof this ? this : x)(function (
                    e,
                  ) {
                    var n = !1;
                    return (
                  ...
                  if (zt.multi) {
                    var Ht = {
                      ...
                      srcs: zt.images.map(function (t) {
                        return { src_key: t.key, src_info: t.info };
                      }),
                    };
      ...
      function o(t) {
        ...
        try {
          ...
          if (
            ...
            t.inheritToken ||
              (en.verifyToken(),
              en.autoRefreshToken(function (t, e) {
                if (L) {
                  var n = {
                    target: "KOI-SDK",
                    action: "refreshToken",
            ...
            (D("userId", t.userId),
              en
                .call("issueUserToken")
                .then(function (t) {
                  (t.division && D("division", t.division),
                    t.lang && D("lang", t.lang),
                    t.companyCode && D("companyCode", t.companyCode));
                  var e = { token: t.token, expiredAt: new Date().getTime() };
          ...
          (t.email && D("email", t.email),
            t.staffCode && D("staffCode", t.staffCode),
            (function () {
                      ...
                      case 94:
                        (n.useTabless && (e.uiStyle = "tab-less,header-less"),
                          ...
                          n.tabControl &&
                            (e.extra || (e.extra = {}),
                            e.extra.override || (e.extra.override = {}),
                            (T = Object.keys(n.tabControl).map(function (t) {
                      ...
                      case 87:
                        (i.useTabless && (o.uiStyle = "tab-less,header-less"),
                          ...
                          i.tabControl &&
                            (o.extra || (o.extra = {}),
                            o.extra.override || (o.extra.override = {}),
                            (m = Object.keys(i.tabControl).map(function (t) {
          ...
          },
          {
            ...
            value: function (t, e, n, r) {
              ...
              (void 0 !== e && e.constructor === Function && void 0 === r
                ...
                r && r.constructor === Function && (k = r),
                o.ddp_block.commands.some(function (t) {
                  return "set-text-style" === t.action
                    ? t.data.text || "" === t.data.text
                    : "set-item-src" === t.action &&
                        t.data.src &&
                        t.data.src.includes("color");
                }) && (o.show_progress = !1),
                ...
                D("division")
                  ...
                  : en
                      ...
                      .then(function (t) {
                        ...
                        (D("editorToken", e),
                          en.call("getProductInfo", r).then(function (t) {
                            var e = t.product;
                            ((e.userData = JSON.parse(e.userData || "{}")),
                              e.userData &&
                              e.userData.productCustomData &&
                ...
                return (
                  e.forEach(function (a) {
                    ...
                    l.reduce(function (o, i, t, e) {
                      ...
                      return (
                        o[i][c].sort(function (t, e) {
                          return d[c][t.code].sortNumber
                            ? d[c][t.code].sortNumber - d[c][e.code].sortNumber
              ...
              switch (t.selectionInfo.compareKey) {
                case "materialType":
                  r = this.templateList.find(function (t) {
                    return (
                      t.features.customInfo.materialType === e.materialType
                    );
                  });
                  break;
                case "productCode":
                ...
                function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          (n = this.customTabInfo.noStocks),
                          (y = n.exceptions),
                          (m = n.tagItems),
                          (r = e.reduce(function (t, r) {
                            var e = !1;
                            if (
                              (y &&
                    ...
                    switch ((t.prev = t.next)) {
                      case 0:
                        if (
                          ...
                          (m = Object.keys(r)),
                          a
                            ? (_ = c.list.reduce(function (t, e) {
                                var n = "";
                                return (
                                  m.includes(e.key) &&
                                    ((n = r[e.key]),
                                    m.splice(m.indexOf(e.key), 1)),
                                  e.initVariable &&
                                    (y[e.initVariable] = r[e.key]),
                                  n ? t[n] : t
                                );
                              }, f))
                            : (y.$MTRL = r.material),
                          (b = m.reduce(function (t, e) {
                            return ((t[e] = r[e]), t);
                          }, {})),
                          p)
                        ) {
                      ...
                      case 47:
                        return (
                          (F = { entities: this.getEntities(_, r) }),
                          (t.t1 = _extends),
                          (t.t2 = {}),
                          (t.t3 = g),
                          (t.t4 = { $PRCE: "" + s }),
