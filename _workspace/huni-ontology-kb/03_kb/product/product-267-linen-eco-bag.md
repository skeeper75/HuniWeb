...
- **정체**: pack §1.3(FRESH) + live-snapshot(`PRD_000267` 실재·use_yn=Y·del_yn=N).
...
<!-- transcribed-by: awk t_prd_products.csv PRD_000267 from live-snapshot/latest (snap_20260702_1119) @ 2026-07-04 -->
...
<!-- transcribed-by: awk t_prd_product_materials.csv + t_mat_materials.csv PRD_000267 from live-snapshot/latest (snap_20260702_1119) @ 2026-07-04 -->
