...
# -*- coding: utf-8 -*-
"""
전사 스크립트 (D-9·§4·[HARD] LLM 손전사 금지) — 반칼띠지스티커 PRD_000061 전용.
...
사용:  python3 transcribe_product_061.py            # stdout에 markdown 블록
       python3 transcribe_product_061.py --json     # cache/transcribed-061-260703.json 갱신
...
STAMP = "2026-07-03"
PRD = "PRD_000061"
SELF = "transcribe_product_061.py"
...
def md(d):
    ...
    o.append(_tb("t_prd_products PRD_000061"))
    p = d["product"]
...
if __name__ == "__main__":
    d = build()
    if "--json" in sys.argv:
        p = os.path.join(os.path.dirname(__file__), "cache", "transcribed-061-260703.json")
