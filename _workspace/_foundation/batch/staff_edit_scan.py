...
CONFIRM_PENDING = {
    ("PRD_000024", "MAT_000082"): "포토카드 종이축 — 세트고정가 모델에 자재별 차등가 반영 방법 실무진 확인",
    ("PRD_000024", "PROC_000015"): "포토카드 코팅 — 판수기반 comp를 세트모델(qty=20)에 환산하는 방법 확인 필요",
    ("PRD_000024", "PROC_000014"): "포토카드 코팅 — 판수기반 comp를 세트모델(qty=20)에 환산하는 방법 확인 필요",
    ("PRD_000024", "PROC_000028"): "포토카드 모서리 — 세트 수량기준과 코너 tier 정합 확인 필요",
    ("PRD_000024", "PROC_000027"): "포토카드 모서리 — 세트 수량기준과 코너 tier 정합 확인 필요",
    ("PRD_000025", "MAT_000178"): "투명포토카드 종이축 — 포토카드와 동일 사유",
    ("PRD_000025", "PROC_000028"): "투명포토카드 모서리 — 포토카드와 동일 사유",
    ("PRD_000025", "PROC_000027"): "투명포토카드 모서리 — 포토카드와 동일 사유",
    ("PRD_000052", "MAT_000611"): "아트스티커 — 가격표에 단가 원천 전무(임의단가 금지)",
    ("PRD_000058", "MAT_000611"): "아트스티커 — 가격표에 단가 원천 전무(임의단가 금지)",
    ("PRD_000055", "MAT_000593"): "유포지+엠보코팅 — canonical(165)도 무가격·코팅프리미엄 모호",
    ("PRD_000053", "PROC_000008"): "화이트별색/화이트인쇄 — 스티커 클러스터 조사범위 밖(미확인, 다음 세션)",
}
