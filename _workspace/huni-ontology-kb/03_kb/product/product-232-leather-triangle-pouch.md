---
id: product-232-leather-triangle-pouch
type: product
anchor: t_prd_products/PRD_000232
badge: candidate
sources:
  - {source_file: "live-snapshot/latest/t_prd_products.csv", source_locator: "키:PRD_000232 (prd_typ=PRD_TYPE.01·use_yn=Y·del_yn=N·nonspec_yn=N)", captured_at: "live 20260702_1119", badge: verified, src_id: SR-5-livesnap}
...
relations:
  ...
  - {rel: has_size, target: size-SIZ_000437, note: "실 사이즈(t_prd_product_sizes 활성·dflt=Y)"}
  - {rel: has_size, target: size-SIZ_000438, note: "실 사이즈(t_prd_product_sizes 활성·dflt=N)"}
...
# 레더 삼각 파우치 (product-232-leather-triangle-pouch)
...
<!-- transcribed-by: _meta/scripts/gen_leather_pouch_nodes.py from live-snapshot/latest (snap_20260702_1119) t_prd_products PRD_000232 @ 2026-07-03 -->
...
<!-- transcribed-by: _meta/scripts/gen_leather_pouch_nodes.py from live-snapshot/latest (snap_20260702_1119) t_prd_product_prices+t_prd_product_price_formulas PRD_000232 @ 2026-07-03 -->
| 원천 테이블 | 행 | 값 |
|---|---|---|
...
<!-- transcribed-by: _meta/scripts/gen_leather_pouch_nodes.py from live-snapshot/latest (snap_20260702_1119) t_prd_product_materials+t_mat_materials PRD_000232 @ 2026-07-03 -->
...
<!-- transcribed-by: _meta/scripts/gen_leather_pouch_nodes.py from live-snapshot/latest (snap_20260702_1119) t_prd_product_sizes+t_siz_sizes PRD_000232 @ 2026-07-03 -->
| siz_cd | 라벨 | 작업 w×h(mm) | dflt |
|---|---|---|---|
| SIZ_000437 | 440x160 | 440.00×160.00 | Y |
| SIZ_000438 | 520x200 | 520.00×200.00 | N |

`has_size`는 공유 [[axis/sizes]] 축 노드 미민팅이라 배선 대기(needs_axis)·위 표가 권위.

#### 카테고리

<!-- transcribed-by: _meta/scripts/gen_leather_pouch_nodes.py from live-snapshot/latest (snap_20260702_1119) t_prd_product_categories+t_cat_categories PRD_000232 @ 2026-07-03 -->
