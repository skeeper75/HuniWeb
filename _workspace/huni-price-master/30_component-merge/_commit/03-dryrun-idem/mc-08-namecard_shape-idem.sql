...
-- 멱등 실증(롤백전용): mc-08-namecard_shape 본문 2회 적용 후 ROLLBACK. 게이트 RAISE 시 즉시 abort(비0 종료).
BEGIN;
\echo '=== mc-08-namecard_shape PASS 1 ==='
...
\echo '=== mc-08-namecard_shape PASS 2 (idempotency) ==='
SET LOCAL statement_timeout = '120s';
...
\echo '=== mc-08-namecard_shape 2PASS 통과 → 멱등·게이트OK ==='
ROLLBACK;
