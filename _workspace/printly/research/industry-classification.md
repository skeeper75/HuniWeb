...
> ★2026-07-04 확장: 국내외 4슬라이스 리서치로 교차확증 증거기반 작성 →
> **`print-materials-evidence-base-260704.md`**(업종 8→12+·홍보물 9→50+·해외 강출처 보강·정량 매크로 앵커).
> 이 문서 = 원 정본(소진공 분류·AliCoCo·8업종). 확장·승격은 위 증거기반 참조.
