...
| 3 | 송장 기반 배송상태 일괄변경 | 샵바이/우리 | 서희항 | `STD-SHP-013` *(cross t63 **P23**)* | 부분 | 명세 `docs/shopby/shopby-api-docs-complete/04_server-api/order.mdx:400` `PUT /orders/change-status/by-shipping-no` · 호출 0건 |
...
| 6 | 송장번호 등록(판매자) | 샵바이/우리 | 서희항 | `STD-SHP-012` *(cross t63 **P23**)* | 부분 | → P10. **행은 t63 소유** — 여기서 다시 만들지 않는다(t63 전달 260919) |
