...
relations:
  ...
  - {rel: has_size, target: size-SIZ_000433, note: "실 사이즈(t_prd_product_sizes 활성·dflt=Y)"}
  - {rel: has_size, target: size-SIZ_000434, note: "실 사이즈(t_prd_product_sizes 활성·dflt=N)"}
