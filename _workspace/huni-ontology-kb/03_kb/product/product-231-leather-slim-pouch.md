---
id: product-231-leather-slim-pouch
type: product
anchor: t_prd_products/PRD_000231
badge: candidate
sources:
...
# 레더 슬림 파우치 (product-231-leather-slim-pouch)
...
<!-- transcribed-by: _meta/scripts/gen_leather_pouch_nodes.py from live-snapshot/latest (snap_20260702_1119) t_prd_products PRD_000231 @ 2026-07-03 -->
...
<!-- transcribed-by: _meta/scripts/gen_leather_pouch_nodes.py from live-snapshot/latest (snap_20260702_1119) t_prd_product_prices+t_prd_product_price_formulas PRD_000231 @ 2026-07-03 -->
| 원천 테이블 | 행 | 값 |
|---|---|---|
...
<!-- transcribed-by: _meta/scripts/gen_leather_pouch_nodes.py from live-snapshot/latest (snap_20260702_1119) t_prd_product_materials+t_mat_materials PRD_000231 @ 2026-07-03 -->
...
<!-- transcribed-by: _meta/scripts/gen_leather_pouch_nodes.py from live-snapshot/latest (snap_20260702_1119) t_prd_product_sizes+t_siz_sizes PRD_000231 @ 2026-07-03 -->
| siz_cd | 라벨 | 작업 w×h(mm) | dflt |
|---|---|---|---|
| SIZ_000435 | 220x294 | 220.00×294.00 | Y |
| SIZ_000436 | 260x374 | 260.00×374.00 | N |

`has_size`는 공유 [[axis/sizes]] 축 노드 미민팅이라 배선 대기(needs_axis)·위 표가 권위.

#### 카테고리

<!-- transcribed-by: _meta/scripts/gen_leather_pouch_nodes.py from live-snapshot/latest (snap_20260702_1119) t_prd_product_categories+t_cat_categories PRD_000231 @ 2026-07-03 -->
