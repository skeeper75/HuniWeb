...
**변경이력:** 최신: 2026-07-02(배선 서브트랙 6세션) **CONFIRM 12건 전부 해소 + 지그재그 라벨스왑 + 벽걸이캘린더 이중권위 통일** — ① 포토카드/투명포토카드 8+화이트별색1=무료확정(권위 단일고정가/스티커=시트가격) ② 스티커 4상품(052/053/058/055) 사이즈 재키잉 파손 복구 COMMIT(정규코드 del_yn복원+아트611/쿨코팅593 grp1단가클론+A6=100x148·webadmin 8/8 PRICE≠0·052 A5q100=520,000 골든일치) ③ ★[HARD 사용자지적]실무진이 IMPORT시트로 등록한 자재는 배선안됐다고 삭제금지=배선/단가 채울 갭 ④ 지그재그엽서 접지옵션 라벨↔공정 스왑 교정(가격영향0) ⑤ 벽걸이캘린더(111/112) 제본 이중권위→캘린더전용(COMP_BIND_CAL_WALL/PROC_099) 통일(108/109 동형·100부 1,300→2,000). B_confirm 12→0. → `_workspace/_foundation/batch/wiring/HANDOFF.md`·[[formula-components-wiring-subtrack-260701]]. 직전: 5세션 CONFIRM-QUEUE 4항목+22상품 전수진단+모서리 1000배버그
