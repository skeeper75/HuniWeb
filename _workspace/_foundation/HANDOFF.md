...
2. **아크릴 B02 투명1.5T 81셀**(§26 마지막 잔여 매핑미상·별도 comp 부재·사람 확인).
3. **박 분기 2026-07-01 활성 후 시뮬레이터 e2e**(오늘은 base 공식·★내일 2026-07-01부터 박 분기 자동 선택·점진 활성). 활성 후 webadmin price-simulator로 6상품 본체+박 합계 1회 확인 권장.
4. **박영역 상한 CONFIRM (Q-FOIL-SIZE2·실무·적재 비차단)**: 027(170×220)·069/070(A4)은 트림이 대형격자(≤170) 초과. 박영역≤170이면 정확·>170 가능 시 위젯 박영역 입력상한 캡. 돈크리티컬 아님.
