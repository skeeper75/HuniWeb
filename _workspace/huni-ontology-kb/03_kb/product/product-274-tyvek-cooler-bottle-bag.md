---
id: product-274-tyvek-cooler-bottle-bag
type: product
anchor: t_prd_products/PRD_000274
badge: candidate
sources:
  - {source_file: "live-snapshot/latest/t_prd_products.csv", source_locator: "키:PRD_000274 (타이벡보냉보틀백·prd_typ_cd=PRD_TYPE.01·nonspec_yn=N·use_yn=Y·del_yn=N·min1/max10000/incr1·QTY_UNIT.01)", captured_at: "live 20260702_1119", badge: verified, src_id: SR-5-livesnap}
...
relations:
  ...
  - {rel: references, target: gap-goods-material-contamination, note: ".09 형상/규격값 자재화(비-substrate): MAT_000319(M·MAT_TYPE.09)·MAT_000320(L·MAT_TYPE.09)"}
props:
...
answers_cq: ["구체 상품 질의(타이벡보냉보틀백 구성·가격)", "백류/에코백 탐색"]
tags: ["#백류", "#봉제상품", "#비종이류판형없음", "#NEITHER-gap", "#empty-shell", "#자재오염"]
updated: 2026-07-04
---

# 타이벡보냉보틀백 (product-274-tyvek-cooler-bottle-bag)

타이벡보냉보틀백(`PRD_000274`)는 **백류·필통(봉제) 완제품 단품**(`prd_typ_cd=PRD_TYPE.01`)이다. 셋트 아님
...
- **정체**: pack §1.3(FRESH) + live-snapshot(`PRD_000274` 실재·use_yn=Y·del_yn=N).
...
<!-- transcribed-by: awk t_prd_products.csv PRD_000274 from live-snapshot/latest (snap_20260702_1119) @ 2026-07-04 -->
...
<!-- transcribed-by: awk t_prd_product_materials.csv + t_mat_materials.csv PRD_000274 from live-snapshot/latest (snap_20260702_1119) @ 2026-07-04 -->
| mat_cd | 자재명 | mat_typ | usage_cd | 역할 판정 | KB 배선 |
|---|---|---|---|---|---|
| MAT_000319 | M | MAT_TYPE.09 | USAGE.07 | ★.09 형상/규격값=비-substrate(오염) | 미배선(오염) |
| MAT_000320 | L | MAT_TYPE.09 | USAGE.07 | ★.09 형상/규격값=비-substrate(오염) | 미배선(오염) |
...
- [[gap-goods-material-contamination]] — .09 형상/규격값 자재화(비-substrate): MAT_000319(M·MAT_TYPE.09)·MAT_000320(L·MAT_TYPE.09)
