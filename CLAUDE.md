...
**변경이력:** 최신: 2026-06-30 **차원 정합 진단기(Phase 2b) 구축+전수 교정 완주** — 신규 에이전트 `hpti-dimension-conformance-inspector`+스킬+결정론 `dim_conformance.py`(use_dims↔충전↔옵션수단 3자 조인·union 분담흡수). 전수 HIGH 12 MISSING+4 UNDECLARED → 3 진단가 병렬 권위대조 → **교정 8 COMMIT**(봉투 MAT_169·132레더·163미니파츠·135족자 재지정·031 고아옵션·★032코팅 use_dims+print_opt_cd 견적0→11000·124린넨 proc_cd→NULL·★027/029 접지키오류 192단가행·028 미니접지 공정0→12등록 접지+52000). FP 9(아크릴6=두께축vs부속). ★엔진규칙 정정=`_row_matches`는 use_dims 무관 충전컬럼 매칭·use_dims는 UI노출만. ★도구개선=mat_typ분리+.06환원제거→MISSING-HIGH 12→0. ★잔여=가변 단가행 동시매칭(027/028/029 COMP_PP_VARTEXT/VARIMG·신규·다음 시작점)·박 엔진C-track·아크릴부속§18. 직전: 디지털인쇄비 셀단위 종결. → `_workspace/huni-price-table-integrity/HANDOFF.md`·[[dimension-conformance-3face-diagnosis-260630]]
