...
sources:
  ...
  - {source_file: "live-snapshot/latest/t_prd_product_price_formulas.csv", source_locator: "키:PRD_000246 가격공식 0행 + t_prd_product_prices.csv 동키 0행 + t_prd_product_processes.csv 0행(전수 실측)", captured_at: "live 20260702_1119", badge: candidate, src_id: SR-5-livesnap}
relations:
...
answers_cq: ["타이벡 삼각 파우치 구성·가격 질의(원천 부재 정직 응답)"]
tags: ["#파우치", "#타이벡", "#봉제", "#비종이", "#NEITHER-gap", "#empty-shell"]
updated: 2026-07-04
---

# 타이벡 삼각 파우치 (product-246-tyvek-triangle-pouch)

타이벡 삼각 파우치(PRD_000246)는 **봉제 완제품 단품**(PRD_TYPE.01·셋트 아님). **비종이 → 판형 없음**.
...
<!-- transcribed-by: awk over live-snapshot/latest (snap_20260702_1119) t_prd_product_materials+t_prd_product_processes+t_prd_product_price_formulas+t_prd_product_prices+t_prd_product_plate_sizes+t_prd_product_categories PRD_000246 @ 2026-07-04 -->
...
| plate_sizes(비종이 오용) | SIZ_000456 220x330·SIZ_000457 260x390 | 판형 아님(관찰·미배선) |
