...
(종료척도[HARD]=배선 결함 0+PRICE≠0). 변경이력: 최신 2026-07-04 ★통합 진단·교정 배치 hdx **P5-②a**
(OptionCpqDx 신규·옵션 dtl_opt↔단가행 dim_vals 연결 끊김 저청구·신뢰도 모델 형제입증형 HIGH·**메쉬배너 타공 저청구 적발**·
다음 codex+도메인 전파) ← 첫 실적재(포스터 use_dims 라이브 COMMIT·라운드4 해소) ← P5-① 반자동 라운드 러너
