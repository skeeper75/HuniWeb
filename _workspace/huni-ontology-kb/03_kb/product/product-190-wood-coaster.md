...
sources:
  ...
  - {source_file: "live t_prd_product_prices (07-04 SELECT·reprice_goods_260704)", source_locator: "키:PRD_000190 unit_price=7000.00·reg_dt=2026-07-03·frm 0행(고정가룩업)", captured_at: "live 2026-07-04", badge: verified, src_id: SR-reprice-0704}
relations:
...
**고정가룩업(07-04 재프라이싱 정정)** → [[gap-goods-fixed-lookup-no-formula]]. product_materials 2행(MAT_000263 원형90mm·MAT_000264
