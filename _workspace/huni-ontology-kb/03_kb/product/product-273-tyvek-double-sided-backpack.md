---
id: product-273-tyvek-double-sided-backpack
type: product
anchor: t_prd_products/PRD_000273
badge: candidate
sources:
...
answers_cq: ["구체 상품 질의(타이벡 양면 백팩 구성·가격)", "백류/에코백 탐색"]
tags: ["#백류", "#봉제상품", "#비종이류판형없음", "#NEITHER-gap", "#empty-shell", "#자재오염"]
updated: 2026-07-04
---

# 타이벡 양면 백팩 (product-273-tyvek-double-sided-backpack)

타이벡 양면 백팩(`PRD_000273`)는 **백류·필통(봉제) 완제품 단품**(`prd_typ_cd=PRD_TYPE.01`)이다. 셋트 아님
...
- **정체**: pack §1.3(FRESH) + live-snapshot(`PRD_000273` 실재·use_yn=Y·del_yn=N).
...
<!-- transcribed-by: awk t_prd_products.csv PRD_000273 from live-snapshot/latest (snap_20260702_1119) @ 2026-07-04 -->
...
<!-- transcribed-by: awk t_prd_product_materials.csv + t_mat_materials.csv PRD_000273 from live-snapshot/latest (snap_20260702_1119) @ 2026-07-04 -->
