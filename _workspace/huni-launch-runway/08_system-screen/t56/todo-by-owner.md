...
- 판정 분포(735행 전체): 담당맞음 457 · 재배정 141 · 분할 36 · provided 37 · 불필요 1 · 미정 63
...
재판정 뒤 이 사람이 실제로 질 남은 일(제안 기준) = 113 + 넘어옴 56 = **169행** (+ 나눠야 하는 9행의 자기 몫)
...
재판정 뒤 이 사람이 실제로 질 남은 일(제안 기준) = 128 + 넘어옴 43 = **171행** (+ 나눠야 하는 12행의 자기 몫)
...
| STD-CAT-007 | T3.A5 | 부분 | 상품 상세페이지 본문(이미지·설명 블록) | merged-owner_side |
...
| STD-CAT-012 | T3.A5 | 부분 | 재작업 불가 사항 고지(폰트 아웃라인 등) | merged-owner_side |
