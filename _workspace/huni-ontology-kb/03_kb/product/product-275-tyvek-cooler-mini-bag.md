---
id: product-275-tyvek-cooler-mini-bag
type: product
anchor: t_prd_products/PRD_000275
badge: verified
sources:
  - {source_file: "live-snapshot/latest/t_prd_products.csv", source_locator: "키:PRD_000275 (타이벡 보냉 미니백·prd_typ_cd=PRD_TYPE.01·nonspec_yn=N·use_yn=Y·del_yn=N·min1/max10000/incr1·QTY_UNIT.01)", captured_at: "live 20260702_1119", badge: verified, src_id: SR-5-livesnap}
...
# 타이벡 보냉 미니백 (product-275-tyvek-cooler-mini-bag)

타이벡 보냉 미니백(`PRD_000275`)는 **백류·필통(봉제) 완제품 단품**(`prd_typ_cd=PRD_TYPE.01`)이다. 셋트 아님
...
- **정체**: pack §1.3(FRESH) + live-snapshot(`PRD_000275` 실재·use_yn=Y·del_yn=N).
...
<!-- transcribed-by: awk t_prd_products.csv PRD_000275 from live-snapshot/latest (snap_20260702_1119) @ 2026-07-04 -->
...
<!-- transcribed-by: awk t_prd_product_materials.csv + t_mat_materials.csv PRD_000275 from live-snapshot/latest (snap_20260702_1119) @ 2026-07-04 -->
| mat_cd | 자재명 | mat_typ | usage_cd | 역할 판정 | KB 배선 |
|---|---|---|---|---|---|
| — | (0행) | — | — | 순수 empty-shell(자재 미적재) | needs_axis(실무진 BOM 대기) |
...
<!-- transcribed-by: awk t_prd_product_prices.csv PRD_000275 from live-snapshot/latest (snap_20260702_1119) @ 2026-07-04 -->
| prd_cd | apply_ymd | unit_price | note |
|---|---|---|---|
| PRD_000275 | 2026-06-10 | 25000.00 | GP-1 base 단일고정가 §21 R-GP4-1 (260610 verbatim) |
...
- [[gap-pouch-empty-shell]] — 자재·공정 0행(순수 empty-shell)
