...
> **버전:** v1.0(BN §1~§3 보존) + **v2.0(GS §4 굿즈 data-gap·라이브 2026-06-17 실측)**.
...
- **본 하네스(RP-Meta) 산출**: `vessel-needs.md`의 V-1~V-9(vessel-gap)만 — **GS 핵심 = V-3 굿즈 분해축·V-8 형태가공**. data는 전부 dbmap.
