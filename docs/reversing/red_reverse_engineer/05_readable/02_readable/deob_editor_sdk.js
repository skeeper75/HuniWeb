/*
 * 서드파티 인덱스 (아래 블록은 표준 라이브러리 · 읽기 생략 가능 · 참조: deob_editor_sdk.js.thirdparty.js)
 *   - Babel transpile helpers (head)  (원본 13-113, 101줄)  : Babel 트랜스파일 헬퍼 head(서드파티 툴링): _slicedToArray/_extends/_createClass/_typeof(13-84)·_toConsumableArray(85-91)·_defineProperty(92-104)·_classCallCheck(105-113). fold 대상은 아니나(번들 상단 유지) 내부 루프/임시 바인딩(n/r/o 11건·_createClass의 function r@59 포함)은 가독성 집계에서 제외. 거대 proprietary IIFE는 line 114(`!(function(windowRef){...}`)부터 시작.
 *   - Sentry @sentry/browser v5.22.0  (원본 122-3760, 3639줄)  : 에러 추적 라이브러리(서드파티). 리네임 제외 — region 배너+상단 인덱스만, 참조 추출본 분리. 가독본 노드앵커(VariableDeclarator id=sentryLib)로 재탐지한 실좌표(원본 67-2534에서 갱신). 내부 바인딩(At/Bt/Dt/lt/vt 등 151개)은 Sentry 내부 전용.
 *   - Babel Polyfill + regeneratorRuntime  (원본 4635-13902, 9268줄)  : async/await 지원 폴리필 + regeneratorRuntime(서드파티). 리네임 제외. 가독본 노드앵커(ExpressionStatement windowRef._babelPolyfill||!function...())로 재탐지한 실좌표(원본 2888-9527에서 갱신). proprietary 코어 에디터 SDK는 이 블록 직후 line 13903부터 재개.
 */
// ============================================================
    ...
    if (Symbol.iterator in Object(t))
      return (function (t, e) {
        ...
        try {
          for (
            /**
             * buildQueryString — 객체를 `?k=v&...` URL 쿼리스트링으로 변환(값은 encodeURIComponent,
             * 객체값은 JSON 직렬화). (원본 식별자 c)
             */
            /**
             * ApiClient — 레드프린팅 makers API HTTP 래퍼 클래스.
             * makers.redprinting.net과 통신하며 red-editor-token 헤더 인증과
             * 50분 간격 토큰 자동 갱신을 수행한다. (원본 식별자 a, 섹션 라인 2733-2887)
             */
...
!(function (windowRef) {
  /**
   * EditorBridge — 에디터 iframe 통신 관리자.
   * edicusbase.firebaseapp.com(운영)/edicus-stage(개발) iframe을 생성하고
   * postMessage 기반 양방향 통신과 URL 구성을 담당한다. (원본 식별자 Qe, 섹션 라인 2535-2732)
   */
  var editorBridge,
    isEditorBusy = !1,
    sentryLib = (function (u) {
      var r = function (t, e) {
        return (r =
      ...
      /**
       * RedEditorSDK — 메인 SDK 클래스(window.RedEditorSDK로 export).
       * 생성자 + 45개 프로토타입 메서드(템플릿/프로젝트/에디터 UI/VDP/라이프사이클/인증/이벤트/조회/주문).
       * this.version=6.6.48, sdkState.mode=standard|passive. (원본 식별자 t, 섹션 라인 10398-11801)
       */
      var t,
        e,
        o,
      ...
      ((e = t || (t = {}))[(e.None = 0)] = "None"),
        ...
        (o.Debug = "debug"),
        (o.Critical = "critical"),
        ((i = u.Severity || (u.Severity = {})).fromString = function (t) {
          switch (t) {
            case "debug":
              return i.Debug;
            case "info":
        ...
        (a.Invalid = "invalid"),
        (a.Failed = "failed"),
        ((c = u.Status || (u.Status = {})).fromHttpCode = function (t) {
          return 200 <= t && t < 300
            ? c.Success
            : 429 === t
            ? c.RateLimit
      ...
      function y(t) {
        return (
          null === t ||
          ("object" !== (void 0 === t ? "undefined" : _typeof(t)) && "function" != typeof t)
        );
      }
      function m(t) {
      ...
      /**
       * commandPromiseHandlers — remoteEditor command+close-preview 명령의 결과를
       * 해소할 Promise 핸들러 보관소. (원본 식별자 b)
       */
      function b(t) {
      ...
      function L(t) {
        try {
          for (
            ...
            e &&
            r++ < 5 &&
            !("html" === (a = A(e)) || (1 < r && 80 <= o + n.length * i + a.length));
      ...
      function A(t) {
        ...
        if (
          (c.push(a.tagName.toLowerCase()), a.id && c.push("#" + a.id), (e = a.className) && _(e))
        )
          for (n = e.split(/\s+/), i = 0; i < n.length; i++) c.push("." + n[i]);
        var s = ["type", "name", "title", "alt"];
        for (i = 0; i < s.length; i++)
          (r = s[i]), (o = a.getAttribute(r)) && c.push("[" + r + '="' + o + '"]');
        return c.join("");
      }
      /**
       * getAuthState — sessionStorage의 editorToken/userId로 인증 상태({user, token})를 조회. (원본 식별자 B)
       */
      /**
       * validateRequiredParams — 필수 파라미터 검증. 키 배열을 순회하며
       * 대상 객체에 없는 키가 있으면 `<key> is undefined.` 에러를 던진다. (원본 식별자 U)
       */
      /**
       * sessionStorageManager — Base64 인코딩 sessionStorage 관리 유틸.
       * 값이 주어지면 JSON 직렬화 후 btoa(encodeURIComponent)로 저장(userId는 64자 절단),
       * 값이 없으면 atob로 디코딩하여 반환한다. (원본 식별자 D, 90회 참조)
       */
      var D = Date.now(),
        U = 0,
        B = {
      ...
      /**
       * ddpBlockBuilder — SDK 고수준 명령을 에디터가 이해하는 DDP 블록으로 변환.
       * 23가지 명령 타입을 처리한다. (원본 식별자 G, 21회 참조, 섹션 라인 9654-10346)
       */
      var G = "<anonymous>";
      function q(t) {
        try {
      ...
      /**
       * sdkState — SDK 내부 상태 객체. mode(standard|passive)·deviceTarget(pc|mobile) 등
       * 런타임 상태를 보관한다. (원본 식별자 K, 47회 참조)
       */
      var V = O(),
        J = "Sentry Logger ",
        K = (function () {
      ...
      /**
       * CustomTabManager — 커스텀 탭(옵션 선택 UI) 데이터 가공 헬퍼 클래스.
       * 소재 목록에서 동적 아이템을 추출하고 템플릿 매칭·초기 변수 설정을 수행한다.
       * (원본 식별자 X, 섹션 라인 11803-12244)
       */
      var Y,
        $,
      ...
      function rt(t, e, n, r) {
        if ((void 0 === n && (n = 1 / 0), void 0 === r && (r = new Z()), 0 === n))
          return (function (t) {
        ...
        for (var c in i)
          Object.prototype.hasOwnProperty.call(i, c) && (a[c] = rt(c, i[c], n - 1, r));
                ...
                if (n._state !== Y.PENDING) {
                  ...
                  (n._handlers = []),
                    t.forEach(function (t) {
                      t.done ||
                        (n._state === Y.RESOLVED && t.onfulfilled && t.onfulfilled(n._value),
                        n._state === Y.REJECTED && t.onrejected && t.onrejected(n._value),
                        (t.done = !0));
                    });
                }
              });
            ...
            (t.prototype.add = function (t) {
              ...
              return this.isReady()
                ? (-1 === this._buffer.indexOf(t) && this._buffer.push(t),
                  ...
                  t)
                : it.reject(new v("Not adding Promise due to buffer limit reached."));
            }),
          ...
          switch (((pt[t] = !0), t)) {
            ...
            case "dom":
              !(function () {
                ...
                lt.document.addEventListener("click", bt("click", vt.bind(null, "dom")), !1),
                  lt.document.addEventListener("keypress", xt(vt.bind(null, "dom")), !1),
                  ["EventTarget", "Node"].forEach(function (t) {
                    var e = lt[t] && lt[t].prototype;
                    e &&
                      e.hasOwnProperty &&
                      e.hasOwnProperty("addEventListener") &&
                      (Q(e, "addEventListener", function (r) {
                        return function (t, e, n) {
                          return (
                            e && e.handleEvent
                              ? ("click" === t &&
                                  Q(e, "handleEvent", function (e) {
                                    return function (t) {
                              ...
                              : ("click" === t && bt("click", vt.bind(null, "dom"), !0)(this),
                                "keypress" === t && xt(vt.bind(null, "dom"))(this)),
                            r.call(this, t, e, n)
                          );
                        };
                      }),
                  ...
                  return function () {
                    ...
                    return (
                      "onreadystatechange" in r && "function" == typeof r.onreadystatechange
                        ? Q(r, "onreadystatechange", function (n) {
                            return function () {
                  ...
                  return function () {
                    ...
                    var n = {
                      ...
                      fetchData: {
                        method: (function (t) {
                          void 0 === t && (t = []);
                          if ("Request" in lt && w(t[0], Request) && t[0].method)
      ...
      function ht(t) {
        t &&
          ...
          ((ft[t.type] = ft[t.type] || []), ft[t.type].push(t.callback), dt(t.type));
      }
      function vt(e, t) {
        var n, r;
        if (e && ft[e])
        ...
        Tt = (function () {
          ...
          return (
            ...
            (n.prototype.setContext = function (t, e) {
              var n;
              return (
                (this._contexts = f(f({}, this._contexts), (((n = {})[t] = e), n))),
                this._notifyScopeListeners(),
                this
              );
            }),
            ...
            (n.prototype.applyToEvent = function (t, e) {
              return (
                ...
                this._notifyEventProcessors(s(Pt(), this._eventProcessors), t, e)
              );
            }),
          ...
          return (
            ...
            (t.prototype.getIntegration = function (e) {
              ...
              try {
                ...
                return (
                  X.warn("Cannot retrieve integration " + e.id + " from the current Hub"), null
                );
              }
            }),
      ...
      function Nt() {
        var t = Rt();
        return (
          (Ft(t) && !Lt(t).isOlderThan(jt)) || At(t, new Ct()),
          T()
            ? (function (e) {
                try {
                  var t = Rt(),
      ...
      function Lt(t) {
        return (
          (t && t.__SENTRY__ && t.__SENTRY__.hub) ||
            ((t.__SENTRY__ = t.__SENTRY__ || {}), (t.__SENTRY__.hub = new Ct())),
          t.__SENTRY__.hub
        );
      }
      function At(t, e) {
      ...
      function Wt(t) {
        ...
        return (
          (function (t) {
            ...
            return (
              -1 !== a.indexOf("Debug") && r.push.apply(r, s(r.splice(a.indexOf("Debug"), 1))), r
            );
          })(t).forEach(function (t) {
            !(function (t) {
              -1 === Ht.indexOf(t.name) &&
                (t.setupOnce(Ot, Nt), Ht.push(t.name), X.log("Integration installed: " + t.name));
            })((e[t.name] = t));
          }),
          e
        );
      ...
      var Gt,
          ...
          return (
            ...
            (t.prototype.getIntegration = function (e) {
              try {
                ...
                return (
                  X.warn("Cannot retrieve integration " + e.id + " from the current Client"), null
                );
              }
            }),
                ...
                : new it(function (r, o) {
                    a._prepareEvent(t, e, i)
                      .then(function (t) {
                        if (null !== t) {
                          var e = t;
                          if ((i && i.data && !0 === i.data.__sentry__) || !c || s)
                            return a._sendEvent(e), void r(e);
                          var n = c(t, i);
                          if (void 0 === n)
                            X.error("`beforeSend` method has to return `null` or a valid event.");
                          else if (k(n)) a._handleAsyncBeforeSend(n, r, o);
                          else {
                            if (null === (e = n))
                              return (
                                X.log("`beforeSend` returned `null`, will not send event."),
                                void r(null)
                              );
                            a._sendEvent(e), r(e);
                          }
        ...
        Jt = (function () {
          function t(t) {
            (this._options = t),
              this._options.dsn || X.warn("No DSN provided, backend will not do anything."),
          ...
          return (
            ...
            (a.prototype._isIgnoredError = function (t, n) {
              return (
                ...
                this._getPossibleEventMessages(t).some(function (e) {
      ...
      function ae(t) {
        var e = null,
          n = 0;
        t &&
          ("number" == typeof t.framesToPop ? (n = t.framesToPop) : ie.test(t.message) && (n = 1));
        try {
          if (
            (e = (function (t) {
            ...
            (e = (function (t) {
              ...
              for (var e, n, r, o = [], i = t.stack.split("\n"), a = 0; a < i.length; ++a) {
                if ((n = te.exec(i[a]))) {
                  ...
                  n[3] && -1 < n[3].indexOf(" > eval") && (e = re.exec(n[3]))
      ...
      function ge(t, e, n) {
        ...
        return p(t)
          ? (r = pe(ae(t)))
          : (m(t) || b(t)
              ? F((r = fe(t, e, n.rejection)), {
                  synthetic: !0,
                })
              : (N((r = _e(t, e, n)), "" + t, void 0),
                F(r, {
                  synthetic: !0,
                })),
            r);
                        ...
                        if (e !== u.Status.Success) {
                          if (e === u.Status.RateLimit) {
                            ...
                            (a._disabledUntil = new Date(n + W(n, r))),
                              X.warn("Too many requests, backing off till: " + a._disabledUntil);
                          }
                          i(t);
                        } else
                          o({
            ...
            (s.prototype.setupOnce = function () {
              (Error.stackTraceLimit = 50),
                this._options.onerror &&
                  (X.log("Global Handler attached: onerror"), this._installGlobalOnErrorHandler()),
                ...
                (ht({
                  callback: function (t) {
                    ...
                    if (r && !Ee() && !o) {
                      var i = n.getClient(),
                        a = y(e)
                          ? c._eventFromIncompleteOnError(t.msg, t.url, t.line, t.column)
                ...
                (ht({
                  callback: function (t) {
                    ...
                    try {
                      "reason" in t
                        ? (e = t.reason)
                        : "detail" in t && "reason" in t.detail && (e = t.detail.reason);
                    } catch (t) {}
                    var n = Nt(),
                      r = n.getIntegration(s),
                      o = e && !0 === e.__sentry_own_request__;
        ...
        je = (function () {
          ...
          return (
            (e.prototype.setupOnce = function () {
              var t = O();
              (this._options.setTimeout && Q(t, "setTimeout", this._wrapTimeFunction.bind(this)),
              this._options.setInterval && Q(t, "setInterval", this._wrapTimeFunction.bind(this)),
              ...
              this._options.eventTarget) &&
                (Array.isArray(this._options.eventTarget) ? this._options.eventTarget : Oe).forEach(
            ...
            (e.prototype._wrapXHR = function (n) {
              return function () {
                ...
                var r = this;
                return (
                  ["onload", "onerror", "onprogress", "onreadystatechange"].forEach(function (n) {
                    n in r &&
                      "function" == typeof r[n] &&
                      Q(r, n, function (t) {
                        var e = {
          ...
          return (
            ...
            (e.prototype._consoleBreadcrumb = function (t) {
              ...
              if ("assert" === t.level) {
                ...
                (e.message = "Assertion failed: " + (E(t.args.slice(1), " ") || "console.assert")),
        ...
        Re = (function () {
          ...
          return (
            ...
            (r.prototype._handler = function (t, e) {
              if (!(t.exception && t.exception.values && e && w(e.originalException, Error)))
                return t;
              var n = this._walkErrorTree(e.originalException, this._key);
              return (t.exception.values = s(n, t.exception.values)), t;
            }),
            (r.prototype._walkErrorTree = function (t, e, n) {
              if ((void 0 === n && (n = []), !w(t[e], Error) || n.length + 1 >= this._limit))
                return n;
              var r = le(ae(t[e]));
      ...
      return (
        ...
        (u.Scope = Tt),
        (u.Transports = ke),
        (u.addBreadcrumb = function (t) {
          Dt("addBreadcrumb", t);
        }),
        (u.addGlobalEventProcessor = Ot),
        (u.captureEvent = function (t) {
          return Dt("captureEvent", t);
        }),
        (u.captureException = Ut),
        (u.captureMessage = function (t, e) {
          var n;
          try {
            throw new Error(t);
          } catch (t) {
  ...
  ((editorBridge = {
    ...
    (editorBridge.dev_base_url = "https://edicus-stage.firebaseapp.com"),
    (editorBridge._lastUpdatedAt = "20210609"),
    (editorBridge.init = function (t, e) {
      var i = this;
      (editorBridge._isDev = t),
        (editorBridge.base_url = t ? editorBridge.dev_base_url : editorBridge.base_url),
        e && (editorBridge.base_url = e),
        windowRef.__KOI_EVENT_LISNTER_INITIALIZE ||
          ((i.messageListener = function (t) {
          ...
          windowRef.addEventListener("message", i.messageListener, !1),
          (windowRef.__KOI_EVENT_LISNTER_INITIALIZE = !0));
    }),
    (editorBridge.destroy = function (t, e) {
      e &&
        this.messageListener &&
        (windowRef.removeEventListener("message", this.messageListener, !1),
        (this.messageListener = null),
        (windowRef.__KOI_EVENT_LISNTER_INITIALIZE = !1)),
        this.iframe_el &&
          t &&
          t.firstElementChild &&
          (t.removeChild(this.iframe_el), (this.iframe_el = null));
    }),
    (editorBridge.open_portal = function (t, e) {
      var openUrl = this.base_url + "/ed#/editor_portal?cmd=open_portal&token=" + t.token;
      this._build_iframe(openUrl, t.parent_element), (this.target_callback = e);
    }),
    (editorBridge._add_common_url_param = function (t, e) {
      return (t +=
    ...
    (editorBridge.open_preview = function (t, e) {
      var openUrl =
        ...
        "&flow=" +
        (t.flow || "horizontal") +
        (t.options ? "&wait_options=true" : "") +
        (t.data_row ? "&wait_data_row=true" : "") +
        (t.zoom ? "&wait_zoom=true" : "");
      this._set_deferred_params(t),
        this._build_iframe(openUrl, t.parent_element),
        (this.target_callback = e);
    }),
    (editorBridge.show_tnview = function (t, e) {
      var showUrl =
        this.base_url +
        this.tnview_path +
        "?cmd=show&token=" +
        ...
        (t.zoom ? "&wait_zoom=true" : "");
      this._set_deferred_params(t),
        this._build_iframe(showUrl, t.parent_element),
        (this.target_callback = e);
    }),
    (editorBridge.create_tnview = function (t, e) {
      var createUrl =
        this.base_url +
        this.tnview_path +
        "?cmd=create&token=" +
        ...
        (t.zoom ? "&wait_zoom=true" : "");
      this._set_deferred_params(t),
        this._build_iframe(createUrl, t.parent_element),
        (this.target_callback = e);
    }),
    (editorBridge.open_tnview = function (t, e) {
      var openUrl =
        this.base_url +
        this.tnview_path +
        "?cmd=open&token=" +
    ...
    (editorBridge.show_gallery = function (t, e) {
      var galleryUrl =
        this.base_url +
        this.tnview_path +
        "?cmd=gallery&token=" +
        ...
        (t.lang || "ko") +
        (t.options ? "&wait_options=true" : "") +
        (t.data_feed ? "&wait_data_feed=true" : "") +
        (t.data_row ? "&wait_data_row=true" : "");
      this._set_deferred_params(t),
        this._build_iframe(galleryUrl, t.parent_element),
        (this.target_callback = e);
    }),
    (editorBridge.create_lite_project = function (t, e) {
      var createUrl =
        this.base_url +
        this.lite_path +
        "?cmd=create&token=" +
        ...
        "&uilocale=" +
        (t.uilocale || "ko") +
        (t.private_css ? "&wait_private_css=true" : "") +
        (t.prod_info ? "&wait_prod_info=true" : "") +
        (t.size_option ? "&wait_size_option=true" : "") +
        (t.rsc_option ? "&wait_rsc_option=true" : "");
      this._set_deferred_params(t),
        this._build_iframe(createUrl, t.parent_element),
        (this.target_callback = e);
    }),
    (editorBridge.open_lite_project = function (t, e) {
      var openUrl =
        this.base_url +
        this.lite_path +
        "?cmd=open&token=" +
    ...
    (editorBridge.show_lite_editor = function (t, e) {
      var showUrl =
        this.base_url +
        this.lite_path +
        "?cmd=show&token=" +
    ...
    (editorBridge.post_to_editor = function (t, e) {
      var toEdicusMessage = {
        type: "to-edicus",
        action: t,
        info: e,
      };
      this.iframe_el.contentWindow.postMessage(JSON.stringify(toEdicusMessage), "*");
    }),
    (editorBridge.post_to_tnview = function (t, e) {
      var toEdicusTnviewMessage = {
        type: "to-edicus-tnview",
        action: t,
        info: e,
      };
      this.iframe_el.contentWindow.postMessage(JSON.stringify(toEdicusTnviewMessage), "*");
    }),
    (editorBridge.post_to_preview = function (t, e) {
      var toEdicusPreviewMessage = {
        type: "to-edicus-preview",
        action: t,
        info: e,
      };
      this.iframe_el.contentWindow.postMessage(JSON.stringify(toEdicusPreviewMessage), "*");
    }),
    (editorBridge._build_iframe = function (t, e) {
    ...
    (editorBridge._set_deferred_params = function (t) {
      t.ddp_block
        ? (console.log("detect_ddp", t.ddp_block), (this.ddp_block = t.ddp_block))
        : (this.ddp_block = null),
        t.private_css ? (this.private_css = t.private_css) : (this.private_css = null),
        t.prod_info
          ? (console.log("detect_prod_info", t.prod_info), (this.prod_info = t.prod_info))
          : (this.prod_info = null),
        t.options
          ? (console.log("detect_options", t.options), (this.options = t.options))
          : (this.options = null),
        t.data_feed
          ? (console.log("detect_date_feed", t.data_feed), (this.data_feed = t.data_feed))
          : (this.data_feed = null),
        t.data_row
          ? (console.log("detect_initial_data_row", t.data_row), (this.data_row = t.data_row))
          : (this.data_row = null),
        t.zoom ? (console.log("detect_zoom", t.zoom), (this.zoom = t.zoom)) : (this.zoom = null),
        t.show3d
          ? (console.log("detect_show3d", t.show3d), (this.show3d = t.show3d))
          : (this.show3d = null),
        t.size_option
          ? (console.log("detect_size_option", t.size_option), (this.size_option = t.size_option))
          : (this.size_option = null),
        t.rsc_option
          ? (console.log("detect_rsc_option", t.rsc_option), (this.rsc_option = t.rsc_option))
        ...
        t.option_string ? (this.option_string = t.option_string) : (this.option_string = null);
    });
        ...
        },
        {
          ...
          value: function (t, e, n) {
            ...
            formData.append("target", t),
              formData.append("uid", sessionStorageManager("userId")),
              formData.append("email", sessionStorageManager("email")),
              formData.append("staffCode", sessionStorageManager("staffCode")),
              [
                "projectThumbnail",
                "deleteProject",
                "tentativeOrder",
          ...
          value: function () {
            ...
            (xMLHttpRequest.onreadystatechange = function () {
              if (4 == xMLHttpRequest.readyState && 200 == xMLHttpRequest.status) {
                var t = JSON.parse(xMLHttpRequest.responseText).refreshToken;
                e.refreshToken = t;
              }
            }),
              xMLHttpRequest.open("POST", t),
              xMLHttpRequest.setRequestHeader("content-type", "application/json"),
              xMLHttpRequest.setRequestHeader("red-editor-token", this.token);
            xMLHttpRequest.send(
              JSON.stringify({
                type: "verify",
              })
    ...
    !(function i(a, c, s) {
    ...
    })(
      {
                ...
                r(
                  ...
                  function () {
                    ...
                    return t._t && (t._l = n = n ? n.n : t._t._f)
                      ? o(0, "keys" == e ? n.k : "values" == e ? n.v : [n.k, n.v])
                      : ((t._t = void 0), o(1));
                  },
                  e ? "entries" : "values",
                  !e,
        ...
        22: [
          function (t, e, n) {
            ...
            e.exports = function (r, t, e, n, o, i) {
              ...
              return (
                T(c, r), (l[r] = c), y(y.G + y.W + y.F * (c != a), l), i || n.setStrong(c, r, o), c
              );
            };
          },
          {
              ...
              r = function t(e, n, r) {
                ...
                for (o in (u && (r = n), r))
                  (a = ((i = !s && p && void 0 !== p[o]) ? p : r)[o]),
                    (c = f && i ? m(a, v) : l && "function" == typeof a ? m(Function.call, a) : a),
                    p && y(p, o, a, e & t.U),
                    d[o] != a && _(d, o, c),
                    l && h[o] != a && (h[o] = a);
              };
        ...
        40: [
          function (t, e, n) {
            var r = (e.exports =
              void 0 !== windowRef && windowRef.Math == Math
                ? windowRef
        ...
        67: [
          function (t, e, n) {
            ...
            e.exports = {
              ...
              key: function (t) {
                return void 0 === t || "symbol" == (void 0 === t ? "undefined" : _typeof(t))
                  ? t
                  : String(t);
              },
              exp: function (t) {
          ...
          function (r, t, e) {
            ...
            t.exports =
              ...
              function (t, e) {
                ...
                return (
                  null !== t
                    ? ((s.prototype = o(t)), (n = new s()), (s.prototype = null), (n[c] = t))
                    : (n = u()),
                  void 0 === e ? n : i(n, e)
                );
              };
        ...
        76: [
          function (t, e, n) {
            var r = t(117),
              ...
              i = {}.toString,
              a =
                "object" == (void 0 === windowRef ? "undefined" : _typeof(windowRef)) &&
                windowRef &&
                Object.getOwnPropertyNames
                  ? Object.getOwnPropertyNames(windowRef)
                  : [];
            e.exports.f = function (t) {
        ...
        84: [
          function (t, e, n) {
            ...
            e.exports = function (c) {
              return function (t) {
                for (var e, n = u(t), r = s(n), o = r.length, i = 0, a = []; i < o; )
        ...
        88: [
          function (t, e, n) {
            ...
            e.exports = function () {
              for (
                var o = l(this), i = arguments.length, a = Array(i), t = 0, c = r._, s = !1;
                t < i;

              )
                (a[t] = arguments[t++]) === c && (s = !0);
              return function () {
                var t,
                  e = arguments.length,
                  n = 0,
                ...
                if (((t = a.slice()), s)) for (; n < i; n++) t[n] === c && (t[n] = arguments[r++]);
            ...
            (t(23).inspectSource = function (t) {
              ...
              (e.exports = function (t, e, n, r) {
                ...
                o && (c(n, "name") || a(n, "name", e)),
                  t[e] !== n &&
                    (o && (c(n, s) || a(n, s, t[e] ? "" + t[e] : u.join(String(e)))),
                    t === i
                      ? (t[e] = n)
                      : r
                      ? t[e]
            ...
            t.exports = {
              set:
                ...
                ("__proto__" in {}
                  ? (function (t, n, r) {
                      try {
                        (r = e(25)(Function.call, e(75).f(Object.prototype, "__proto__").set, 2))(
                          t,
                          []
                        ),
            ...
            if (t(29)) {
              var _ = t(60),
                ...
                Nt = {
                  ...
                  reverse: function () {
                    for (var t, e = this, n = Et(e).length, r = Math.floor(n / 2), o = 0; o < r; )
                      (t = e[o]), (e[o++] = e[--n]), (e[n] = t);
                    return e;
                  },
                  some: function (t) {
            ...
            function r(t, e, n) {
              ...
              for (
                (t = A(t)) != t || t === F
                  ...
                  : ((r = U(B(t) / z)),
                    t * (i = D(2, -r)) < 1 && (r--, (i *= 2)),
                    2 <= (t += 1 <= r + u ? l / i : l * D(2, 1 - u)) * i && (r++, (i /= 2)),
                    s <= r + u
                      ? ((o = 0), (r = s))
                      : 1 <= r + u
                      ? ((o = (t * i - 1) * D(2, e)), (r += u))
        ...
        123: [
          function (t, e, n) {
            for (
              ...
              (r = o[p[f++]]) ? (i(r.prototype, c, !0), i(r.prototype, s, !0)) : (l = !1);
            e.exports = {
              ABV: u,
              CONSTR: l,
              TYPED: c,
            ...
            r(r.P + r.F * (s || !t(105)(c)), "Array", {
              lastIndexOf: function (t) {
                ...
                var e = o(this),
                  ...
                  r = n - 1;
                for (
                  1 < arguments.length && (r = Math.min(r, i(arguments[1]))), r < 0 && (r = n + r);
                  0 <= r;
                  r--
                )
            ...
            r(
              ...
              "Array",
              {
                slice: function (t, e) {
                  ...
                  for (var o = l(t, n), i = l(e, n), a = f(i - o), c = Array(a), s = 0; s < a; s++)
        ...
        169: [
          function (t, e, n) {
            ...
            r(r.S, "Math", {
              hypot: function (t, e) {
                for (var n, r, o = 0, i = 0, a = arguments.length, c = 0; i < a; )
                  c < (n = s(arguments[i++]))
                    ? ((o = o * (r = c / n) * r + 1), (c = n))
                    : (o += 0 < n ? (r = n / c) * r : n);
            ...
            var r,
              ...
              P = !!(function () {
                try {
                  ...
                  return (
                    (E || "function" == typeof PromiseRejectionEvent) && t.then(I) instanceof e
                  );
                } catch (t) {}
              })(),
              O = c
                    ...
                    for (var c = u._v, s = 1 == u._s, t = 0; n.length > t; )
                      !(function (t) {
                        ...
                        try {
                          r
                            ? (s || (2 == u._h && N(u), (u._h = 1)),
                              !0 === r ? (e = c) : (a && a.enter(), (e = r(c)), a && a.exit()),
                              e === t.promise
                ...
                return !n && r && t.constructor === u && o
                  ...
                  : i(
                      h
                        ...
                        : l((r = t instanceof u) ? t.source : t, r && o ? s.call(t) : e),
                      n ? this : f,
                      u
                    );
              };
            ...
            t(36)("split", 2, function (o, i, a) {
              ...
              if (
                ...
                a = function (t, e) {
                  ...
                  return (
                    l === n[g] ? (!a && p.test("")) || s.push("") : s.push(n.slice(l)),
                    s[g] > f ? s.slice(0, f) : s
                  );
                };
              } else
        ...
        246: [
          function (t, e, n) {
            ...
            r(r.S, "String", {
              raw: function (t) {
                for (
                  var e = a(t.raw), n = c(e.length), r = arguments.length, o = [], i = 0;
                  i < n;

                )
                  o.push(String(e[i++])), i < r && o.push(String(arguments[i]));
                return o.join("");
              },
            });
          },
          ...
          function (t, e, n) {
            var r = t(40),
              ...
              Y = function (t) {
                ...
                return (
                  !(this === B && a(D, t) && !a(U, t)) &&
                  (!(e || !a(this, t) || !a(D, t) || (a(this, N) && this[N][t])) || e)
                );
              },
              $ = function (t, e) {
              ...
              Z = function (t) {
                for (var e, n = t === B, r = j(n ? U : b(t)), o = [], i = 0; r.length > i; )
            ...
            r(r.P, "Array", {
              flatMap: function (t) {
                var e,
                  ...
                  r = i(this);
                return (
                  c(t), (e = a(r.length)), (n = s(r, 0)), o(n, r, r, e, 0, 1, t, arguments[1]), n
                );
              },
            }),
              t(5)("flatMap");
                ...
                of: function () {
                  ...
                  return new ("function" == typeof this ? this : x)(function (e) {
                    ...
                    return (
                      o(function () {
                        if (!n) {
                          for (var t = 0; t < r.length; ++t) if ((e.next(r[t]), n)) return;
                          e.complete();
                        }
                      }),
                      function () {
            ...
            var r = t(40),
              ...
              u = function (n) {
                return s
                  ? function (t, e) {
                      return n(
                        i(a, [].slice.call(arguments, 2), "function" == typeof t ? t : Function(t)),
                        e
                      );
                    }
                  : n;
                ...
                function l(t, e) {
                  ...
                  if (n === h) {
                    if (((e.delegate = null), "throw" === e.method)) {
                      if (
                        t.iterator.return &&
                        ((e.method = "return"), (e.arg = h), l(t, e), "throw" === e.method)
                      )
                        return T;
                      (e.method = "throw"),
                    ...
                    (k.mark = function (t) {
                      return (
                        Object.setPrototypeOf
                          ...
                          : ((t.__proto__ = e), b in t || (t[b] = "GeneratorFunction")),
                    ...
                    (f.prototype = {
                      ...
                      finish: function (t) {
                        for (var e = this.tryEntries.length - 1; 0 <= e; --e) {
                          ...
                          if (n.finallyLoc === t)
                            return this.complete(n.completion, n.afterLoc), s(n), T;
                        }
                      },
                      catch: function (t) {
                        for (var e = this.tryEntries.length - 1; 0 <= e; --e) {
  ...
  // ============================================================
  /**
   * apiClientInstance — ApiClient 인스턴스(makers API 통신용 싱글턴). (원본 식별자 en, 36회 참조)
   */
  var sessionStorageManager = function (t, e) {
    ...
    onLoadCallback = function (t) {
      return null;
    },
    onChangeCallback = function (t) {
      return null;
    },
    onCloseCallback = function (t) {
      return null;
    },
    onSaveCallback = function (t) {
      return null;
    },
    onSelectCallback = function (t) {
      return null;
    },
    onHistoryStateCallback = function (t) {
      return null;
    },
    onHistoryLabelCallback = function (t) {
      return null;
    },
    onPromoReportCallback = function (t) {
      return null;
    },
    onGroupCaptionCallback = function (t) {
      return null;
    },
    commandPromiseHandlers = {
      resolve: function (t) {
        return null;
      },
      reject: function (t) {
    ...
    onAllEventsCallback = function (t) {
      return null;
    },
    onDdpExecuteCompleteCallback = function () {
      return null;
    },
    onImagePoolCallback = function (t) {
      return null;
    },
    onPreviewCloseCallback = function () {
      return null;
    },
    onFontListCallback = function (t) {
      return null;
    },
    onChangeModeCallback = function (t) {
      return null;
    },
    onPageCountChangeCallback = function (t) {
      return null;
    },
    onPageChangeCallback = function (t) {
      return null;
    },
    onImposeOpenedCallback = function (t) {
      return null;
    },
    onPrintCountChangeCallback = function (t) {
      return null;
    },
    onCustomTabSelectionChangeCallback = function (t) {
      return null;
    },
    onDocReportCallback = function (t) {
      return null;
    },
    koiTokenRefreshListener = function (t) {
      if (t.data && "string" == typeof t.data && t.data.match(/^{.*}$/g)) {
        var e = JSON.parse(t.data);
        "KOI-SDK" == e.target &&
          "refreshToken" == e.action &&
          apiClientInstance.setToken(e.info.token);
      }
    },
        ...
        console.log(t, e),
        {
          commands: t.reduce(function (t, e) {
            if (e.hiddenItems && e.hiddenItems.constructor === new Array().constructor) {
              ...
              try {
                for (
                  var _iterStep, _iterator = e.hiddenItems[Symbol.iterator]();
                ...
                try {
                  !_iterDone && _iterator.return && _iterator.return();
                } finally {
            ...
            if (e.deletePages && e.deletePages.constructor === new Array().constructor) {
              ...
              try {
                for (
                  var _iterStep2, _iterator2 = e.deletePages[Symbol.iterator]();
                ...
                try {
                  !_iterDone2 && _iterator2.return && _iterator2.return();
                } finally {
                  if (_iterDidErr2) throw _iterErr2;
                }
              }
            }
            if (e.setItems && e.setItems.constructor === new Array().constructor) {
              ...
              try {
                for (
                  var _iterStep3, _iterator3 = e.setItems[Symbol.iterator]();
                  !(_iterDone3 = (_iterStep3 = _iterator3.next()).done);
                  _iterDone3 = !0
                ) {
                  var _iterValue3 = _iterStep3.value,
                    k = {};
                  (k.action = "cell" === _iterValue3.type ? "set-cell-src" : "set-item-src"),
                    (k.target = {
                      object: "item",
                    }),
                    _iterValue3 && _iterValue3.target && "background" === _iterValue3.target.type
                      ? ((k.target.type = _iterValue3.target.type),
                        (k.data = {
                          src: _iterValue3.data.src,
                        }))
                      : (_iterValue3.tid
                          ? (k.target.item_id = _iterValue3.tid)
                          : (_iterValue3.id && (k.target.var_id = _iterValue3.id),
                            _iterValue3.name && (k.target.name = _iterValue3.name)),
                        (k.data = {
                          src: _iterValue3.src,
                        }),
                        _iterValue3.srcSize && (k.data.srcSize = _iterValue3.srcSize),
                        _iterValue3.scaleType && (k.data.scaleType = _iterValue3.scaleType),
                        "center" === _iterValue3.scaleType &&
                          _iterValue3.srcSize &&
                          (k.data.size_mm = _iterValue3.srcSize),
                        _iterValue3.nocache && (k.data.nocache = _iterValue3.nocache)),
                    t.push(k);
                }
              } catch (t) {
                (_iterDidErr3 = !0), (_iterErr3 = t);
              } finally {
                try {
                  !_iterDone3 && _iterator3.return && _iterator3.return();
                } finally {
                  if (_iterDidErr3) throw _iterErr3;
                }
              }
            }
            if (e.setAttributes && e.setAttributes.constructor === new Array().constructor) {
              ...
              try {
                for (
                  var _iterStep4, _iterator4 = e.setAttributes[Symbol.iterator]();
                  !(_iterDone4 = (_iterStep4 = _iterator4.next()).done);
                  _iterDone4 = !0
                ) {
                  ...
                  if ("layer" === _iterValue4.type) {
                    ...
                    (j.target = {
                      object: "all-items",
                      type: _iterValue4.target,
                      scope: _iterValue4.scope || "document",
                    }),
                      (j.data = {}),
                      "color" === _iterValue4.data.attribute &&
                        ("textbox" === _iterValue4.target
                          ? ((j.action = "set-text-style"),
                            (j.data.fontColor = _iterValue4.data.value))
                          : "svgart" === _iterValue4.target
                          ? ((j.action = "set-item-overlay-src"),
                            (j.data.overlaySrc = "value://color/" + _iterValue4.data.value))
                          : ((j.action = "set-item-src"),
                            (j.data.src =
                              "value://color/" +
                              _iterValue4.data.value +
                              objectToQueryParam(_iterValue4.data.cmyk)))),
                      "textbox" === _iterValue4.target &&
                        "font" === _iterValue4.data.attribute &&
                        _iterValue4.data.font &&
                        (j.data.font = _iterValue4.data.font),
                      t.push(j);
                  }
                ...
                (_iterDidErr4 = !0), (_iterErr4 = t);
              } finally {
                try {
                  !_iterDone4 && _iterator4.return && _iterator4.return();
                } finally {
                  if (_iterDidErr4) throw _iterErr4;
                }
              }
            }
            if (e.clonePages && e.clonePages.constructor === new Array().constructor) {
              ...
              try {
                for (
                  var _iterStep5, _iterator5 = e.clonePages[Symbol.iterator]();
                  !(_iterDone5 = (_iterStep5 = _iterator5.next()).done);
                  _iterDone5 = !0
                ) {
                ...
                try {
                  !_iterDone5 && _iterator5.return && _iterator5.return();
                } finally {
                  if (_iterDidErr5) throw _iterErr5;
                }
              }
            }
            if (e.flipStickers && e.flipStickers.constructor === new Array().constructor) {
              ...
              try {
                for (
                  var _iterStep6, _iterator6 = e.flipStickers[Symbol.iterator]();
                  !(_iterDone6 = (_iterStep6 = _iterator6.next()).done);
                  _iterDone6 = !0
                ) {
                ...
                try {
                  !_iterDone6 && _iterator6.return && _iterator6.return();
                } finally {
                  if (_iterDidErr6) throw _iterErr6;
                }
              }
            }
            if (e.changeLayout && e.changeLayout.constructor === new Array().constructor) {
              ...
              try {
                for (
                  var _iterStep7, _iterator7 = e.changeLayout[Symbol.iterator]();
                  !(_iterDone7 = (_iterStep7 = _iterator7.next()).done);
                  _iterDone7 = !0
                ) {
                  ...
                  (changeLayoutCommand.data = {
                    ...
                    changeOverlay: !1 !== _iterValue7.changeOverlay,
                    transferCellContent: !1 !== _iterValue7.transferCellContent,
                    transferTextContent: !1 !== _iterValue7.transferTextContent,
                ...
                try {
                  !_iterDone7 && _iterator7.return && _iterator7.return();
                } finally {
                  if (_iterDidErr7) throw _iterErr7;
                }
              }
            }
            if (e.copyPageContent && e.copyPageContent.constructor === new Array().constructor) {
              ...
              try {
                for (
                  var _iterStep8, _iterator8 = e.copyPageContent[Symbol.iterator]();
                  !(_iterDone8 = (_iterStep8 = _iterator8.next()).done);
                  _iterDone8 = !0
                ) {
                ...
                try {
                  !_iterDone8 && _iterator8.return && _iterator8.return();
                } finally {
                  if (_iterDidErr8) throw _iterErr8;
                }
              }
            }
            if (
              ...
              try {
                for (
                  var _iterStep9, _iterator9 = e.addPages[Symbol.iterator]();
                  !(_iterDone9 = (_iterStep9 = _iterator9.next()).done);
                  _iterDone9 = !0
                ) {
                  ...
                  if (_iterValue9.cutMargin) {
                    ...
                    try {
                      for (
                        var _iterStep10,
                          _iterator10 = Object.entries(_iterValue9.cutMargin)[Symbol.iterator]();
                      ...
                      try {
                        !_iterDone10 && _iterator10.return && _iterator10.return();
                      } finally {
                        if (_iterDidErr10) throw _iterErr10;
                      }
                    }
                  }
                ...
                try {
                  !_iterDone9 && _iterator9.return && _iterator9.return();
                } finally {
                  if (_iterDidErr9) throw _iterErr9;
                }
              }
            }
            if (e.addItems && e.addItems.constructor === new Array().constructor) {
              ...
              try {
                for (
                  var _iterStep11, _iterator11 = e.addItems[Symbol.iterator]();
                  !(_iterDone11 = (_iterStep11 = _iterator11.next()).done);
                  _iterDone11 = !0
                ) {
                ...
                try {
                  !_iterDone11 && _iterator11.return && _iterator11.return();
                } finally {
                  if (_iterDidErr11) throw _iterErr11;
                }
              }
            }
            if (
              ...
              try {
                for (
                  var _iterStep12, _iterator12 = e.addExternalImages[Symbol.iterator]();
                  !(_iterDone12 = (_iterStep12 = _iterator12.next()).done);
                  _iterDone12 = !0
                ) {
                ...
                try {
                  !_iterDone12 && _iterator12.return && _iterator12.return();
                } finally {
                  if (_iterDidErr12) throw _iterErr12;
                }
              }
            }
            if (
              ...
              try {
                for (
                  var _iterStep13, _iterator13 = e.addInternalImages[Symbol.iterator]();
                  !(_iterDone13 = (_iterStep13 = _iterator13.next()).done);
                  _iterDone13 = !0
                ) {
                  ...
                  if (_iterValue13.multi) {
                    var setCellSrcInfosPayload = {
                      ...
                      sort_type: "default",
                      srcs: _iterValue13.images.map(function (t) {
                        return {
                          src_key: t.key,
                          src_info: t.info,
                        };
                ...
                (_iterDidErr13 = !0), (_iterErr13 = t);
              } finally {
                try {
                  !_iterDone13 && _iterator13.return && _iterator13.return();
                } finally {
                  if (_iterDidErr13) throw _iterErr13;
                }
              }
            }
            if (e.setTexts && e.setTexts.constructor === new Array().constructor) {
              ...
              try {
                for (
                  var _iterStep14, _iterator14 = e.setTexts[Symbol.iterator]();
                  !(_iterDone14 = (_iterStep14 = _iterator14.next()).done);
                  _iterDone14 = !0
                ) {
                  var _iterValue14 = _iterStep14.value,
                    setTextStyleCommand2 = {
                      ...
                      target: {
                        object: "item",
                        var_id: _iterValue14.variableId,
                      },
                      data: {},
                    };
                ...
                try {
                  !_iterDone14 && _iterator14.return && _iterator14.return();
                } finally {
                  if (_iterDidErr14) throw _iterErr14;
                }
              }
            }
            if (
              ...
              try {
                for (
                  var _iterStep15, _iterator15 = e.setItemAttributes[Symbol.iterator]();
                  !(_iterDone15 = (_iterStep15 = _iterator15.next()).done);
                  _iterDone15 = !0
                ) {
                ...
                try {
                  !_iterDone15 && _iterator15.return && _iterator15.return();
                } finally {
                  if (_iterDidErr15) throw _iterErr15;
                }
              }
            }
            if (e.setLayerFeatures && e.setLayerFeatures.constructor === new Array().constructor) {
              ...
              try {
                for (
                  var _iterStep16, _iterator16 = e.setLayerFeatures[Symbol.iterator]();
                  !(_iterDone16 = (_iterStep16 = _iterator16.next()).done);
                  _iterDone16 = !0
                ) {
                  var _iterValue16 = _iterStep16.value,
                    setItemLayerFilterCommand = {
                      ...
                      target: {
                        object: "item",
                        postlayer: _iterValue16.target,
                      },
                      data: _defineProperty(
                        {},
                        "" + _iterValue16.feature,
                        _iterValue16.value ? "true" : "false"
                      ),
                    };
                ...
                try {
                  !_iterDone16 && _iterator16.return && _iterator16.return();
                } finally {
                  if (_iterDidErr16) throw _iterErr16;
                }
              }
            }
            if (e.resizePages && e.resizePages.constructor === new Array().constructor) {
              ...
              try {
                for (
                  var _iterStep17, _iterator17 = e.resizePages[Symbol.iterator]();
                  !(_iterDone17 = (_iterStep17 = _iterator17.next()).done);
                  _iterDone17 = !0
                ) {
                  var _iterValue17 = _iterStep17.value,
                    resizePageCommand = {
                      ...
                      target: {
                        object: "page",
                        index: _iterValue17.pageIndex,
                      },
                      data: {
                        size_mm: {
                          width: _iterValue17.width,
                          height: _iterValue17.height,
                        },
                        imposing_rect_mm: _iterValue17.imposing_rect_mm,
                ...
                try {
                  !_iterDone17 && _iterator17.return && _iterator17.return();
                } finally {
                  if (_iterDidErr17) throw _iterErr17;
                }
              }
            }
            if (e.imposePages && e.imposePages.constructor === new Array().constructor) {
              ...
              try {
                for (
                  var _iterStep18, _iterator18 = e.imposePages[Symbol.iterator]();
                  !(_iterDone18 = (_iterStep18 = _iterator18.next()).done);
                  _iterDone18 = !0
                ) {
                  var _iterValue18 = _iterStep18.value,
                    imposePagesCommand = {
                      ...
                      data: {
                        type: "bin-packing",
                        info: {
                          methods: _iterValue18.methods,
                          srcPages: _iterValue18.srcPages,
                          paperSize_mm: _iterValue18.paperSize,
                          imposeRect_mm: _iterValue18.imposeRect,
                          baseTemplateUri: _iterValue18.baseTemplateUri,
                          rotatable: _iterValue18.rotatable,
                          border: _iterValue18.border,
                          sort: _iterValue18.sort,
                          preserve_page_group: _iterValue18.preservePageGroup || !1,
                        },
                      },
                    };
                ...
                try {
                  !_iterDone18 && _iterator18.return && _iterator18.return();
                } finally {
                  if (_iterDidErr18) throw _iterErr18;
                }
              }
            }
            if (e.addPageGroup && e.addPageGroup.constructor === new Array().constructor) {
              ...
              try {
                for (
                  var _iterStep19, _iterator19 = e.addPageGroup[Symbol.iterator]();
                  !(_iterDone19 = (_iterStep19 = _iterator19.next()).done);
                  _iterDone19 = !0
                ) {
                ...
                try {
                  !_iterDone19 && _iterator19.return && _iterator19.return();
                } finally {
                  if (_iterDidErr19) throw _iterErr19;
                }
              }
            }
            if (e.clonePageGroup && e.clonePageGroup.constructor === new Array().constructor) {
              ...
              try {
                for (
                  var _iterStep20, _iterator20 = e.clonePageGroup[Symbol.iterator]();
                ...
                try {
                  !_iterDone20 && _iterator20.return && _iterator20.return();
                } finally {
                  if (_iterDidErr20) throw _iterErr20;
                }
              }
            }
            if (e.changeGroupInfo && e.changeGroupInfo.constructor === new Array().constructor) {
              ...
              try {
                for (
                  var _iterStep21, _iterator21 = e.changeGroupInfo[Symbol.iterator]();
                  !(_iterDone21 = (_iterStep21 = _iterator21.next()).done);
                  _iterDone21 = !0
                ) {
                ...
                try {
                  !_iterDone21 && _iterator21.return && _iterator21.return();
                } finally {
                  if (_iterDidErr21) throw _iterErr21;
                }
              }
            }
            if (e.setPageAttribute) {
              ...
              try {
                for (
                  var _iterStep22, _iterator22 = e.setPageAttribute[Symbol.iterator]();
                ...
                try {
                  !_iterDone22 && _iterator22.return && _iterator22.return();
                } finally {
    ...
    vdpCatalogData = null,
    koiContainerElement = void 0,
    koiIframeElement = void 0,
    apiClientInstance = null,
    koiPassiveMessageListener = function (t) {
      if (t.data && "string" == typeof t.data && t.data.match(/^{.*}$/g)) {
        var e = JSON.parse(t.data);
        if (e && "From-KOI-Passive" === e.target)
          switch (e.type) {
            case "load":
              (isEditorBusy = !1),
                sessionStorageManager("projectId", e.info.info.project_id),
                onLoadCallback(e.info);
              break;
            case "save":
              onSaveCallback(e.info);
              break;
            case "error":
              onErrorCallback(e.info);
              break;
            case "close":
              onCloseCallback(e.info);
          }
      }
    },
    sentryHubInstance = null,
    sentryLogger = function (t) {
      var e = t.message,
        projectId = t.projectId,
        data = t.data,
        level = t.level,
        i = void 0 === level ? "info" : level;
      try {
        sentryHubInstance.withScope(function (t) {
          t.setUser({
            id: sessionStorageManager("userId"),
            username: sessionStorageManager("userId"),
          }),
            t.setTag("projectId", projectId),
            t.setTag("editorBaseURL", editorBridge.base_url),
            sdkState.clone &&
              (t.setTag("originProjectId", sdkState.originProjectId),
              (data.clone = !0),
              (data.originProjectId = sdkState.originProjectId)),
            t.setExtras(data),
            t.addEventProcessor(function (t) {
              return (
                (t.request = _extends(
            ...
            sentryHubInstance.captureMessage(e, i);
        });
      } catch (t) {
        console.log(t);
      }
    ...
    RedEditorSDK = (function () {
      function _regO(t) {
        _classCallCheck(this, _regO);
        var self2 = this;
        (self2.version = "6.6.48"),
          (self2.isDev = !1),
          (sdkState.fromKOIPassive = t.fromKOIPassive),
          (sdkState.mode = "standard"),
          (sdkState.deviceTarget = "pc");
        try {
          validateRequiredParams(["accessToken"], t);
        } catch (t) {
          onErrorCallback &&
            onErrorCallback.constructor === Function &&
            ((t.code = "002"), onErrorCallback(t)),
            console.error(t);
        } finally {
          var e = "local" === t.sandboxMode ? "local" : t.sandboxMode ? "dev" : "product";
          if (
            ((apiClientInstance = new ApiClient(t.accessToken, e)),
            t.inheritToken ||
              (apiClientInstance.verifyToken(),
              apiClientInstance.autoRefreshToken(function (t, e) {
                if (koiIframeElement) {
                  ...
                  koiIframeElement.contentWindow.postMessage(
                    JSON.stringify(refreshTokenCommand),
                    "*"
                  );
                }
              })),
            (self2.isDev = t.sandboxMode),
            editorBridge.init(self2.isDev, t.initialStageUrl),
            windowRef.addEventListener("message", koiTokenRefreshListener, !1),
            t.userId)
          )
            sessionStorageManager("userId", t.userId),
              apiClientInstance
                .call("issueUserToken")
                .then(function (t) {
                  t.division && sessionStorageManager("division", t.division),
                    t.lang && sessionStorageManager("lang", t.lang),
                    t.companyCode && sessionStorageManager("companyCode", t.companyCode);
                  var e = {
                    token: t.token,
            ...
            try {
              ...
              console.error(t), (self2.isReady = !1);
            }
          t.email && sessionStorageManager("email", t.email),
            t.staffCode && sessionStorageManager("staffCode", t.staffCode),
            (function () {
              var t = new sentryLib.BrowserClient({
                dsn: "https://d574a33afd6c41cfb5f1afddc2110603@logging.betterwaysystems.com/1",
                integrations: [].concat(_toConsumableArray(sentryLib.defaultIntegrations)),
                normalizeDepth: 8,
                release: "v6.6.48",
              });
              new sentryLib.Hub(t).run(function (t) {
                sentryHubInstance = t;
              });
            })();
        }
        ...
        _createClass(_regO, [
          {
            ...
            value: function (t) {
              sessionStorageManager("currentTemplate", t);
            },
          },
          {
            /**
            ...
            value: function () {
              return JSON.parse(sessionStorageManager("currentTemplate") || "{}");
            },
          },
          {
            // ---- 프로젝트 관리 메서드 (7개) ----
                ...
                function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        if (isEditorBusy) return t.abrupt("return", !1);
                        t.next = 2;
                        break;
                      case 2:
                        if (
                      ...
                      case 71:
                        if (
                          ...
                          return (
                            ...
                            (_regG = _regP.options),
                            (t.next = 78),
                            regeneratorRuntime.awrap(this.getProductInfo(_regD))
                          );
                        t.next = 94;
                        break;
                      case 78:
                        return (
                          (_ = t.sent),
                          (t.next = 81),
                          regeneratorRuntime.awrap(this.getTemplateList(_regD))
                        );
                      case 81:
                        return (
                          (y = t.sent.list),
                      ...
                      case 68:
                        if (projectOptions.customTabInfo)
                          return (
                            ...
                            (_regC = e.initValues),
                            (_regS = e.options),
                            (_regU = void 0 === _regS ? {} : _regS),
                            (t.next = 73),
                            regeneratorRuntime.awrap(this.getProductInfo(_regN))
                          );
                        t.next = 87;
                        break;
                      case 73:
                        return (
                          (_regL = t.sent),
                          (t.next = 76),
                          regeneratorRuntime.awrap(this.getTemplateList(_regN))
                        );
                      case 76:
                        return (
                          (_regF = t.sent.list),
                          ...
                          (_regU.skipInitVarMap = !0),
                          (t.next = 83),
                          regeneratorRuntime.awrap(_regD.getCustomTabFormat(_regR, _regC, _regU))
                        );
                      case 83:
                        (_regH = t.sent),
                ...
                function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 11:
                        (t.prev = 11),
                          validateRequiredParams(["selector", "projectId", "psCode"], _argO),
                          (t.next = 18);
                        break;
                      case 15:
                        (t.prev = 15),
                          ...
                          (i.limitColor || i.paletteCode) &&
                            (_argO.extra
                              ...
                              : ((_argO.extra = {}),
                                (_argO.extra.palette = {}),
                                i.limitColor &&
                                  (_argO.extra.palette.max_color = parseInt(i.limitColor)),
                                i.paletteCode && (_argO.extra.palette.palCode = i.paletteCode))),
                          i && i.privateCSS)
                        )
                          return (
                            (t.next = 38), regeneratorRuntime.awrap(this.getCustomCss(i.privateCSS))
                          );
                        t.next = 39;
                        break;
                      case 38:
                      ...
                      case 39:
                        return (
                          ...
                          !0 === _argO.clone
                            ? this.cloneProject(_argO.projectId)
                                .then(function (t) {
                                  (sdkState.clone = !0),
          ...
          },
          {
            ...
            key: "editTemplate",
            value: function (e) {
              var _regN, _regR, _regO2, i, _regA;
              return regeneratorRuntime.async(
                function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                        ...
                        if (
                          ...
                          e &&
                            ...
                            (e.unableLayers.constructor === String().constructor
                              ? (_regR.unlayers = e.unableLayers)
                              : e.unableLayers.constructor === Array().constructor &&
                                0 < e.unableLayers.length &&
                                (_regR.unlayers = e.unableLayers.join(","))),
                          e &&
                            e.lockGroupPageCount &&
                            ((_regR.no_edit_group = e.lockGroupPageCount),
                            (_regR.edit_lock = "edit-group")),
                          e &&
                            e.disableMasterColorPicker &&
                            ((_regR.no_edit_group = e.lockGroupPageCount),
                            (_regR.edit_lock = _regR.edit_lock
                              ? _regR.edit_lock + ",set-strict-color"
                              : "set-strict-color")),
                          e &&
                            e.disableFontPreview &&
                            (_regR.edit_lock = _regR.edit_lock
                              ? _regR.edit_lock + ",no-font-preview"
                              : "no-font-preview"),
                          e &&
                            e.disableSelection &&
                            (_regR.edit_lock = _regR.edit_lock
                              ? _regR.edit_lock + ",no-selection"
                              : "no-selection"),
                          e.resourceParams && (_regR.resapi_param = e.resourceParams),
                          e.clearSource && (_regR.clear_src = e.clearSource),
                          e.privateCSS)
                        )
                          return (
                            (t.next = 13), regeneratorRuntime.awrap(this.getCustomCss(e.privateCSS))
                          );
                        t.next = 14;
                        break;
                      case 13:
                        _regR.private_css = t.sent;
                      case 14:
                        ...
                        return t.abrupt("return", !1);
                      case 17:
                        (_regO2 = _regN.editorEventHandler),
                          e.promotionInfo &&
                            (_regR.options || (_regR.options = {}),
                            (_regR.options.promo = {
                          ...
                          (i = sessionStorageManager("staffEditorToken")),
                          (i = JSON.parse(i || "{}")),
                          3e6,
                          (_regA = {}),
                          new Date().getTime() - i.expiredAt < 3e6
                            ...
                            : (_regA.token = !1),
                          _regA.token
                            ? ((_regR.token = _regA.token),
                              editorBridge.edit_template(_regR, _regO2))
                            : apiClientInstance
                                ...
                                .then(function (t) {
                                  ...
                                  sessionStorageManager("staffEditorToken", e),
                                    editorBridge.edit_template(_regR, _regO2);
                                })
                                .catch(function (t) {
                                  onErrorCallback &&
          ...
          },
          {
            ...
            value: function (t) {
              var self2 = this;
              try {
                validateRequiredParams(["selector", "projectId"], t);
              } catch (t) {
                onErrorCallback &&
                  onErrorCallback.constructor === Function &&
                  ((t.code = "003"), onErrorCallback(t)),
          ...
          },
          {
            ...
            key: "setVariableData",
            value: function (t) {
              editorBridge.set_variable_data_row(t);
            },
          },
          {
            /**
            ...
            value: function (t) {
              editorBridge.move_page_tnview(t);
            },
          },
          {
            /**
          ...
          },
          {
            ...
            key: "changeProject",
            value: function (t) {
              sessionStorageManager("projectId", t), editorBridge.change_project(t);
            },
          },
          {
            /**
          ...
          },
          {
            ...
            value: function (e, _argN) {
              var _regR, _regO2, i, _regA, _regC, _regS, _regU;
              return regeneratorRuntime.async(
                function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 5:
                        if (
                          ("project-id-created" === _argN.action &&
                            (sessionStorageManager("projectId", _argN.info.project_id),
                            onCreateCallback(_argN)),
                          ("load-project-report" !== _argN.action &&
                            "edit-template-report" !== _argN.action) ||
                            "end" !== _argN.info.status ||
                            ((isEditorBusy = !1),
                            onLoadCallback(_argN),
                            autoSaveIntervalMinutes &&
                              "number" == typeof autoSaveIntervalMinutes &&
                              (autoSaveIntervalId = setInterval(function () {
                                editorBridge.post_to_editor("command", {
                                  type: "save",
                                  show_progress: !1,
                                  force_save: !1,
                                });
                              }, 6e4 * autoSaveIntervalMinutes)),
                            sentryLogger({
                              message:
                                "[" +
                                sdkState.openType +
                                "]Editor Loaded" +
                                (sdkState.fromKOIPassive ? "(KOI-Passive)" : ""),
                              projectId: sessionStorageManager("projectId"),
                              data: _extends({}, _argN.info, {
                                mode: sdkState.mode,
                                deviceTarget: sdkState.deviceTarget,
                                config: sdkState.params,
                              }),
                            })),
                          "show-tn-report" === _argN.action &&
                            "end" === _argN.info.status &&
                            onLoadCallback(_argN),
                          !["doc-changed", "var-added", "var-deleted", "var-changed"].includes(
                            _argN.action
                          ))
                        ) {
                          t.next = 20;
                        ...
                        if (
                          (onChangeCallback(_argN), "doc-changed" !== _argN.action || !_argN.info)
                        ) {
                          t.next = 20;
                          break;
                        }
                        if (_argN.info && _argN.info.template_uri)
                          return (
                            (_regR = _argN.info.template_uri.split("/")),
                            (_regO2 = _regR.length),
                            (i = _regR[_regO2 - 1].split(".")[0]),
                            (t.next = 17),
                            regeneratorRuntime.awrap(apiClientInstance.getResourceWithId(i))
                          );
                        t.next = 19;
                        break;
                      case 17:
                        (_regA = t.sent) && _regA.template_uri
                          ? apiClientInstance.updateTemplateCount(_regA.template_uri, "hit")
                          : console.warn("Fail Resource Info LookUp");
                      case 19:
                        vdpCatalogData =
                          void 0 !== _argN.info.vdp_catalog &&
                          null !== _argN.info.vdp_catalog &&
                          0 < Object.keys(_argN.info.vdp_catalog).length
                            ? {
                                totalPage: _argN.info.page_count,
                                variableDataList: _argN.info.vdp_catalog,
                              }
                            : null;
                      case 20:
                        if (
                          ("page-changed" === _argN.action && onPageChangeCallback(_argN),
                          "promo-external-report" === _argN.action && onPromoReportCallback(_argN),
                          "command-completed" === _argN.action &&
                            (commandPromiseHandlers.resolve(_argN),
                            (commandPromiseHandlers.resolve = function () {
                              return null;
                            })),
                          "command-rejected" === _argN.action &&
                            (commandPromiseHandlers.reject(_argN),
                            (commandPromiseHandlers.reject = function () {
                              return null;
                            })),
                          "save-doc-report" === _argN.action &&
                            "end" === _argN.info.status &&
                            ((_regC = {
                              message:
                                "[" +
                            ...
                            sentryLogger(_regC),
                            onSaveCallback(_argN)),
                          "close" !== _argN.action && "goto-cart" !== _argN.action)
                        ) {
                          t.next = 45;
                          break;
                        }
                        if (((_regS = null), (t.prev = 27), _argN.info && _argN.info.projectID))
                          return (
                            (t.next = 31),
                            regeneratorRuntime.awrap(
                              apiClientInstance.call(
                                "isReadyToOrder",
                                _argN.info.projectID || sessionStorageManager("projectId")
                              )
                            )
                          );
                        t.next = 33;
                        break;
                      case 31:
                        (_regS = t.sent).can_order
                          ? (_argN.isCanOrder = !0)
                          : ((_argN.error = _regS), (_argN.isCanOrder = !1));
                      case 33:
                        sentryLogger({
                          message:
                            "[" +
                      ...
                      case 36:
                        (t.prev = 36),
                          ...
                          onErrorCallback &&
                            onErrorCallback.constructor === Function &&
                            ((t.t0.code = "003"), onErrorCallback(t.t0)),
                          (_argN.error = t.t0),
                          console.log(t.t0);
                      case 41:
                        return (t.prev = 41), onCloseCallback(_argN), t.finish(41);
                      case 44:
                        autoSaveIntervalId &&
                          "number" == typeof autoSaveIntervalId &&
                          clearInterval(autoSaveIntervalId);
                      case 45:
                        "selection-changed" === _argN.action && onSelectCallback(_argN),
                          "state-history" === _argN.action && onHistoryStateCallback(_argN),
                          "label-history" === _argN.action && onHistoryLabelCallback(_argN.info),
                          "dpp-execute-report" === _argN.action &&
                            "end" === _argN.info.status &&
                            (onDdpExecuteCompleteCallback &&
                              onDdpExecuteCompleteCallback.constructor === Function &&
                              onDdpExecuteCompleteCallback(),
                            (onDdpExecuteCompleteCallback = null)),
                          "scene-info-report" === _argN.action &&
                            sceneInfoCallback &&
                            sceneInfoCallback.constructor === Function &&
                            (_argN.info.activePage &&
                              (_argN.info.sceneInfo.activePage = _argN.info.activePage),
                            sceneInfoCallback(_argN.info.sceneInfo),
                            (sceneInfoCallback = null)),
                          "imgpool-notify" === _argN.action && onImagePoolCallback(_argN.info),
                          "preview-closed" === _argN.action && onPreviewCloseCallback(),
                          "font-list" === _argN.action && onFontListCallback(_argN.info),
                          ("enter-overlay-mode" !== _argN.action &&
                            "exit-overlay-mode" !== _argN.action) ||
                            onChangeModeCallback(_argN),
                          "page-count-changed" === _argN.action && onPageCountChangeCallback(_argN),
                          "request-page-size-change" === _argN.action &&
                            onGroupCaptionCallback(_argN),
                          "request-user-token" === _argN.action &&
                            apiClientInstance
                              .call("issueUserToken")
                              .then(function (t) {
                                t.division && sessionStorageManager("division", t.division),
                          ...
                          "impose-opened" === _argN.action && onImposeOpenedCallback(_argN),
                          "page-group-print-count-changed" === _argN.action &&
                            onPrintCountChangeCallback(_argN),
                          "prod-var-changed" == _argN.action &&
                            onCustomTabSelectionChangeCallback(_argN),
                          "doc-report" == _argN.action &&
                            ((_regU = {
                              message:
                                "[" +
                                sdkState.openType +
                            ...
                            sentryLogger(_regU),
                            onDocReportCallback(_argN)),
                          onAllEventsCallback(_argN);
                      case 62:
                      case "end":
                        return t.stop();
                    }
            ...
            value: function (t, e) {
              return (
                "create" === t
                  ...
                  ? (onSelectCallback = e)
                  : "historyState" === t
                  ? (onHistoryStateCallback = e)
                  : "historyLabel" === t
                  ? (onHistoryLabelCallback = e)
                  : "promoReport" === t
                  ? (onPromoReportCallback = e)
                  : "error" === t
                  ? (onErrorCallback = function (t) {
                      sentryLogger({
                        message: t,
                  ...
                  : "imagePool" === t
                  ? (onImagePoolCallback = e)
                  : "previewClose" === t
                  ? (onPreviewCloseCallback = e)
                  : "fontList" === t
                  ? (onFontListCallback = e)
                  : "changeMode" === t
                  ? (onChangeModeCallback = e)
                  : "pageCountChange" === t
                  ? (onPageCountChangeCallback = e)
                  : "pageChange" === t
                  ? (onPageChangeCallback = e)
                  : "groupCaption" === t
                  ? (onGroupCaptionCallback = e)
                  : "imposeOpened" === t
                  ? (onImposeOpenedCallback = e)
                  : "printCountChange" === t
                  ? (onPrintCountChangeCallback = e)
                  : "customTabSelectionChange" === t
                  ? (onCustomTabSelectionChangeCallback = e)
                  : "docReport" === t
                  ? (onDocReportCallback = e)
                  : "all" === t && (onAllEventsCallback = e),
                this
              );
            },
          },
          {
            ...
            key: "getProjectId",
            value: function () {
              return sessionStorageManager("projectId");
            },
          },
          {
            /**
            ...
            value: function (t, e) {
              if ("changeLayout" !== t)
                return (
                  editorBridge.post_to_editor(t, e),
                  ["command"].includes(t) && ["close-preview"].includes(e.type)
                    ? new Promise(function (t, e) {
                        (commandPromiseHandlers.resolve = t), (commandPromiseHandlers.reject = e);
                      })
                    : new Promise(function (t, e) {
                        t(void 0);
                      })
              ...
              console.warn(
                ...
                editorBridge.change_layout(e.uri, e.pageIndex, e.isChangeableBackground);
            },
          },
          {
            /**
          ...
          },
          {
             ...
             */
            key: "getTemplateList",
            value: function (_argR, e, _argO) {
              var i, _regN, _regA, _regC, _regS;
              return regeneratorRuntime.async(
                function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 9:
                        ...
                        if (
                          ...
                          return (
                            ...
                            (t.prev = 14),
                            (t.next = 17),
                            regeneratorRuntime.awrap(this.getProductInfo(_argR))
                          );
                        t.next = 27;
                        break;
                      case 17:
                        (_regA = t.sent), (_regN = _regA.userData || []), (t.next = 24);
                        break;
                      case 21:
                        (t.prev = 21),
                          (t.t0 = t.catch(14)),
                      ...
                      case 24:
                        (_regC = i.features),
                          delete i.features,
                          Object.keys(_regC).map(function (e) {
                            var t = null;
                            (t = _regN.some(function (t) {
                              return t.field === e && "text" === t.type;
                            })
                              ? _regC[e]
                              : "string" == typeof _regC[e]
                              ? [_regC[e]]
                              : _regC[e]),
                              (i["features." + e] = {
                                $in: t,
                      ...
                      case 27:
                        i.sort &&
                          ((_regS = i.sort),
                          (i.sort = {}),
                          Object.keys(_regS).map(function (t) {
                            ["hit", "ordered", "priority"].includes(t)
                              ? (i.sort["sortReference." + t] = _regS[t])
                              : (i.sort[t] = _regS[t]);
                          }));
                      case 28:
                        return t.abrupt(
                          ...
                          new Promise(function (e, n) {
                            apiClientInstance
                              ...
                              .then(function (t) {
                                _argO && "function" == typeof _argO ? _argO(null, t) : e(t);
                              })
                              .catch(function (t) {
                                onErrorCallback &&
                                  onErrorCallback.constructor === Function &&
          ...
          {
            key: "getResourceList",
            value: function (_argR, _argO, e, i) {
              var _regA, _regN, _regC, _regS, _regU;
              return regeneratorRuntime.async(
                function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        if (!_argO.resourceType) {
                          t.next = 32;
                          break;
                        }
                        if (null === e || "function" != typeof e) {
                      ...
                      case 10:
                        ...
                        if (
                          ((_regA = JSON.parse(JSON.stringify(e))).size &&
                            Array.isArray(_regA.size) &&
                            (_regA.size = {
                              $in: _regA.size,
                            }),
                          _regA.features)
                        ...
                        break;
                      case 18:
                        (_regC = t.sent), (_regN = _regC.userData || []), (t.next = 25);
                        break;
                      case 22:
                        (t.prev = 22),
                          (t.t0 = t.catch(15)),
                          onErrorCallback &&
                            ...
                            ((t.t0.code = "003"), onErrorCallback(t.t0));
                      case 25:
                        (_regS = _regA.features),
                          delete _regA.features,
                          Object.keys(_regS).map(function (e) {
                            var t = null;
                            (t = _regN.some(function (t) {
                              return t.field === e && "text" === t.type;
                            })
                              ? _regS[e]
                              : "string" == typeof _regS[e]
                              ? [_regS[e]]
                              : _regS[e]),
                              (_regA["features." + e] = {
                                $in: t,
                      ...
                      case 28:
                        _regA.sort &&
                          ((_regU = _regA.sort),
                          (_regA.sort = {}),
                          Object.keys(_regU).map(function (t) {
                            ["hit", "ordered"].includes(t)
                              ? (_regA.sort["sortReference." + t] = _regU[t])
                              : (_regA.sort[t] = _regU[t]);
                          }));
                      case 29:
                        return t.abrupt(
                          "return",
          ...
          },
          {
            ...
            key: "getSceneInfo",
            value: function (t) {
              editorBridge.post_to_editor("get-scene-info", {
                include_text_info: !0,
              }),
                (sceneInfoCallback = t);
            },
          ...
          },
          {
            ...
            value: function () {
              ...
              editorBridge.post_to_editor("return-message", t);
            },
          },
          {
            /**
              ...
              return new Promise(function (e, t) {
                ...
                xMLHttpRequest.open("GET", r, !0),
                  ...
                  (xMLHttpRequest.onload = function () {
                    ...
                    t.readAsText(xMLHttpRequest.response),
                      (t.onload = function (t) {
                        e(t.target.result);
                      });
                  }),
          ...
          },
          {
            ...
            key: "destroy",
            value: function (t) {
              var e = JSON.parse(sessionStorageManager("edicusConfig"));
              t &&
                ...
                (onHistoryStateCallback = function () {
                  return null;
                }),
                (onHistoryLabelCallback = function () {
                  return null;
                }),
                (onErrorCallback = function () {
                  return null;
                }),
                (onFontListCallback = function () {
                  return null;
                }),
                (onChangeModeCallback = function () {
                  return null;
                }),
                (onPageCountChangeCallback = function () {
                  return null;
                }),
                (onPageChangeCallback = function () {
                  return null;
                }),
                (onDocReportCallback = function () {
                  return null;
                }),
                (onAllEventsCallback = function () {
                  return null;
                })),
                editorBridge.destroy(e ? document.querySelector(e.selector) : null, t),
                koiContainerElement &&
                  (windowRef.removeEventListener("message", koiPassiveMessageListener, !1),
                  koiContainerElement.removeChild(koiIframeElement));
            },
          },
          {
            /**
            ...
            value: function (t, e) {
              ...
              return (
                ...
                (koiIframeElement = (function (t, e, n) {
                  ...
                  var o = r + "gateway/" + t + "?",
                    i = {
                      ...
                      companyCode: sessionStorageManager("companyCode"),
                ...
                koiContainerElement.appendChild(koiIframeElement),
                function (t) {
                  koiIframeElement.contentWindow.postMessage(JSON.stringify(t), "*");
                })
              );
            },
          },
          {
            key: "getProjectOwnerId",
            value: function (t, e) {
              if (!e) return apiClientInstance.getProjectOwnerId(t);
              apiClientInstance
                .getProjectOwnerId(t)
                .then(function (t) {
                  e(null, t);
          ...
          },
          {
            ...
            value: function (g) {
              ...
              if (0 < Object.keys(_).length) {
                ...
                try {
                  for (
                    var _iterStep, _iterator = Object.entries(_)[Symbol.iterator]();
                    !(_iterDone = (_iterStep = _iterator.next()).done);
                    _iterDone = !0
                  ) {
        ...
        _createClass(e, [
          ...
          },
          {
            ...
            value: function (o) {
              ...
              return e
                ? groupingInfo.list.map(function (t) {
                    var e = t.sliceField,
          ...
          },
          {
            ...
            value: function (t, e) {
              var material = t.material,
                ...
                haveMappingData = e.haveMappingData,
                i = e.sliceField,
              ...
              try {
                for (
                  var _iterStep, _iterator = docFields[Symbol.iterator]();
                  !(_iterDone = (_iterStep = _iterator.next()).done);
                  _iterDone = !0
                ) {
                  var _iterValue = _iterStep.value;
          ...
          },
          {
            ...
            value: function (r, o) {
              ...
              try {
                for (
                  var _iterStep, _iterator = this.customTabInfo.initVariables[Symbol.iterator]();
                  !(_iterDone = (_iterStep = _iterator.next()).done);
                  _iterDone = !0
                ) {
                  var _iterValue = _iterStep.value;
                  if ("text" === _iterValue.type) e[_iterValue.variable] = _iterValue.value;
                  else {
                      ...
                      if ("uniform-select" === value.type) {
                        var t = n[value.items.target].reduce(function (t, e) {
                          ...
                          try {
                            for (
                              var _iterStep2,
                                _iterator2 = Object.keys(value.items)[Symbol.iterator]();
                              !(_iterDone2 = (_iterStep2 = _iterator2.next()).done);
                              _iterDone2 = !0
                            ) {
                        ...
                        return (
                          ...
                          (_regR = e.reduce(function (t, r) {
                            ...
                            if ("Y" === r.HIDE_YN) {
                              ...
                              try {
                                for (
                                  var _iterStep, _iterator = _regM[Symbol.iterator]();
                                  !(_iterDone = (_iterStep = _iterator.next()).done);
                                  _iterDone = !0
                                ) {
                                  var _iterValue = _iterStep.value,
                ...
                function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        if (
                          ((_regN = this.customTabInfo),
                          (_regO = _regN.baseData),
                          (i = _regN.noStocks),
                          (_regA = _regN.grouping),
                          (_regC = _regN.groupingInfo),
                          (_regS = _regN.defaultPrice),
                          ...
                          (_regB = _regM.reduce(function (t, e) {
                            return (t[e] = _argR[e]), t;
                          }, {})),
                          _regP)
                        ) {
                          t.next = 47;
                        ...
                        if (
                          ((x = this.getInitVariable(_, _regB)),
                          (k = _extends(
                            {
                              $CDBG: this.isDev,
                            },
                          ...
                          _regH &&
                            ((_regW = _regH.condition),
                            (_regS2 = _regW.key),
                            (_regE = _regW.value),
                            _argR[_regS2] === _regE && (k.$FCMC = _regH.value)),
                          _regD && (k.$PGLR = "Cut"),
                          !_regV || !_regV.length)
                        ) {
                          t.next = 46;
                        ...
                        (_regT = !(_regI = !0)),
                          (_regP2 = void 0),
                          (t.prev = 20),
                          (_regO2 = _regV[Symbol.iterator]());
                      case 22:
                        if ((_regI = (j = _regO2.next()).done)) {
                          t.next = 32;
                          break;
                        }
                        if (
                          ((_regC2 = j.value),
                          (_regR = _regC2.condition),
                          (_regM2 = _regC2.filter),
                          (_regN2 = _regC2.data),
                          _regR.every(function (t) {
                            var e = t.key,
                              value = t.value;
                            return _argR[e] === value;
                          }))
                        ) {
                          t.next = 28;
                          break;
                      ...
                      case 32:
                        ...
                        break;
                      case 34:
                        (t.prev = 34), (t.t0 = t.catch(20)), (_regT = !0), (_regP2 = t.t0);
                      case 38:
                        (t.prev = 38), (t.prev = 39), !_regI && _regO2.return && _regO2.return();
                      case 41:
                        if (((t.prev = 41), _regT)) throw _regP2;
                        t.next = 44;
                        break;
                      case 44:
                        return t.finish(41);
                      ...
                      case 47:
                        return (
                          (_regF2 = {
                            entities: this.getEntities(_, _argR),
                          }),
                          (t.t1 = _extends),
                          (t.t2 = {}),
                          (t.t3 = _regG),
                          ...
                          (t.next = 54),
                          regeneratorRuntime.awrap(this.getNoStocksInfo(e[i.baseData]))
                        );
                      case 54:
                        return (
                          (t.t5 = t.sent),
                          ...
                          (_regG = (0, t.t1)(t.t2, t.t3, t.t7)),
                          t.abrupt("return", _regG)
                        );
                      case 59:
                      case "end":
                        return t.stop();
  ...
  windowRef.RedEditorSDK = RedEditorSDK;
})(window);
